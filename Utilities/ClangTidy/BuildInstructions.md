# How to build the XII custom version of clang-tidy
 ...
 * Copy the xii folder to `llvm-project/clang-tools-extra/clang-tidy/xii`
 ...
 * Copy the resulting executable from `build/Release/bin/clang-tidy.exe` to `XII/Data/Tools/Precompiled/clang-tidy/clang-tidy.exe` when done
