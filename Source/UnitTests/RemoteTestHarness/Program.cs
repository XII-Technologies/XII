...
namespace xiiUwpTestHarness
{
  ...
  class Program
  {
    public class Options
    {
      ...
      public string xiiWorkspace { get; set; }
    ...
    static void Main(string[] args)
    {
      ...
      AppDomain.CurrentDomain.UnhandledException += (object sender, UnhandledExceptionEventArgs eventArgs) =>
      {
        ...
        try
        {
          ...
          var bla = xiiProcessHelper.RunExternalExe("procdump", args2, absBinDir);
        }
        catch (Exception e)
        {
      ...
      Parser.Default.ParseArguments<Options>(args)
        ...
        {
          xiiTestUWP test = new xiiTestUWP(o.xiiWorkspace, o.testOutputPath, o.configuration, o.platform, o.project);
          test.ExecuteTest();
        });
    }
