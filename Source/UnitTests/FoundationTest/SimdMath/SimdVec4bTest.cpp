...
XII_CREATE_SIMPLE_TEST(SimdMath, SimdVec4b)
{
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Constructor")
  {
    ...
    static_assert(sizeof(xiiSimdVec4b) == 16);
    static_assert(XII_ALIGNMENT_OF(xiiSimdVec4b) == 16);
#endif
    ...
    XII_TEST_BOOL(vInit1B.m_v.m128_u32[0] == 0xFFFFFFFF && vInit1B.m_v.m128_u32[1] == 0xFFFFFFFF && vInit1B.m_v.m128_u32[2] == 0xFFFFFFFF && vInit1B.m_v.m128_u32[3] == 0xFFFFFFFF);
#endif
