...
XII_CREATE_SIMPLE_TEST(SimdMath, SimdTransformd)
{
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Constructor")
  {
    ...
    {
      xiiSimdQuatd qRot;
      qRot.SetFromAxisAndAngle(xiiSimdVec4d(1, 2, 3).GetNormalized<3>(), xiiAngled::Degree(42.0));
      ...
      XII_TEST_BOOL(t.m_Rotation == xiiSimdQuatd::IdentityQuaternion());
...

    {
      ...
      XII_TEST_BOOL(t == xiiSimdTransformd::IdentityTransform());
    }
  }
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Inverse")
  {
    ...
    tParent.m_Rotation.SetFromAxisAndAngle(xiiSimdVec4d(0, 1, 0), xiiAngled::Degree(90));
    tParent.m_Scale = xiiSimdVec4d(2);

    xiiSimdTransformd tToChild(xiiSimdVec4d(4, 5, 6));
    tToChild.m_Rotation.SetFromAxisAndAngle(xiiSimdVec4d(0, 0, 1), xiiAngled::Degree(90));
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "GetAsMat4")
  {
    ...
    t.m_Rotation.SetFromAxisAndAngle(xiiSimdVec4d(0, 1, 0), xiiAngled::Degree(34));
    ...
    {
      xiiQuatd q;
      q.SetFromAxisAndAngle(xiiVec3d(0, 1, 0), xiiAngled::Degree(34));
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "TransformPos / Dir / operator*")
  {
    ...
    qRotX.SetFromAxisAndAngle(xiiSimdVec4d(1, 0, 0), xiiAngled::Degree(90.0));
    qRotY.SetFromAxisAndAngle(xiiSimdVec4d(0, 1, 0), xiiAngled::Degree(90.0));
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Operators")
  {
    ...
    {
      xiiSimdTransformd t(xiiSimdVec4d(1, 2, 3));
      t.m_Rotation.SetFromAxisAndAngle(xiiSimdVec4d(0, 1, 0), xiiAngled::Degree(90));
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Comparison")
  {
    ...
    t2.m_Rotation.SetFromAxisAndAngle(xiiSimdVec4d(0, 1, 0), xiiAngled::Degree(90));

    XII_TEST_BOOL(t != t2);

    xiiSimdTransformd t3(xiiSimdVec4d(1, 2, 3));
    t3.m_Rotation.SetFromAxisAndAngle(xiiSimdVec4d(0, 1, 0), xiiAngled::Degree(91));
