...
namespace
{
  ...
  static void TestLength(const xiiSimdVec4f& a, float r[4], const xiiSimdFloat& eps)
  {
    ...
    XII_TEST_FLOAT(l1, r[0], eps);
    XII_TEST_FLOAT(l2, r[1], eps);
    XII_TEST_FLOAT(l3, r[2], eps);
    XII_TEST_FLOAT(l4, r[3], eps);
  ...
  static void TestNormalize(const xiiSimdVec4f& a, xiiSimdVec4f n[4], xiiSimdFloat r[4], const xiiSimdFloat& eps)
  {
    ...
    XII_TEST_BOOL(n1.IsEqual(n[0], eps).AllSet());
    XII_TEST_BOOL(n2.IsEqual(n[1], eps).AllSet());
    XII_TEST_BOOL(n3.IsEqual(n[2], eps).AllSet());
    XII_TEST_BOOL(n4.IsEqual(n[3], eps).AllSet());
    ...
    XII_TEST_BOOL(a1.IsEqual(n[0], eps).AllSet());
    XII_TEST_BOOL(a2.IsEqual(n[1], eps).AllSet());
    XII_TEST_BOOL(a3.IsEqual(n[2], eps).AllSet());
    XII_TEST_BOOL(a4.IsEqual(n[3], eps).AllSet());

    XII_TEST_BOOL(a1.IsNormalized<1>(eps));
    XII_TEST_BOOL(a2.IsNormalized<2>(eps));
    XII_TEST_BOOL(a3.IsNormalized<3>(eps));
    XII_TEST_BOOL(a4.IsNormalized<4>(eps));
    XII_TEST_BOOL(!a1.IsNormalized<2>(eps));
    XII_TEST_BOOL(!a2.IsNormalized<3>(eps));
    XII_TEST_BOOL(!a3.IsNormalized<4>(eps));
...
#  endif
    ...
    XII_CHECK_AT_COMPILETIME(sizeof(xiiSimdVec4f) == 16);
    XII_CHECK_AT_COMPILETIME(XII_ALIGNMENT_OF(xiiSimdVec4f) == 16);
#endif
    ...
    xiiSimdVec4f vZero = xiiSimdVec4f::ZeroVector();
