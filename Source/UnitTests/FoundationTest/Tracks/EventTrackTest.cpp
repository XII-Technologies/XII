...
XII_CREATE_SIMPLE_TEST(Tracks, EventTrack)
{
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Empty")
  {
    ...
    et.Sample(xiiTime::Zero(), xiiTime::Seconds(1.0), result);
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Sample")
  {
    ...
    et.AddControlPoint(xiiTime::Seconds(3.0), "Event3");
    et.AddControlPoint(xiiTime::Seconds(0.0), "Event0");
    et.AddControlPoint(xiiTime::Seconds(4.0), "Event4");
    et.AddControlPoint(xiiTime::Seconds(1.0), "Event1");
    et.AddControlPoint(xiiTime::Seconds(2.0), "Event2");

    XII_TEST_BOOL(!et.IsEmpty());

    // sampling an empty range should yield no results, even if sampling an exact time where an event is
    result.Clear();
    {{et.Sample(xiiTime::Seconds(0.0), xiiTime::Seconds(0.0), result);
    XII_TEST_INT(result.GetCount(), 0);
  }

  {
    result.Clear();
    et.Sample(xiiTime::Seconds(1.0), xiiTime::Seconds(1.0), result);
    XII_TEST_INT(result.GetCount(), 0);
  }

  {
    result.Clear();
    et.Sample(xiiTime::Seconds(4.0), xiiTime::Seconds(4.0), result);
    XII_TEST_INT(result.GetCount(), 0);
  }
}
...
{
  result.Clear();
  et.Sample(xiiTime::Seconds(0.0), xiiTime::Seconds(1.0), result);
...
{
  result.Clear();
  et.Sample(xiiTime::Seconds(0.0), xiiTime::Seconds(2.0), result);
...
{
  result.Clear();
  et.Sample(xiiTime::Seconds(0.0), xiiTime::Seconds(4.0), result);
...
{
  result.Clear();
  et.Sample(xiiTime::Seconds(0.0), xiiTime::Seconds(10.0), result);
...
{
  result.Clear();
  et.Sample(xiiTime::Seconds(-0.1), xiiTime::Seconds(10.0), result);
  XII_TEST_INT(result.GetCount(), 5);
  XII_TEST_STRING(result[0].GetString(), "Event0");
  XII_TEST_STRING(result[1].GetString(), "Event1");
  XII_TEST_STRING(result[2].GetString(), "Event2");
...
XII_TEST_BLOCK(xiiTestBlock::Enabled, "Reverse Sample")
{
  ...
  {
    result.Clear();
    et.Sample(xiiTime::Seconds(2.0), xiiTime::Seconds(0.0), result);
    XII_TEST_INT(result.GetCount(), 2);
  ...
  {
    result.Clear();
    et.Sample(xiiTime::Seconds(4.0), xiiTime::Seconds(0.0), result);
    XII_TEST_INT(result.GetCount(), 4);
  ...
  {
    result.Clear();
    et.Sample(xiiTime::Seconds(10.0), xiiTime::Seconds(0.0), result);
    XII_TEST_INT(result.GetCount(), 4);
    XII_TEST_STRING(result[0].GetString(), "Event4");
    XII_TEST_STRING(result[1].GetString(), "Event3");
    XII_TEST_STRING(result[2].GetString(), "Event2");
  ...
  {
    result.Clear();
    et.Sample(xiiTime::Seconds(10.0), xiiTime::Seconds(-0.1), result);
    XII_TEST_INT(result.GetCount(), 5);
    XII_TEST_STRING(result[0].GetString(), "Event4");
    XII_TEST_STRING(result[1].GetString(), "Event3");
    XII_TEST_STRING(result[2].GetString(), "Event2");
