...
XII_CREATE_SIMPLE_TEST(Strings, StringUtils)
{
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "StartsWith")
  {
    ...
    XII_TEST_BOOL(xiiStringUtils::StartsWith(sz, (const char*)u8"äbc", sz + uiByteCount) == true);
    XII_TEST_BOOL(xiiStringUtils::StartsWith(sz, (const char*)u8"äbc", sz + uiByteCount - 1) == false);
    XII_TEST_BOOL(xiiStringUtils::StartsWith(sz, (const char*)u8"äbc", sz + 0) == false);
