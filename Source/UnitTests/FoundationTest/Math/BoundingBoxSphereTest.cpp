...
XII_CREATE_SIMPLE_TEST(Math, BoundingBoxSphere)
{
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Constructor")
  {
    ...
    XII_TEST_BOOL(b.m_vBoxHalfExtents == xiiVec3T(1, 2, 3));
    ...
    XII_TEST_BOOL(b.m_vBoxHalfExtents == xiiVec3T(1, 1, 1));
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "SetFromPoints")
  {
    ...
    XII_TEST_BOOL(b.m_vBoxHalfExtents == xiiVec3T(4.5, 6.5, 8.5));
    XII_TEST_FLOAT(b.m_fSphereRadius, xiiVec3T(0.5, 0.5, 8.5).GetLength(), 0.00001f);
    XII_TEST_BOOL(b.m_fSphereRadius <= b.m_vBoxHalfExtents.GetLength());
  }
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "ExpandToInclude")
  {
    ...
    XII_TEST_BOOL(b1.m_vBoxHalfExtents == xiiVec3T(2, 2, 2));
    XII_TEST_FLOAT(b1.m_fSphereRadius, xiiMath::Sqrt(xiiMathTestType(3)) * 2, 0.00001f);
    XII_TEST_BOOL(b1.m_fSphereRadius <= b1.m_vBoxHalfExtents.GetLength());
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Transform")
  {
    ...
    XII_TEST_BOOL(b.m_vBoxHalfExtents == xiiVec3T(10, 15, 10));
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "IsNaN")
  {
    if (xiiMath::SupportsNaN<xiiMathTestType>())
    {
      ...
      b                     = xiiBoundingBoxSphereT::MakeInvalid();
      b.m_vBoxHalfExtents.x = xiiMath::NaN<xiiMathTestType>();
      XII_TEST_BOOL(b.IsNaN());

      b                     = xiiBoundingBoxSphereT::MakeInvalid();
      b.m_vBoxHalfExtents.y = xiiMath::NaN<xiiMathTestType>();
      XII_TEST_BOOL(b.IsNaN());

      b                     = xiiBoundingBoxSphereT::MakeInvalid();
      b.m_vBoxHalfExtents.z = xiiMath::NaN<xiiMathTestType>();
      XII_TEST_BOOL(b.IsNaN());
