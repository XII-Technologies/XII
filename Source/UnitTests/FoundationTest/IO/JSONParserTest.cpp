...
class TestReader : public xiiJSONParser
{
private:
  xiiDeque<ParseResult> m_Results;
...
public:
  ...
  ~TestReader()
  {
    XII_TEST_INT(m_iExpectedParsingErrors, 0);
  ...
  {
    XII_TEST_BOOL(!m_Results.IsEmpty());
    XII_TEST_BOOL(m_Results.PeekFront().m_Function == ValueDouble);
    XII_TEST_DOUBLE(m_Results.PeekFront().m_fValue, fValue, 0.0001);
  ...
  {
    XII_TEST_BOOL(!m_Results.IsEmpty());
    XII_TEST_BOOL(m_Results.PeekFront().m_Function == ValueBool);
    XII_TEST_BOOL(m_Results.PeekFront().m_bValue == bValue);
  ...
  {
    XII_TEST_BOOL(!m_Results.IsEmpty());
    XII_TEST_BOOL(m_Results.PeekFront().m_Function == ValueNULL);
  ...
  {
    XII_TEST_BOOL(!m_Results.IsEmpty());
    XII_TEST_BOOL(m_Results.PeekFront().m_Function == BeginObject);
  ...
  {
    XII_TEST_BOOL(!m_Results.IsEmpty());
    XII_TEST_BOOL(m_Results.PeekFront().m_Function == EndObject);
  ...
  {
    XII_TEST_BOOL(!m_Results.IsEmpty());
    XII_TEST_BOOL(m_Results.PeekFront().m_Function == BeginArray);
  ...
  {
    XII_TEST_BOOL(!m_Results.IsEmpty());
    XII_TEST_BOOL(m_Results.PeekFront().m_Function == EndArray);
...
XII_CREATE_SIMPLE_TEST(IO, JSONParser)
{
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "All Features")
  {
...
\"test\" : \"text\"\n\
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Empty Document (string")
  {
    const char* szTestData = "";
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Empty Document (Whitespace)")
  {
    const char* szTestData = " \n  \t ";
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Empty Document")
  {
    const char* szTestData = "{}";
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Two Empty Documents")
  {
    const char* szTestData = "{}{}";
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "No Whitespace")
  {
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Empty Blocks")
  {
    // I want C++ 11 raw string literals
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Superfluous separators")
  {
    // I want C++ 11 raw string literals
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Too many commas in array")
  {
    // I want C++ 11 raw string literals
    ...
    XII_TEST_INT(reader.m_iExpectedParsingErrors, 0); // must fail to parse
  }

  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Comments")
  {
    // I want C++ 11 raw string literals
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Skip Object")
  {
    // I want C++ 11 raw string literals
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Skip Array")
  {
    // I want C++ 11 raw string literals
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Skip Variable")
  {
    // I want C++ 11 raw string literals
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Unicode escape sequence")
  {
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "Unicode escape sequence parsing errors")
  {
