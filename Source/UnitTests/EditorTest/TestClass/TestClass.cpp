...
xiiResult xiiEditorTest::InitializeTest()
{
  ...
  if (xiiStringUtils::IsEqual_NoCase(xiiGameApplication::GetActiveRenderer(), "D3D11") && s_bIsReferenceDriver)
  {
  ...
  else if (xiiStringUtils::IsEqual_NoCase(xiiGameApplication::GetActiveRenderer(), "D3D11") && s_bIsAMDDriver)
  {
