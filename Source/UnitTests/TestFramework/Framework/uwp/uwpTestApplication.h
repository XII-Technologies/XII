...
class xiiUwpTestApplication : public RuntimeClass<IFrameworkViewSource, IFrameworkView>
{
public:
  xiiUwpTestApplication(xiiTestFramework& testFramework);
  virtual ~xiiUwpTestApplication();
...
private:
  ...
  xiiTestFramework&                 m_testFramework;
