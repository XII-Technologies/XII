...
/// \brief Enum for usage in XII_TEST_BLOCK to enable or disable the block.
struct xiiTestBlock
{
  /// \brief Enum for usage in XII_TEST_BLOCK to enable or disable the block.
  enum Enum
...
/// \brief Tests two xiiVec3's for equality, using some epsilon. On failure both actual and expected values are output.
...
/// \brief Tests two xiiVec4's for equality, using some epsilon. On failure both actual and expected values are output.
