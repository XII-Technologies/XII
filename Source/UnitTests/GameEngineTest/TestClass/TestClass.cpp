...
xiiResult xiiGameEngineTest::InitializeTest()
{
  ...
  if (xiiGameApplication::GetActiveRenderer().IsEqual_NoCase("D3D11") || xiiGameApplication::GetActiveRenderer().IsEqual_NoCase("DX11"))
  {
    ...
    else if ((xiiGameApplication::GetActiveRenderer().IsEqual_NoCase("D3D11") || xiiGameApplication::GetActiveRenderer().IsEqual_NoCase("DX11")) && xiiGALDevice::HasDefaultDevice() && xiiGALDevice::GetDefaultDevice()->GetCapabilities().m_sAdapterName.FindSubString_NoCase("AMD") || xiiGALDevice::GetDefaultDevice()->GetCapabilities().m_sAdapterName.FindSubString_NoCase("Radeon"))
    {
  ...
  else if (xiiGameApplication::GetActiveRenderer().IsEqual_NoCase("Vulkan"))
  {
