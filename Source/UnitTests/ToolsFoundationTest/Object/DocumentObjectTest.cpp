...
XII_CREATE_SIMPLE_TEST(DocumentObject, DocumentObjectManager)
{
  ...
  {
    XII_TEST_BOOL(manager.CanAdd(xiiObjectTest::GetStaticRTTI(), nullptr, "", 0).m_Result.Succeeded());
    ...
    XII_TEST_BOOL(manager.CanAdd(OuterClass::GetStaticRTTI(), pObject, szProperty, 0).m_Result.Failed());
    XII_TEST_BOOL(manager.CanAdd(xiiObjectTest::GetStaticRTTI(), pObject, szProperty, 0).m_Result.Succeeded());
    ...
    XII_TEST_BOOL(manager.CanAdd(OuterClass::GetStaticRTTI(), pObject, "ClassPtrArray", 0).m_Result.Succeeded());
    XII_TEST_BOOL(manager.CanAdd(ExtendedOuterClass::GetStaticRTTI(), pObject, "ClassPtrArray", 0).m_Result.Succeeded());
    XII_TEST_BOOL(!manager.CanAdd(xiiReflectedClass::GetStaticRTTI(), pObject, "ClassPtrArray", 0).m_Result.Succeeded());

    for (xiiInt32 i = 0; i < XII_ARRAY_SIZE(pChildren); i++)
    {
      XII_TEST_BOOL(manager.CanAdd(xiiObjectTest::GetStaticRTTI(), pChildObject, szProperty, i).m_Result.Succeeded());
    ...
    XII_TEST_BOOL_MSG(manager.CanMove(pObject, pChildObject, szProperty, 0).m_Result.Failed(), "Can't move to own child");
    XII_TEST_BOOL_MSG(manager.CanMove(pChildren[1], pChildObject, szProperty, 1).m_Result.Failed(), "Can't move before onself");
    XII_TEST_BOOL_MSG(manager.CanMove(pChildren[1], pChildObject, szProperty, 2).m_Result.Failed(), "Can't move after oneself");
    XII_TEST_BOOL_MSG(manager.CanMove(pChildren[1], pChildren[1], szProperty, 0).m_Result.Failed(), "Can't move into yourself");
  }
  ...
  XII_TEST_BLOCK(xiiTestBlock::Enabled, "DocumentSubElementObject")
  {
    ...
    {
      XII_TEST_BOOL(manager.CanAdd(OuterClass::GetStaticRTTI(), pObject, szProperty, i).m_Result.Succeeded());
    ...
    XII_TEST_BOOL(manager.CanRemove(pSubElementObject[0]).m_Result.Succeeded());
    ...
    XII_TEST_BOOL(manager.CanMove(pSubElementObject[1], pObject, szProperty, 2).m_Result.Succeeded());
    manager.MoveObject(pSubElementObject[1], pObject, szProperty, 2);
    XII_TEST_BOOL(manager.CanMove(pSubElementObject[3], pObject, szProperty, 0).m_Result.Succeeded());
    ...
    XII_TEST_BOOL(manager.CanRemove(pSubElementObject[3]).m_Result.Succeeded());
    ...
    XII_TEST_BOOL(manager.CanMove(pSubElementObject[1], pChildObject, szProperty, 0).m_Result.Succeeded());
    manager.MoveObject(pSubElementObject[1], pChildObject, szProperty, 0);
    XII_TEST_BOOL(manager.CanMove(pSubElementObject[2], pChildObject, szProperty, 0).m_Result.Succeeded());
