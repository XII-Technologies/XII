...
### [xiiEditor](https://github.com/xiiEngine/xiiEngine)

The xiiEditor is a full blown graphical editor used for editing scenes and
importing and authoring assets for the [xiiEngine](https://github.com/xiiEngine/xiiEngine) -
an open source C++ game engine in active development.

![xiiEditor](doc/showcase_xiiEngine_editor.png)
