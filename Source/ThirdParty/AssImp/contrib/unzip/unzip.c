...
#define SIZXIIIPLOCALHEADER          (0x1e)
    ...
    uint16_t *psize_local_extrafield)
{
    ...
    *poffset_local_extrafield = s->cur_file_info_internal.offset_curfile + SIZXIIIPLOCALHEADER + size_filename;
...
extern int ZEXPORT unzOpenCurrentFile3(unzFile file, int *method, int *level, int raw, const char *password)
{
    ...
    pfile_in_zip_read_info->pos_in_zipfile = s->cur_file_info_internal.offset_curfile + SIZXIIIPLOCALHEADER + size_variable;
    pfile_in_zip_read_info->stream.avail_in = 0;
