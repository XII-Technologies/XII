...
struct XII_GAMEENGINE_DLL xiiProjectileReaction
{
...
XII_DECLARE_REFLECTABLE_TYPE(XII_GAMEENGINE_DLL, xiiProjectileReaction);

/// \brief Holds the information about how a projectile interacts with a specific surface type
struct XII_GAMEENGINE_DLL xiiProjectileSurfaceInteraction
{
...
XII_DECLARE_REFLECTABLE_TYPE(XII_GAMEENGINE_DLL, xiiProjectileSurfaceInteraction);

class XII_GAMEENGINE_DLL xiiProjectileComponent : public xiiComponent
{
