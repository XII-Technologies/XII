...
void xiiPlayerStartPointComponent::SerializeComponent(xiiWorldWriter& inout_stream) const
{
...
void xiiPlayerStartPointComponent::DeserializeComponent(xiiWorldReader& inout_stream)
{
...
const xiiRangeView<xiiStringView, xiiUInt32> xiiPlayerStartPointComponent::GetParameters() const
{
...
void xiiPlayerStartPointComponent::SetParameter(xiiStringView sKey, const xiiVariant& value)
{
  xiiHashedString hs;
  hs.Assign(sKey);
...
void xiiPlayerStartPointComponent::RemoveParameter(xiiStringView sKey)
{
