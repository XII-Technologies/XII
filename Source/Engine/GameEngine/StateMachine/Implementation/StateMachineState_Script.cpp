...
bool xiiStateMachineState_Script::GetInstanceDataDesc(xiiStateMachineInstanceDataDesc& out_desc)
{
...
const xiiRangeView<const char*, xiiUInt32> xiiStateMachineState_Script::GetParameters() const
{
...
void xiiStateMachineState_Script::RemoveParameter(const char* szKey)
{
...
bool xiiStateMachineState_Script::GetParameter(const char* szKey, xiiVariant& out_value) const
{
