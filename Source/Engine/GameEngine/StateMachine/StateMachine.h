...
private:
  ...
  xiiStateMachineInternal::InstanceDataAllocator m_InstanceDataAllocator;
};
...
private:
  ...
  {
    return xiiStateMachineInternal::InstanceDataAllocator::GetInstanceData(m_InstanceData.GetByteBlobPtr(), uiOffset);
  }
