...
void xiiGameApplication::RenderFps()
{
  ...
  if (cvar_AppShowFPS)
  {
    ...
    {
      xiiDebugRenderer::DrawInfoText(pView->GetHandle(), xiiDebugTextPlacement::BottomLeft, "FPS", xiiFmt("{0} fps, {1} ms", uiFPS, xiiArgF(tDisplayedFrameTime.GetMilliseconds(), 1, false, 4)));
    }
  }
}
