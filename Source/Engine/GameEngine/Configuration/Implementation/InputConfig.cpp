...
XII_CHECK_AT_COMPILETIME_MSG(xiiGameAppInputConfig::MaxInputSlotAlternatives == xiiInputActionConfig::MaxInputSlotAlternatives, "Max values should be kept in sync");
