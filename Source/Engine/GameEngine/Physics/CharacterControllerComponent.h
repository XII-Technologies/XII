...
struct XII_GAMEENGINE_DLL xiiMsgMoveCharacterController : public xiiMessage
{
  XII_DECLARE_MESSAGE_TYPE(xiiMsgMoveCharacterController, xiiMessage);
...
class XII_GAMEENGINE_DLL xiiCharacterControllerComponent : public xiiComponent
{
  XII_DECLARE_ABSTRACT_COMPONENT_TYPE(xiiCharacterControllerComponent, xiiComponent);
...
public:
  ...
  //////////////////////////////////////////////////////////////////////////
  // xiiCharacterControllerComponent
...
public:
  ...
  virtual void RawMove(const xiiVec3& vMoveDeltaGlobal) = 0; // [ scriptable ]
  ...
  virtual void TeleportCharacter(const xiiVec3& vGlobalFootPos) = 0; // [ scriptable ]
  ...
  virtual bool IsDestinationUnobstructed(const xiiVec3& vGlobalFootPos, float fCharacterHeight) = 0; // [ scriptable ]
