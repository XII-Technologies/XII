...
class XII_GAMEENGINE_DLL xiiFakeRopeComponentManager : public xiiComponentManager<class xiiFakeRopeComponent, xiiBlockStorageType::FreeList>
{
public:
...
class XII_GAMEENGINE_DLL xiiFakeRopeComponent : public xiiComponent
{
