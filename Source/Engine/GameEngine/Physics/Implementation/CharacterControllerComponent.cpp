...
XII_BEGIN_ABSTRACT_COMPONENT_TYPE(xiiCharacterControllerComponent, 1)
{
  ...
  {
    new xiiCategoryAttribute("Physics"),
  }
  XII_END_ATTRIBUTES;
  XII_BEGIN_FUNCTIONS
  {
...
void xiiCharacterControllerComponent::SerializeComponent(xiiWorldWriter& inout_stream) const
{
  SUPER::SerializeComponent(inout_stream);
  // auto& s = stream.GetStream();
}

void xiiCharacterControllerComponent::DeserializeComponent(xiiWorldReader& inout_stream)
{
