...
void xiiSimpleAnimationComponent::SerializeComponent(xiiWorldWriter& stream) const
{
...
void xiiSimpleAnimationComponent::DeserializeComponent(xiiWorldReader& stream)
{
