...
void xiiColorAnimationComponent::SerializeComponent(xiiWorldWriter& inout_stream) const
{
...
void xiiColorAnimationComponent::DeserializeComponent(xiiWorldReader& inout_stream)
{
...
void xiiColorAnimationComponent::OnSimulationStarted()
{
  ...
  {
    m_CurAnimTime = xiiTime::MakeFromSeconds(GetWorld()->GetRandomNumberGenerator().DoubleMinMax(0.0, m_Duration.GetSeconds()));
  }
}
