...
// clang-format off
XII_BEGIN_STATIC_REFLECTED_ENUM(xiiFollowPathMode, 1)
  XII_ENUM_CONSTANTS(xiiFollowPathMode::OnlyPosition, xiiFollowPathMode::AlignUpZ, xiiFollowPathMode::FullRotation)
