...
struct XII_GAMEENGINE_DLL xiiMsgPathChanged : public xiiEventMessage
{
  XII_DECLARE_MESSAGE_TYPE(xiiMsgPathChanged, xiiEventMessage);
};
...
public:
  ...
  void OnMsgPathChanged(xiiMsgPathChanged& ref_msg); // [ message handler ]
