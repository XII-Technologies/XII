...
public:
  ...
  virtual xiiUniquePtr<xiiActor> CreateActor(xiiView* pView, xiiEnum<xiiGALMSAASampleCount> msaaCount = xiiGALMSAASampleCount::OneSample, xiiUniquePtr<xiiWindowBase> pCompanionWindow = nullptr, xiiUniquePtr<xiiWindowOutputTargetGAL> pCompanionWindowOutput = nullptr) = 0;
