...
public:
  ...
  xiiUniquePtr<xiiActor> CreateActor(xiiView* pView, xiiGALMSAASampleCount::Enum msaaCount = xiiGALMSAASampleCount::None, xiiUniquePtr<xiiWindowBase> companionWindow = nullptr, xiiUniquePtr<xiiWindowOutputTargetGAL> companionWindowOutput = nullptr) override;
