...
public:
  ...
  xiiUniquePtr<xiiActor> CreateActor(xiiView* pView, xiiGALMSAASampleCount::Enum msaaCount = xiiGALMSAASampleCount::None, xiiUniquePtr<xiiWindowBase> pCompanionWindow = nullptr, xiiUniquePtr<xiiWindowOutputTargetGAL> pCompanionWindowOutput = nullptr) override;
