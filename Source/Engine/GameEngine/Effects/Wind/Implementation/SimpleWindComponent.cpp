...
void xiiSimpleWindComponent::SerializeComponent(xiiWorldWriter& inout_stream) const
{
...
void xiiSimpleWindComponent::DeserializeComponent(xiiWorldReader& inout_stream)
{
