...
xiiQuat xiiCoordinateSystemConversion::ConvertSourceRotation(const xiiQuat& vOrientation) const
{
  xiiVec3 axis = m_mSourceToTarget * vOrientation.v;
  xiiQuat rr(axis.x, axis.y, axis.z, vOrientation.w * m_fWindingSwap);
  return rr;
}
...
xiiQuat xiiCoordinateSystemConversion::ConvertTargetRotation(const xiiQuat& vOrientation) const
{
  xiiVec3 axis = m_mTargetToSource * vOrientation.v;
  xiiQuat rr(axis.x, axis.y, axis.z, vOrientation.w * m_fWindingSwap);
  return rr;
}
