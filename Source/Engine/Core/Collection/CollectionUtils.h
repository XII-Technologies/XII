...
namespace xiiCollectionUtils
{
  ...
  XII_CORE_DLL void AddFiles(xiiCollectionResourceDescriptor& collection, const char* szAssetTypeName, const char* szAbsPathToFolder, const char* szFileExtension, const char* szStripPrefix, const char* szPrependPrefix);
  ...
  XII_CORE_DLL void AddResourceHandle(
    xiiCollectionResourceDescriptor& collection,
    xiiTypelessResourceHandle        handle,
    const char*                      szAssetTypeName,
