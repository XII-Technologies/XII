...
namespace xiiCollectionUtils
{
  ...
  XII_CORE_DLL void AddFiles(xiiCollectionResourceDescriptor& collection, xiiStringView sAssetTypeName, xiiStringView sAbsPathToFolder, xiiStringView sFileExtension, xiiStringView sStripPrefix, xiiStringView sPrependPrefix);
  ...
  /// string.
  XII_CORE_DLL void MergeCollections(xiiCollectionResourceDescriptor& result, xiiArrayPtr<const xiiCollectionResourceDescriptor*> inputCollections);
  ...
  XII_CORE_DLL void DeDuplicateEntries(xiiCollectionResourceDescriptor& result, const xiiCollectionResourceDescriptor& input);
  ...
  XII_CORE_DLL void AddResourceHandle(xiiCollectionResourceDescriptor& collection, xiiTypelessResourceHandle handle, xiiStringView sAssetTypeName, xiiStringView sAbsFolderpath);
