...
bool xiiLuaWrapper::IsVariableAvailable(const char* szName) const
{
...
bool xiiLuaWrapper::IsFunctionAvailable(const char* szFunction) const
{
  if (m_States.m_iOpenTables == 0)
...
XII_STATICLINK_FILE(Core, Core_Scripting_LuaWrapper_Variables);
