...
/// The same seed and position sequence will always produce identical results, which is essential for deterministic gameplay and debugging.
class XII_CORE_DLL xiiScriptExtensionClass_StableRandom
{
public:
...
XII_DECLARE_REFLECTABLE_TYPE(XII_CORE_DLL, xiiScriptExtensionClass_StableRandom);
