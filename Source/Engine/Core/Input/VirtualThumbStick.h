...
class XII_CORE_DLL xiiVirtualThumbStick : public xiiInputDevice
{
...
public:
  ...
  void GetInputArea(xiiVec2& out_vLowerLeft, xiiVec2& out_vUpperRight);
...
protected:
  ...
  xiiVec2 m_vLowerLeft;
  xiiVec2 m_vUpperRight;
  float   m_fRadius;
