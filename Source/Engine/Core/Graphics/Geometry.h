...
public:
  ...
  xiiUInt32 AddVertex(const xiiVec3& vPos, const xiiVec3& vNormal, const xiiVec2& vTexCoord, const xiiColor& color, const xiiUInt16 uiBoneIndex, const xiiMat4& mTransform)
  {
    return AddVertex(mTransform.TransformPosition(vPos), mTransform.TransformDirection(vNormal).GetNormalized(), vTexCoord, color, xiiVec4U16(uiBoneIndex, 0, 0, 0), xiiColorLinearUB(255, 0, 0, 0));
  }
  ...
  void AddRectXY(const xiiVec2& vSize, xiiUInt32 uiTesselationX = 1, xiiUInt32 uiTesselationY = 1, const GeoOptions& options = GeoOptions());
  ...
  void AddPyramid(const xiiVec3& vSize, bool bCap, const GeoOptions& options = GeoOptions());
