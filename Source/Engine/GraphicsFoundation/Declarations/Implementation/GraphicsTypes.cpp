...
XII_BEGIN_STATIC_REFLECTED_ENUM(xiiGALResourceFormat, 1)
  ...
  XII_ENUM_CONSTANT(xiiGALResourceFormat::P010),
  XII_ENUM_CONSTANT(xiiGALResourceFormat::P016),
  XII_ENUM_CONSTANT(xiiGALResourceFormat::YUY2),
  XII_ENUM_CONSTANT(xiiGALResourceFormat::AYUV),
  XII_ENUM_CONSTANT(xiiGALResourceFormat::P216),
  XII_ENUM_CONSTANT(xiiGALResourceFormat::P416),
XII_END_STATIC_REFLECTED_ENUM;
