...
/// [D3D11_FILL_MODE][]/[D3D12_FILL_MODE][] enum.
...
/// [D3D11_CULL_MODE][]/[D3D12_CULL_MODE][] enum.
...
struct XII_GRAPHICSFOUNDATION_DLL xiiGALRasterizerCreationDescription : public xiiHashableStruct<xiiGALRasterizerCreationDescription>
{
  ...
  xiiEnum<xiiGALFillMode> m_FillMode               = xiiGALFillMode::Solid; ///< Determines triangle fill mode. Solid by default.
  xiiEnum<xiiGALCullMode> m_CullMode               = xiiGALCullMode::Back;  ///< Determines triangle cull mode. Back by default.
