...
struct XII_GRAPHICSFOUNDATION_DLL xiiGALRenderTargetBlendDescription : public xiiHashableStruct<xiiGALRenderTargetBlendDescription>
{
  ...
  xiiEnum<xiiGALBlendFactor>    m_DestinationBlend      = xiiGALBlendFactor::One;    ///< Specifies the blend factor to apply to the RGB value in the render target. The default is One.
  ...
  xiiEnum<xiiGALBlendFactor>    m_DestinationBlendAlpha = xiiGALBlendFactor::One;    ///< Specifies the blend factor to apply to the alpha value in the render target. The default is One.
