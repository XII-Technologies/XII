...
const xiiGALTextureFormatDescription& xiiGALTextureUtilities::GetTextureFormatProperties(xiiEnum<xiiGALTextureFormat> format)
{
...
xiiEnum<xiiGALTextureFormat> xiiGALTextureUtilities::GetDefaultTextureViewFormat(xiiEnum<xiiGALTextureFormat> format, xiiEnum<xiiGALTextureViewType> viewType, xiiBitflags<xiiGALBindFlags> bindFlags)
{
...
const xiiGALSparseTextureProperties xiiGALTextureUtilities::GetSparseTextureProperties(xiiEnum<xiiGALTextureFormat> format, xiiEnum<xiiGALResourceDimension> dimension, xiiUInt32 uiSampleCount)
{
