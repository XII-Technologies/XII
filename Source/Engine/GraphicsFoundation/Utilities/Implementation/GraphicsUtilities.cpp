...
xiiEnum<xiiGALGraphicsAdapterVendor> xiiGALGraphicsUtilities::GetVendorFromID(xiiUInt32 uiID)
{
  switch (uiID)
  {
    case 0x01002: // AMD
...
bool xiiGALGraphicsUtilities::IsIdentityComponentMapping(const xiiGALTextureComponentMapping& mapping)
{
...
xiiVec3U32 xiiGALGraphicsUtilities::GetMipLevelSize(xiiUInt32 uiMipLevelSize, const xiiGALTextureCreationDescription& textureDescription)
{
...
xiiUInt32 xiiGALGraphicsUtilities::GetMipSize(xiiUInt32 uiSize, xiiUInt32 uiMipLevel)
{
...
xiiGALTextureCreationDescription xiiGALGraphicsUtilities::GetDefaultTexture1DDescription() noexcept
{
...
xiiGALTextureCreationDescription xiiGALGraphicsUtilities::GetDefaultTexture2DDescription() noexcept
{
  return xiiGALTextureCreationDescription{
...
xiiGALTextureCreationDescription xiiGALGraphicsUtilities::GetDefaultTexture3DDescription() noexcept
{
  return xiiGALTextureCreationDescription{
...
xiiGALTextureCreationDescription xiiGALGraphicsUtilities::GetDefaultTextureCubeDescription() noexcept
{
  return xiiGALTextureCreationDescription{
