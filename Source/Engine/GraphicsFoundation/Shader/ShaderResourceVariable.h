...
public:
  ...
  [[nodiscard]] virtual xiiEnum<xiiGALShaderResourceVariableType> GetType() const = 0;
  ...
  [[nodiscard]] virtual xiiUInt32 GetIndex() const = 0;
  ...
  [[nodiscard]] virtual xiiArrayPtr<xiiGALResource*> Get(xiiUInt32 uiIndex = 0U) const = 0;
