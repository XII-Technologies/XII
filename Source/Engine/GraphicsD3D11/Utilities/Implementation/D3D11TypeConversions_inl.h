...
XII_ALWAYS_INLINE DXGI_FORMAT xiiD3D11TypeConversions::GetFormat(xiiEnum<xiiGALResourceFormat> e)
{
  switch (e)
  {
...
XII_ALWAYS_INLINE xiiEnum<xiiGALResourceFormat> xiiD3D11TypeConversions::GetGALFormat(DXGI_FORMAT e)
{
  switch (e)
  {
