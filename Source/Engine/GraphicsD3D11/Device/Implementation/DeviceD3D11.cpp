...
void xiiGALDeviceD3D11::DestroyCommandListPlatform(xiiGALCommandList* pCommandList)
{
...
void xiiGALDeviceD3D11::FillFormatLookupTable()
{
  ...
  m_FormatLookupTable.SetFormatInfo(xiiGALTextureFormat::RG16Float,                    xiiGALFormatLookupEntryD3D11(DXGI_FORMAT_R16G16_FLOAT).RT(DXGI_FORMAT_R16G16_FLOAT).IL(DXGI_FORMAT_R16G16_FLOAT).RV(DXGI_FORMAT_R16G16_FLOAT));
  ...
  m_FormatLookupTable.SetFormatInfo(xiiGALTextureFormat::D24UNormalizedS8UInt,         xiiGALFormatLookupEntryD3D11(DXGI_FORMAT_D24_UNORM_S8_UINT).D(DXGI_FORMAT_D24_UNORM_S8_UINT).DS(DXGI_FORMAT_D24_UNORM_S8_UINT).S(DXGI_FORMAT_D24_UNORM_S8_UINT));
