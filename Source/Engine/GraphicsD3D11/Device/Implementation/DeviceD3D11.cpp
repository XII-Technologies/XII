...
{
  const xiiGALDeviceImplementationDescription implementation = {.m_APIType = xiiGALGraphicsDeviceType::Direct3D11, .m_sShaderModel = "D3D_SM50", .m_sShaderCompiler = "xiiShaderCompilerFXC" };
