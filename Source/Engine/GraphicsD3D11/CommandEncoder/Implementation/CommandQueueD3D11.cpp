  ...
  xiiGALCommandQueue(pDeviceD3D11, creationDescription), m_pImmediateContext(pDeviceD3D11->GetImmediateContext()), m_WaitForGPUEventHandle{CreateEvent(nullptr, false, false, nullptr)}
{
  ...
  m_pCommandListD3D11                                         = XII_NEW(pDeviceD3D11->GetAllocator(), xiiGALCommandListD3D11, xiiSharedPtr<xiiGALDeviceD3D11>(pDeviceD3D11, pDeviceD3D11->GetAllocator()), this, commandListDescription);
...
{
  XII_DELETE(m_pCommandListD3D11.m_pAllocator, m_pCommandListD3D11.m_pInstance);
...
xiiSharedPtr<xiiGALCommandList> xiiGALCommandQueueD3D11::BeginCommandList()
{
