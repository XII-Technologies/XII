...
void xiiCommandBufferPoolVulkan::Initialize(vk::Device device, xiiUInt32 graphicsFamilyIndex)
{
  m_device = device;
...
void xiiCommandBufferPoolVulkan::DeInitialize()
{
...
vk::CommandBuffer xiiCommandBufferPoolVulkan::RequestCommandBuffer()
{
  XII_ASSERT_DEBUG(m_device, "xiiCommandBufferPoolVulkan::Initialize not called");
...
void xiiCommandBufferPoolVulkan::ReclaimCommandBuffer(vk::CommandBuffer& commandBuffer)
{
  XII_ASSERT_DEBUG(m_device, "xiiCommandBufferPoolVulkan::Initialize not called");
