...
void xiiShaderMetaData::Write(xiiStreamWriter& stream, const xiiArrayPtr<xiiUInt8>& shaderCode, const xiiDynamicArray<xiiShaderDescriptorSetLayout>& sets, const xiiDynamicArray<xiiShaderVertexInputAttribute>& vertexInputAttributes)
{
...
void xiiShaderMetaData::Read(const xiiArrayPtr<const xiiUInt8> data, xiiArrayPtr<const xiiUInt8>& out_shaderCode, xiiDynamicArray<xiiShaderDescriptorSetLayout>& out_sets, xiiDynamicArray<xiiShaderVertexInputAttribute>& out_vertexInputAttributes)
{
