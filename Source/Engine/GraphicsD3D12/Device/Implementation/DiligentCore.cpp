...
{
  s_pAllocator               = XII_DEFAULT_NEW(xiiProxyAllocator, "D3D12-Allocator", xiiFoundation::GetAlignedAllocator());
...
XII_STATICLINK_FILE(GraphicsD3D12, GraphicsD3D12_Device_Implementation_DiligentCore);
