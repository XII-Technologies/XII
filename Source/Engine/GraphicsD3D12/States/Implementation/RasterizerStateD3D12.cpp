...
xiiResult xiiGALRasterizerStateD3D12::InitPlatform(xiiGALDevice* pDevice)
{
  ...
  m_RasterizerState.FrontCounterClockwise = m_Description.m_bFrontCounterClockwise ? TRUE : FALSE;
  ...
  m_RasterizerState.DepthClipEnable       = m_Description.m_bDepthClipEnable ? TRUE : FALSE;
  m_RasterizerState.AntialiasedLineEnable = m_Description.m_bAntialiasedLineEnable ? TRUE : FALSE;
  m_RasterizerState.MultisampleEnable     = m_Description.m_bAntialiasedLineEnable;

  // Not available in the D3D12 API currently.
  // m_RasterizerState.ScissorEnable = m_Description.m_bScissorEnable ? TRUE : FALSE;
