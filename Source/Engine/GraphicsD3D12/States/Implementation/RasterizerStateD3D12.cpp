...
xiiGALRasterizerStateD3D12::xiiGALRasterizerStateD3D12(xiiGALDeviceD3D12* pDeviceD3D12, const xiiGALRasterizerStateCreationDescription& creationDescription) :
  xiiGALRasterizerState(pDeviceD3D12, creationDescription)
{
}
...
xiiResult xiiGALRasterizerStateD3D12::DeInitPlatform()
{
  return XII_SUCCESS;
}
