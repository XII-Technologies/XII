...
xiiGALRenderPassD3D12::xiiGALRenderPassD3D12(xiiSharedPtr<xiiGALDeviceD3D12> pDeviceD3D12, const xiiGALRenderPassCreationDescription& creationDescription) :
  xiiGALRenderPass(std::move(pDeviceD3D12), creationDescription)
{
}
