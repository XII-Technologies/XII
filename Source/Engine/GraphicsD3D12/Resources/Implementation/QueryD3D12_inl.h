...
XII_ALWAYS_INLINE bool xiiGALQueryD3D12::GetData(void* pData, xiiUInt32 uiDataSize, bool bAutoInvalidate)
{
...
XII_ALWAYS_INLINE void xiiGALQueryD3D12::Invalidate()
{
  m_pQuery->Invalidate();
}
