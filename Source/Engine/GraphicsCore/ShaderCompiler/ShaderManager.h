...
{
public:
  static void             Configure(xiiStringView sActivePlatform, bool bEnableRuntimeCompilation, xiiStringView sShaderCacheDirectory = ":shadercache/ShaderCache"_xiisv, xiiStringView sPermVarSubDirectory = "Shaders/PermutationVars"_xiisv);
...
private:
  ...
  static xiiShaderPermutationResourceHandle PreloadSinglePermutationInternal(xiiStringView sResourceId, xiiUInt64 uiResourceIdHash, xiiUInt32 uiPermutationHash, xiiArrayPtr<xiiPermutationVar> filteredPermutationVariables);
