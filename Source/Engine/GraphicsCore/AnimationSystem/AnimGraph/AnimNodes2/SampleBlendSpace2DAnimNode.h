...
struct XII_RENDERERCORE_DLL xiiAnimationClip2D
{
...
XII_DECLARE_REFLECTABLE_TYPE(XII_RENDERERCORE_DLL, xiiAnimationClip2D);

class XII_RENDERERCORE_DLL xiiSampleBlendSpace2DAnimNode : public xiiAnimGraphNode
{
