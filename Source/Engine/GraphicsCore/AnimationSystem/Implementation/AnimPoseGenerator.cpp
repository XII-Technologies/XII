...
void xiiAnimPoseGenerator::Execute(xiiAnimPoseGeneratorCommand& cmd, const xiiGameObject* pSendAnimationEventsTo)
{
  ...
  switch (cmd.GetType())
  {
    ...
    case xiiAnimPoseGeneratorCommandType::LocalToModelPose:
      ExecuteCmd(static_cast<xiiAnimPoseGeneratorCommandLocalToModelPose&>(cmd), pSendAnimationEventsTo);
      break;
...
void xiiAnimPoseGenerator::ExecuteCmd(xiiAnimPoseGeneratorCommandLocalToModelPose& cmd, const xiiGameObject* pSendAnimationEventsTo)
{
