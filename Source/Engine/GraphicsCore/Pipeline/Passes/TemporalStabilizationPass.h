...
/// \brief Compute scaffold for post-temporal stabilization pass.
class XII_GRAPHICSCORE_DLL xiiRenderGraphTemporalStabilizationPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphTemporalStabilizationPass();
  ...
  void SetReactiveMaskInputResourceName(xiiHashedString sResourceName);
  void SetColorOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sReactiveMaskInputResourceName;
  xiiHashedString               m_sColorOutputResourceName;
