...
/// \brief Compute scaffold for skinning and morph target evaluation.
class XII_GRAPHICSCORE_DLL xiiRenderGraphSkinningPass final : public xiiRenderGraphPassBase
{
public:
