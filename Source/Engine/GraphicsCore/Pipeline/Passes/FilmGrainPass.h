...
/// \brief Compute scaffold for film grain synthesis and blending.
class XII_GRAPHICSCORE_DLL xiiRenderGraphFilmGrainPass final : public xiiRenderGraphPassBase
{
public:
