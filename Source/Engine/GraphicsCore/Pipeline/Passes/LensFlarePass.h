...
/// \brief Compute scaffold for lens flare synthesis and additive merge.
class XII_GRAPHICSCORE_DLL xiiRenderGraphLensFlarePass final : public xiiRenderGraphPassBase
{
public:
