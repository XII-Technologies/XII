...
/// \brief Compute scaffold for shadow-caster visibility culling per cascade/local-light frustum.
class XII_GRAPHICSCORE_DLL xiiRenderGraphShadowCasterCullingPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphShadowCasterCullingPass();
