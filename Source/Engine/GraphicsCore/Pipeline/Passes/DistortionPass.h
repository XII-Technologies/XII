...
/// \brief Compute scaffold for distortion vector application and scene warp.
class XII_GRAPHICSCORE_DLL xiiRenderGraphDistortionPass final : public xiiRenderGraphPassBase
{
public:
  ...
  void SetDistortionOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sDistortionOutputResourceName;
