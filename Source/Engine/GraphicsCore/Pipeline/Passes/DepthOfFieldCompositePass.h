...
/// \brief Compute scaffold for compositing depth-of-field blurred and sharp color.
class XII_GRAPHICSCORE_DLL xiiRenderGraphDepthOfFieldCompositePass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphDepthOfFieldCompositePass();
  ...
  void SetBlurInputResourceName(xiiHashedString sResourceName);
  void SetCompositeOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sBlurInputResourceName;
  xiiHashedString               m_sCompositeOutputResourceName;
