...
/// \brief Compute scaffold for separable bloom blur filtering.
class XII_GRAPHICSCORE_DLL xiiRenderGraphBloomBlurPass final : public xiiRenderGraphPassBase
{
public:
  ...
  void SetBloomExtractInputResourceName(xiiHashedString sResourceName);
  void SetBloomBlurOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sBloomExtractInputResourceName;
  xiiHashedString               m_sBloomBlurOutputResourceName;
