...
/// \brief Compute scaffold for volumetric light shaft post effect.
class XII_GRAPHICSCORE_DLL xiiRenderGraphLightShaftsPass final : public xiiRenderGraphPassBase
{
public:
  ...
  void SetLightShaftsOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sLightShaftsOutputResourceName;
