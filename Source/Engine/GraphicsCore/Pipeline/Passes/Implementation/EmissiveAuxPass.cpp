...
namespace { struct xiiEmissiveAutoReg { xiiEmissiveAutoReg() { xiiRenderWorldModule::RegisterPass(XII_DEFAULT_NEW(xiiEmissiveAuxPass)); } }; static xiiEmissiveAutoReg s_AutoReg; }
