...
namespace { struct xiiNRAutoReg { xiiNRAutoReg() { xiiRenderWorldModule::RegisterPass(XII_DEFAULT_NEW(xiiNormalRoughnessPrepassPass)); } }; static xiiNRAutoReg s_AutoReg; }
