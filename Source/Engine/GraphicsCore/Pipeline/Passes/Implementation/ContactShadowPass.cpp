...
namespace { struct xiiContactShadowAutoReg { xiiContactShadowAutoReg() { xiiRenderWorldModule::RegisterPass(XII_DEFAULT_NEW(xiiContactShadowPass)); } }; static xiiContactShadowAutoReg s_AutoReg; }
