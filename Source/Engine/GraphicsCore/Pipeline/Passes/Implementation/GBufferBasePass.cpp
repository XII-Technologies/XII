...
namespace { struct xiiGBufferBaseAutoReg { xiiGBufferBaseAutoReg() { xiiRenderWorldModule::RegisterPass(XII_DEFAULT_NEW(xiiGBufferBasePass)); } }; static xiiGBufferBaseAutoReg s_AutoReg; }
