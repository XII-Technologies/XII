...
namespace { struct xiiHiZOcclAutoReg { xiiHiZOcclAutoReg() { xiiRenderWorldModule::RegisterPass(XII_DEFAULT_NEW(xiiHiZOcclusionCullPass)); } }; static xiiHiZOcclAutoReg s_AutoReg; }
