...
namespace { struct xiiDrawCmdAutoReg { xiiDrawCmdAutoReg() { xiiRenderWorldModule::RegisterPass(XII_DEFAULT_NEW(xiiDrawCommandBuildPass)); } }; static xiiDrawCmdAutoReg s_AutoReg; }
