...
namespace { struct xiiOccluderDepthAutoReg { xiiOccluderDepthAutoReg() { xiiRenderWorldModule::RegisterPass(XII_DEFAULT_NEW(xiiOccluderDepthPrepass)); } }; static xiiOccluderDepthAutoReg s_AutoReg; }
