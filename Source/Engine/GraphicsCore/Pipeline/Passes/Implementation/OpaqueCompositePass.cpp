...
namespace { struct xiiOpaqueCompAutoReg { xiiOpaqueCompAutoReg() { xiiRenderWorldModule::RegisterPass(XII_DEFAULT_NEW(xiiOpaqueCompositePass)); } }; static xiiOpaqueCompAutoReg s_AutoReg; }
