...
namespace { struct xiiShadowCasterCullAutoReg { xiiShadowCasterCullAutoReg() { xiiRenderWorldModule::RegisterPass(XII_DEFAULT_NEW(xiiShadowCasterCullPass)); } }; static xiiShadowCasterCullAutoReg s_AutoReg; }
