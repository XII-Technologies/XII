...
/// \brief Graphics-side orchestration scaffold for frame kickoff work.
class XII_GRAPHICSCORE_DLL xiiRenderGraphFrameKickoffPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphFrameKickoffPass();
