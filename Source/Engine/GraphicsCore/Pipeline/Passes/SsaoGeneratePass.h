...
/// \brief Compute scaffold for SSAO generation from depth and normal buffers.
class XII_GRAPHICSCORE_DLL xiiRenderGraphSsaoGeneratePass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphSsaoGeneratePass();
  ...
  void SetSceneNormalResourceName(xiiHashedString sResourceName);
  void SetSsaoRawResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sSceneNormalResourceName;
  xiiHashedString               m_sSsaoRawResourceName;
