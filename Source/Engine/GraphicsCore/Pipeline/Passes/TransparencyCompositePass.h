...
/// \brief Graphics scaffold for compositing transparent shading into scene color.
class XII_GRAPHICSCORE_DLL xiiRenderGraphTransparencyCompositePass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphTransparencyCompositePass();
