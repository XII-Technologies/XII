...
/// \brief Compute scaffold for luminance histogram generation used by auto-exposure.
class XII_GRAPHICSCORE_DLL xiiRenderGraphExposureHistogramPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphExposureHistogramPass();
  ...
  void SetExposureHistogramResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sExposureHistogramResourceName;
