...
/// \brief Compute scaffold for denoising stochastic reflection signals.
class XII_GRAPHICSCORE_DLL xiiRenderGraphReflectionDenoisePass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphReflectionDenoisePass();
  ...
  void SetReflectionInputResourceName(xiiHashedString sResourceName);
  void SetReflectionOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sReflectionInputResourceName;
  xiiHashedString               m_sReflectionOutputResourceName;
