...
/// \brief Compute scaffold for deferred/clustered lighting accumulation.
class XII_GRAPHICSCORE_DLL xiiRenderGraphDeferredLightingPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphDeferredLightingPass();
  ...
  void SetGBufferResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sGBufferResourceName;
