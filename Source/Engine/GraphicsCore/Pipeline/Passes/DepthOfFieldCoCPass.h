...
/// \brief Compute scaffold for depth-of-field circle-of-confusion generation.
class XII_GRAPHICSCORE_DLL xiiRenderGraphDepthOfFieldCoCPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphDepthOfFieldCoCPass();
  ...
  void SetCoCOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sCoCOutputResourceName;
