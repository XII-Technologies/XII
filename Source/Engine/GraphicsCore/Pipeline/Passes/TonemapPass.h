...
/// \brief Compute scaffold for HDR tonemapping and output transfer.
class XII_GRAPHICSCORE_DLL xiiRenderGraphTonemapPass final : public xiiRenderGraphPassBase
{
public:
  ...
  void SetHdrColorInputResourceName(xiiHashedString sResourceName);
  void SetBloomInputResourceName(xiiHashedString sResourceName);
  void SetLdrOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sHdrColorInputResourceName;
  xiiHashedString               m_sBloomInputResourceName;
  xiiHashedString               m_sLdrOutputResourceName;
