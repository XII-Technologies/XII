...
/// \brief Compute scaffold for generating temporal reactive mask data.
class XII_GRAPHICSCORE_DLL xiiRenderGraphReactiveMaskPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphReactiveMaskPass();
  ...
  void SetReactiveMaskOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sReactiveMaskOutputResourceName;
