...
/// \brief Compute scaffold for dithering prior to output transfer.
class XII_GRAPHICSCORE_DLL xiiRenderGraphDitherPass final : public xiiRenderGraphPassBase
{
public:
  ...
  void SetDitherOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sDitherOutputResourceName;
