...
/// \brief Compute scaffold for Hi-Z-driven occlusion culling.
class XII_GRAPHICSCORE_DLL xiiRenderGraphHiZOcclusionCullingPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphHiZOcclusionCullingPass();
