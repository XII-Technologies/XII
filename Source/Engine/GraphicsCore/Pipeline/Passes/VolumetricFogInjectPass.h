...
/// \brief Compute scaffold for injecting participating-media lighting into froxel volumes.
class XII_GRAPHICSCORE_DLL xiiRenderGraphVolumetricFogInjectPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphVolumetricFogInjectPass();
