...
/// \brief Compute scaffold for compositing atmospheric scattering into scene lighting.
class XII_GRAPHICSCORE_DLL xiiRenderGraphAtmosphericScatteringCompositePass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphAtmosphericScatteringCompositePass();
  ...
  void SetEpipolarScatteringInputResourceName(xiiHashedString sResourceName);
  void SetLightingOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sEpipolarScatteringInputResourceName;
  xiiHashedString               m_sLightingOutputResourceName;
