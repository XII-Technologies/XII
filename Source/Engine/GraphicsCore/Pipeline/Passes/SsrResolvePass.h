...
/// \brief Compute scaffold for resolving SSR hits into reflection color.
class XII_GRAPHICSCORE_DLL xiiRenderGraphSsrResolvePass final : public xiiRenderGraphPassBase
{
public:
  ...
  void SetSsrTraceOutputResourceName(xiiHashedString sResourceName);
  void SetReflectionColorResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sSsrTraceOutputResourceName;
  xiiHashedString               m_sReflectionColorResourceName;
