...
/// \brief Compute scaffold for assigning visible lights to clusters/tiles.
class XII_GRAPHICSCORE_DLL xiiRenderGraphLightListBuildPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphLightListBuildPass();
