...
/// \brief Compute scaffold for motion-vector dilation around disocclusions.
class XII_GRAPHICSCORE_DLL xiiRenderGraphVelocityDilatePass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphVelocityDilatePass();
  ...
  void SetMotionVectorsInputResourceName(xiiHashedString sResourceName);
  void SetMotionVectorsDilatedResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sMotionVectorsInputResourceName;
  xiiHashedString               m_sMotionVectorsDilatedResourceName;
