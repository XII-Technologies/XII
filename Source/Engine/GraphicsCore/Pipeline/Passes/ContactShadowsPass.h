...
/// \brief Compute scaffold for screen-space contact shadow evaluation.
class XII_GRAPHICSCORE_DLL xiiRenderGraphContactShadowsPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphContactShadowsPass();
