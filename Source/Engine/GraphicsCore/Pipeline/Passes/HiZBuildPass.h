...
/// \brief Compute scaffold for hierarchical Z pyramid generation.
class XII_GRAPHICSCORE_DLL xiiRenderGraphHiZBuildPass final : public xiiRenderGraphPassBase
{
public:
