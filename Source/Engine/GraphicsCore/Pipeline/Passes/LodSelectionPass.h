...
/// \brief Compute scaffold for per-instance LOD classification.
class XII_GRAPHICSCORE_DLL xiiRenderGraphLodSelectionPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphLodSelectionPass();
