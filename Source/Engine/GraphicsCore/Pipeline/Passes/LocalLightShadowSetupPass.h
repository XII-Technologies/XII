...
/// \brief Compute scaffold for preparing local-light shadow view/atlas allocation data.
class XII_GRAPHICSCORE_DLL xiiRenderGraphLocalLightShadowSetupPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphLocalLightShadowSetupPass();
