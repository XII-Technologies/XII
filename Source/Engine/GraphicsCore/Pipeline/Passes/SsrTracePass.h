...
/// \brief Compute scaffold for screen-space reflection ray marching.
class XII_GRAPHICSCORE_DLL xiiRenderGraphSsrTracePass final : public xiiRenderGraphPassBase
{
public:
