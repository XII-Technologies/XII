...
/// \brief Compute scaffold for depth-of-field blur filter.
class XII_GRAPHICSCORE_DLL xiiRenderGraphDepthOfFieldBlurPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphDepthOfFieldBlurPass();
  ...
  void SetCoCInputResourceName(xiiHashedString sResourceName);
  void SetBlurOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sCoCInputResourceName;
  xiiHashedString               m_sBlurOutputResourceName;
