...
/// \brief Compute scaffold for compositing SSAO into lighting.
class XII_GRAPHICSCORE_DLL xiiRenderGraphSsaoCompositePass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphSsaoCompositePass();
  ...
  void SetSsaoFilteredResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sSsaoFilteredResourceName;
