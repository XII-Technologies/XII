...
/// \brief Compute scaffold for denoising SSAO output.
class XII_GRAPHICSCORE_DLL xiiRenderGraphSsaoDenoisePass final : public xiiRenderGraphPassBase
{
public:
