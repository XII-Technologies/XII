...
/// \brief Compute scaffold for resolution upscaling.
class XII_GRAPHICSCORE_DLL xiiRenderGraphUpscalePass final : public xiiRenderGraphPassBase
{
public:
  ...
  void SetUpscaledOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sUpscaledOutputResourceName;
