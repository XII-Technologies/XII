...
/// \brief Compute scaffold for temporal adaptation of exposure from luminance histogram.
class XII_GRAPHICSCORE_DLL xiiRenderGraphExposureAdaptPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphExposureAdaptPass();
