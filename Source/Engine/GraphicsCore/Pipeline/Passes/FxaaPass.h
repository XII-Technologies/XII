...
/// \brief Compute scaffold for FXAA edge filtering.
class XII_GRAPHICSCORE_DLL xiiRenderGraphFxaaPass final : public xiiRenderGraphPassBase
{
public:
