...
/// \brief Compute scaffold for velocity-based motion blur filtering.
class XII_GRAPHICSCORE_DLL xiiRenderGraphMotionBlurPass final : public xiiRenderGraphPassBase
{
public:
