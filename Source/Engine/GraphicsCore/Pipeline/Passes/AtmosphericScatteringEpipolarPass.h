...
/// \brief Compute scaffold for epipolar-sampled atmospheric light scattering generation.
class XII_GRAPHICSCORE_DLL xiiRenderGraphAtmosphericScatteringEpipolarPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphAtmosphericScatteringEpipolarPass();
  ...
  void SetShadowDataResourceName(xiiHashedString sResourceName);
  void SetEpipolarScatteringOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sShadowDataResourceName;
  xiiHashedString               m_sEpipolarScatteringOutputResourceName;
