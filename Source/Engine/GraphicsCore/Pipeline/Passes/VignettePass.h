...
/// \brief Compute scaffold for vignette post effect.
class XII_GRAPHICSCORE_DLL xiiRenderGraphVignettePass final : public xiiRenderGraphPassBase
{
public:
