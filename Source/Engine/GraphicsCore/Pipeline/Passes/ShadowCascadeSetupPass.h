...
/// \brief Compute scaffold for directional shadow cascade setup data generation.
class XII_GRAPHICSCORE_DLL xiiRenderGraphShadowCascadeSetupPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphShadowCascadeSetupPass();
