...
/// \brief Graphics scaffold for rendering procedural sky/atmosphere into the scene color target.
class XII_GRAPHICSCORE_DLL xiiRenderGraphSkyAtmospherePass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphSkyAtmospherePass();

  void SetEnabled(bool bEnabled);

  void SetCameraDataResourceName(xiiHashedString sResourceName);
  void SetSceneColorResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sSceneColorResourceName;
