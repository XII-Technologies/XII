...
/// \brief Compute scaffold for integrating volumetric fog along view rays.
class XII_GRAPHICSCORE_DLL xiiRenderGraphVolumetricFogIntegratePass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphVolumetricFogIntegratePass();
  ...
  void SetFogVolumeResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sFogVolumeResourceName;
