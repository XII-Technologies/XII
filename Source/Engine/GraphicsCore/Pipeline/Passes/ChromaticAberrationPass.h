...
/// \brief Compute scaffold for chromatic aberration post effect.
class XII_GRAPHICSCORE_DLL xiiRenderGraphChromaticAberrationPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphChromaticAberrationPass();
