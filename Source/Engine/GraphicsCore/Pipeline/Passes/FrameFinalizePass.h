...
/// \brief Graphics-side orchestration scaffold for frame finalization work.
class XII_GRAPHICSCORE_DLL xiiRenderGraphFrameFinalizePass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphFrameFinalizePass();
