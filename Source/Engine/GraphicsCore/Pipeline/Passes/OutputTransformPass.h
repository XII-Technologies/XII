...
/// \brief Compute scaffold for final output transform (display transfer/gamut mapping).
class XII_GRAPHICSCORE_DLL xiiRenderGraphOutputTransformPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphOutputTransformPass();
  ...
  void SetOutputColorResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sOutputColorResourceName;
