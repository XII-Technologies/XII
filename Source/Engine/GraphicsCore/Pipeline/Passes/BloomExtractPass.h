...
/// \brief Compute scaffold for extracting bright regions for bloom.
class XII_GRAPHICSCORE_DLL xiiRenderGraphBloomExtractPass final : public xiiRenderGraphPassBase
{
public:
  ...
  xiiRenderGraphBloomExtractPass();
  ...
  void SetBloomExtractOutputResourceName(xiiHashedString sResourceName);
...
private:
  ...
  xiiHashedString               m_sBloomExtractOutputResourceName;
