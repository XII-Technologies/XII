...
public:
  ...
  void UpdateGpuBuffer(xiiSharedPtr<xiiGALCommandList> pCommandList, xiiUInt32 uiFirstVertex = 0, xiiUInt32 uiNumVertices = xiiMath::MaxValue<xiiUInt32>(), xiiUInt32 uiFirstIndex = 0, xiiUInt32 uiNumIndices = xiiMath::MaxValue<xiiUInt32>(), xiiBitflags<xiiGALMapFlags> mapFlags = xiiGALMapFlags::Discard);
