...
struct XII_GRAPHICSCORE_DLL alignas(16) xiiMeshlet
{
  XII_DECLARE_POD_TYPE();
...
static_assert(sizeof(xiiMeshlet) % 16U == 0U, "Meshlet records must preserve structured-buffer alignment.");
