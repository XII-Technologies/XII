...
void xiiLensFlareComponent::OnMsgExtractRenderData(xiiMsgExtractRenderData& msg) const
{
  ...
  for (auto& element : m_Elements)
  {
    ...
    msg.AddRenderData(pRenderData, xiiDefaultRenderDataCategories::LitTransparent,
                      pLightComponent != nullptr ? xiiRenderData::Caching::Never : xiiRenderData::Caching::IfStatic);
  }
}
