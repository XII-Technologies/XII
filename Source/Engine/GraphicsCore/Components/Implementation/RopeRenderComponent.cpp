...
void xiiRopeRenderComponent::OnRopePoseUpdated(xiiMsgRopePoseUpdated& msg)
{
  ...
  {
    m_LocalBounds.ExpandToInclude(xiiBoundingBoxSphere::MakeFromBox(newBounds));
...
void xiiRopeRenderComponent::GenerateRenderMesh(xiiUInt32 uiNumRopePieces)
{
  ...
  meshBufferDesc.AddStream(xiiGALVertexAttributeSemantic::BoneIndices0, xiiGALResourceFormat::RGBAUByte);
  meshBufferDesc.AddStream(xiiGALVertexAttributeSemantic::BoneWeights0, xiiGALResourceFormat::RGBAUByteNormalized);
