...
void xiiBeamComponent::CreateMeshes()
{
  ...
  meshName.SetFormat("xiiBeamComponent_{0}_{1}_{2}_{3}.createdAtRuntime.xiiBinMesh", m_fWidth, xiiArgF(targetPositionInOwnerSpace.x, 2), xiiArgF(targetPositionInOwnerSpace.y, 2), xiiArgF(targetPositionInOwnerSpace.z, 2));
