...
void xiiBoxReflectionProbeComponent::SerializeComponent(xiiWorldWriter& inout_stream) const
{
...
void xiiBoxReflectionProbeComponent::DeserializeComponent(xiiWorldReader& inout_stream)
{
...
XII_STATICLINK_FILE(GraphicsCore, GraphicsCore_Lights_Implementation_BoxReflectionProbeComponent);
