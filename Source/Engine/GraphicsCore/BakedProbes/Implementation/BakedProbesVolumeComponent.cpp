...
#include <GraphicsCore/BakedProbes/BakedProbesVolumeComponent.h>
...
void xiiBakedProbesVolumeComponent::SerializeComponent(xiiWorldWriter& inout_stream) const
{
...
void xiiBakedProbesVolumeComponent::DeserializeComponent(xiiWorldReader& inout_stream)
{
...
XII_STATICLINK_FILE(GraphicsCore, GraphicsCore_BakedProbes_Implementation_BakedProbesVolumeComponent);
