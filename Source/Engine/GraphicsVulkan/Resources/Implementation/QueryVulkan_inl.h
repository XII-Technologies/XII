...
XII_ALWAYS_INLINE bool xiiGALQueryVulkan::GetData(void* pData, xiiUInt32 uiDataSize, bool bAutoInvalidate)
{
...
XII_ALWAYS_INLINE void xiiGALQueryVulkan::Invalidate()
{
  m_pQuery->Invalidate();
}
