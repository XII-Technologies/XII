...
xiiGALRenderCommandEncoder::xiiGALRenderCommandEncoder(xiiGALDevice& ref_device, xiiGALCommandEncoderRenderState& ref_renderState, xiiGALCommandEncoderCommonPlatformInterface& ref_commonImpl, xiiGALCommandEncoderRenderPlatformInterface& ref_renderImpl) :
  xiiGALCommandEncoder(ref_device, ref_renderState, ref_commonImpl), m_RenderState(ref_renderState), m_RenderImpl(ref_renderImpl)
{
}

xiiGALRenderCommandEncoder::~xiiGALRenderCommandEncoder() = default;

void xiiGALRenderCommandEncoder::Clear(const xiiColor& clearColor, xiiUInt32 uiRenderTargetClearMask /*= 0xFFFFFFFFu*/, bool bClearDepth /*= true*/, bool bClearStencil /*= true*/, float fDepthClear /*= 1.0f*/, xiiUInt8 uiStencilClear /*= 0x0u*/)
{
...
void xiiGALRenderCommandEncoder::Draw(xiiUInt32 uiVertexCount, xiiUInt32 uiStartVertex)
{
  AssertRenderingThread();
...
void xiiGALRenderCommandEncoder::DrawIndexed(xiiUInt32 uiIndexCount, xiiUInt32 uiStartIndex)
{
  AssertRenderingThread();
...
void xiiGALRenderCommandEncoder::DrawIndexedInstanced(xiiUInt32 uiIndexCountPerInstance, xiiUInt32 uiInstanceCount, xiiUInt32 uiStartIndex)
{
  AssertRenderingThread();
...
void xiiGALRenderCommandEncoder::DrawIndexedInstancedIndirect(xiiGALBufferHandle hIndirectArgumentBuffer, xiiUInt32 uiArgumentOffsetInBytes)
{
  AssertRenderingThread();
  /// \todo Assert for instancing
...
void xiiGALRenderCommandEncoder::DrawInstanced(xiiUInt32 uiVertexCountPerInstance, xiiUInt32 uiInstanceCount, xiiUInt32 uiStartVertex)
{
  AssertRenderingThread();
  /// \todo Assert for instancing
...
void xiiGALRenderCommandEncoder::DrawInstancedIndirect(xiiGALBufferHandle hIndirectArgumentBuffer, xiiUInt32 uiArgumentOffsetInBytes)
{
  AssertRenderingThread();
  /// \todo Assert for instancing
  /// \todo Assert for indirect draw
...
void xiiGALRenderCommandEncoder::DrawAuto()
{
  AssertRenderingThread();
...
void xiiGALRenderCommandEncoder::BeginStreamOut()
{
  AssertRenderingThread();
...
void xiiGALRenderCommandEncoder::EndStreamOut()
{
  AssertRenderingThread();
...
void xiiGALRenderCommandEncoder::SetIndexBuffer(xiiGALBufferHandle hIndexBuffer)
{
...
void xiiGALRenderCommandEncoder::SetVertexBuffer(xiiUInt32 uiSlot, xiiGALBufferHandle hVertexBuffer)
{
...
void xiiGALRenderCommandEncoder::SetPrimitiveTopology(xiiGALPrimitiveTopology::Enum topology)
{
  AssertRenderingThread();
...
void xiiGALRenderCommandEncoder::SetVertexDeclaration(xiiGALVertexDeclarationHandle hVertexDeclaration)
{
  AssertRenderingThread();
  ...
  const xiiGALVertexDeclaration* pVertexDeclaration = GetDevice().GetVertexDeclaration(hVertexDeclaration);
  // Assert on vertex buffer type (if non-zero)
...
void xiiGALRenderCommandEncoder::SetBlendState(xiiGALBlendStateHandle hBlendState, const xiiColor& blendFactor, xiiUInt32 uiSampleMask)
{
  AssertRenderingThread();
...
void xiiGALRenderCommandEncoder::SetDepthStencilState(xiiGALDepthStencilStateHandle hDepthStencilState, xiiUInt8 uiStencilRefValue /*= 0xFFu*/)
{
  AssertRenderingThread();
...
void xiiGALRenderCommandEncoder::SetRasterizerState(xiiGALRasterizerStateHandle hRasterizerState)
{
  AssertRenderingThread();
...
void xiiGALRenderCommandEncoder::SetViewport(const xiiRectFloat& rect, float fMinDepth, float fMaxDepth)
{
  AssertRenderingThread();
...
void xiiGALRenderCommandEncoder::SetScissorRect(const xiiRectU32& rect)
{
  AssertRenderingThread();
...
void xiiGALRenderCommandEncoder::SetStreamOutBuffer(xiiUInt32 uiSlot, xiiGALBufferHandle hBuffer, xiiUInt32 uiOffset)
{
...
void xiiGALRenderCommandEncoder::ClearStatisticsCounters()
{
