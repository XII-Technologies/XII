...
///
///   class XII_DLL_IMPORT_EXPORT_STUFF A : public xiiEnumerable<A>
///   {
///     XII_DECLARE_ENUMERABLE_CLASS(A); // since A is declared as DLL import/export all code embedded in its body will also work properly
///     ...
///   };
///
...
class xiiEnumerable : public Base
{
public:
  xiiEnumerable()
  {
  ...
  virtual ~xiiEnumerable()
  {
    --Derived::s_uiInstances;
    xiiEnumerable* pPrev = nullptr;
    xiiEnumerable* pCur  = Derived::s_pFirstInstance;
...
private:                                                   \
  ...
  static xiiUInt32                  s_uiInstances;         \
                                                           \
public:                                                    \
...
#define XII_ENUMERABLE_CLASS_IMPLEMENTATION(self)                                 \
  xiiEnumerable<self, self::xiiEnumerableBase>* self::s_pFirstInstance = nullptr; \
  xiiEnumerable<self, self::xiiEnumerableBase>* self::s_pLastInstance  = nullptr; \
  xiiUInt32                                     self::s_uiInstances    = 0
