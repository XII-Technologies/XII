...
namespace xiiGraphicsUtils
{
  ...
  ///
  /// Since this only creates a rotation matrix, vTarget can be interpreted both as a position or a direction.
  XII_FOUNDATION_DLL xiiMat3d CreateLookAtViewMatrix(
    const xiiVec3d&     vTarget,
    const xiiVec3d&     vUpDir,
    xiiHandedness::Enum handedness = xiiHandedness::Default); // [tested]
  ...
  /// \brief Same as CreateLookAtViewMatrix() but returns the inverse matrix
  XII_FOUNDATION_DLL xiiMat3d CreateInverseLookAtViewMatrix(
    const xiiVec3d&     vTarget,
    const xiiVec3d&     vUpDir,
    xiiHandedness::Enum handedness = xiiHandedness::Default); // [tested]
  ...
  /// \brief Returns a look-at matrix with both rotation and translation
  XII_FOUNDATION_DLL xiiMat4d CreateLookAtViewMatrix(const xiiVec3d& vEyePos, const xiiVec3d& vLookAtPos, const xiiVec3d& vUpDir,
                                                     xiiHandedness::Enum handedness = xiiHandedness::Default); // [tested]
  ...
  /// \brief Same as CreateLookAtViewMatrix() but returns the inverse matrix
  XII_FOUNDATION_DLL xiiMat4d CreateInverseLookAtViewMatrix(const xiiVec3d& vEyePos, const xiiVec3d& vLookAtPos, const xiiVec3d& vUpDir,
                                                            xiiHandedness::Enum handedness = xiiHandedness::Default); // [tested]
  ...
  ///
  /// The vectors are put into the appropriate matrix rows and depending on the handedness negated where necessary.
  XII_FOUNDATION_DLL xiiMat4d CreateViewMatrix(const xiiVec3d& vPosition, const xiiVec3d& vForwardDir, const xiiVec3d& vRightDir, const xiiVec3d& vUpDir,
                                               xiiHandedness::Enum handedness = xiiHandedness::Default); // [tested]
  ...
  /// \brief Similar to CreateViewMatrix() but creates the inverse matrix.
  XII_FOUNDATION_DLL xiiMat4d CreateInverseViewMatrix(const xiiVec3d& vPosition, const xiiVec3d& vForwardDir, const xiiVec3d& vRightDir, const xiiVec3d& vUpDir,
                                                      xiiHandedness::Enum handedness = xiiHandedness::Default); // [tested]
