...
public:
  ...
  XII_ALWAYS_INLINE xiiDelegateBase() { m_Instance.m_Ptr = nullptr; }
...
/// takes two parameters, the first being xiiUInt32, the second being a float parameter.
...
///
/// \code{.cpp}
///   void SomeFunction(xiiUInt32 i, float f);
...
///   };
///   SomeClass instance;
///   SomeCallback callback = xiiDelegate<void (xiiUInt32, float)>(&SomeClass::SomeFunction, &instance);
/// \endcode
///
...
template <typename T, xiiUInt32 DataSize = 16>
struct xiiDelegate : public xiiDelegateBase
{
};
...
///   };
///   Example instance;
///   auto delegate = xiiMakeDelegate(&Example::foo, &instance);
/// \endcode
template <typename Method, typename Class>
typename xiiMakeDelegateHelper<Method>::DelegateType xiiMakeDelegate(Method method, Class* pClass);
