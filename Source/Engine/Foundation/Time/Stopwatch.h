...
class XII_FOUNDATION_DLL xiiStopwatch
{
public:
  ...
  xiiTime GetRunningTotal() const; // [tested]
  ...
  xiiTime Checkpoint(); // [tested]

private:
  bool            m_bRunning;
  mutable xiiTime m_LastUpdate;
  xiiTime         m_LastCheckpoint;
  mutable xiiTime m_TotalDuration;
};
