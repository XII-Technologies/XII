...
/// \brief The xiiFileSystem provides high-level functionality to manage files in a virtual file system.
///
...
private:
  ...
  /// \brief This is used by the actual file readers (like xiiFileReader) to get an abstract file reader.
  ///
...
/// \brief Describes the type of events that are broadcast by the xiiFileSystem.
...
/// \brief The event data that is broadcast by the xiiFileSystem upon certain file operations.
