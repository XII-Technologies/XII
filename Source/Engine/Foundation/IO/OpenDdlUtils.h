...
{
  /// \brief Converts the data that \a pElement points to to a xiiColor.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiColorGammaUB.
  ///
  /// \a pElement may be a primitives list of 3 or 4 floats or of 3 or 4 unsigned int8 values.
  /// It may also be a group that contains such a primitives list as the only child.
  /// floats will be interpreted as linear colors, unsigned int 8 will be interpreted as xiiColorGammaUB.
  ...
  /// \brief Converts the data that \a pElement points to to a xiiTime.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec2.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec2d.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec3.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec3d.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec4.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec4d.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec2I32.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec2I64.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec3I32.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec3I64.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec4I32.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec4I64.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec2U32.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec2U64.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec3U32.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec3U64.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec4U32.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiVec4U64.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiMat3.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiMat3d.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiMat4.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiMat4d.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiTransform.
  ///
  ...
  /// \brief Converts the data that \a pElement points to to a xiiTransformd.
  ///
  ...
  /// \brief Writes a xiiColor to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiColorGammaUB to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiTime to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec2 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec2d to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec3 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec3d to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec4 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec4d to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec2I32 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec2I64 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec3I32 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec3I64 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec4I32 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec4I64 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec2U32 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec2U64 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec3U32 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec3U64 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec4U32 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiVec4U64 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiMat3 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiMat3d to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiMat4 to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiMat4d to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiTransform to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiTransformd to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiQuat to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiQuatd to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiUuid to DDL such that the type can be reconstructed.
  ...
  /// \brief Writes a xiiAngle to DDL such that the type can be reconstructed.
