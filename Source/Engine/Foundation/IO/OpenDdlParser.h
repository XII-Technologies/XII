...
private:
  ...
  void      SkipWhitespace();
  void      ContinueIdle();
  void      ReadIdentifier(xiiUInt8* szString, xiiUInt32& count);
  void      ReadString();
  void      ReadWord();
  xiiUInt64 ReadDecimalLiteral();
  ...
  xiiHybridArray<DdlState, 32> m_StateStack;
  ...
  xiiUInt8                  m_szIdentifierType[s_uiMaxIdentifierLength];
  xiiUInt8                  m_szIdentifierName[s_uiMaxIdentifierLength];
  xiiDynamicArray<xiiUInt8> m_TempString;
  xiiUInt32                 m_uiTempStringLength;

  xiiUInt32  m_uiNumCachedPrimitives;
  bool*      m_pBoolCache;
  xiiInt8*   m_pInt8Cache;
  xiiInt16*  m_pInt16Cache;
  xiiInt32*  m_pInt32Cache;
  xiiInt64*  m_pInt64Cache;
  xiiUInt8*  m_pUInt8Cache;
  xiiUInt16* m_pUInt16Cache;
  xiiUInt32* m_pUInt32Cache;
  xiiUInt64* m_pUInt64Cache;
  float*     m_pFloatCache;
