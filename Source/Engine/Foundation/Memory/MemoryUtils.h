...
public:
  ...
  template <typename T>
  static void PatternFill(T* pDestination, xiiUInt8 uiBytePattern, size_t uiCount); // [tested]

  /// \brief Fills every byte of the provided buffer with the given value
  template <typename T, size_t N>
  static void PatternFill(T (&destination)[N], xiiUInt8 uiBytePattern); // [tested]
