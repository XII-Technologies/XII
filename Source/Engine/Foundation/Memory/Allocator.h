...
class xiiAllocator : public xiiInternal::xiiAllocatorMixinReallocate<AllocationPolicy, TrackingMode, xiiHasReallocate<AllocationPolicy, void* (AllocationPolicy::*)(void*, size_t, size_t, size_t)>::value>
{
public:
