namespace xiiInternal
{
  ...
  class xiiAllocatorImpl : public xiiAllocator
  {
  public:
    xiiAllocatorImpl(xiiStringView sName, xiiAllocator* pParent);
    ~xiiAllocatorImpl();

    // xiiAllocator implementation
  ...
  {
  public:
    xiiAllocatorMixinReallocate(xiiStringView sName, xiiAllocator* pParent);
  };
...
XII_FORCE_INLINE xiiInternal::xiiAllocatorImpl<A, TrackingMode>::xiiAllocatorImpl(xiiStringView sName, xiiAllocator* pParent /* = nullptr */) :
...
template <typename A, xiiAllocatorTrackingMode TrackingMode>
xiiAllocator::Stats xiiInternal::xiiAllocatorImpl<A, TrackingMode>::GetStats() const
{
  if constexpr (TrackingMode >= xiiAllocatorTrackingMode::Basics)
  {
...
template <typename A, xiiAllocatorTrackingMode TrackingMode>
XII_ALWAYS_INLINE xiiAllocator* xiiInternal::xiiAllocatorImpl<A, TrackingMode>::GetParent() const
{
  return m_allocator.GetParent();
}

template <typename A, xiiAllocatorTrackingMode TrackingMode, bool HasReallocate>
xiiInternal::xiiAllocatorMixinReallocate<A, TrackingMode, HasReallocate>::xiiAllocatorMixinReallocate(xiiStringView sName, xiiAllocator* pParent) :
  xiiAllocatorImpl<A, TrackingMode>(sName, pParent)
{
}

template <typename A, xiiAllocatorTrackingMode TrackingMode>
xiiInternal::xiiAllocatorMixinReallocate<A, TrackingMode, true>::xiiAllocatorMixinReallocate(xiiStringView sName, xiiAllocator* pParent) :
  xiiAllocatorImpl<A, TrackingMode>(sName, pParent)
{
}
