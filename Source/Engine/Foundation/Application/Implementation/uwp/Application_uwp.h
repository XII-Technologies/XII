...
class xiiUwpApplication : public winrt::implements<xiiUwpApplication, winrt::Windows::ApplicationModel::Core::IFrameworkView, winrt::Windows::ApplicationModel::Core::IFrameworkViewSource>
{
public:
  xiiUwpApplication(xiiApplication* application);
  virtual ~xiiUwpApplication();
...
private:
  ...
  xiiApplication*            m_application;
  xiiDynamicArray<xiiString> m_commandLineArgs;
};
