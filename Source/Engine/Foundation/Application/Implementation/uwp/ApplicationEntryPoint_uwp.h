...
extern XII_FOUNDATION_DLL xiiResult xiiUWPRun(xiiApplication* pApp);

namespace xiiApplicationDetails
{
  XII_FOUNDATION_DLL xiiResult InitializeWinrt();
  XII_FOUNDATION_DLL void      UninitializeWinrt();
...
#define XII_CONSOLEAPP_ENTRY_POINT(AppClass, ...)                                                                                 \
  ...
  int main(int argc, const char** argv) { return ::xiiApplicationDetails::EntryFunc<AppClass>(__VA_ARGS__); }
...
#define XII_APPLICATION_ENTRY_POINT(AppClass, ...)                                                  \
  ...
  {                                                                                                 \
    return ::xiiApplicationDetails::EntryFunc<AppClass>(__VA_ARGS__);                               \
  }
