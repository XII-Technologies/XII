...
namespace xiiTokenParseUtils
{
  ...
  XII_FOUNDATION_DLL bool Accept(const TokenStream& tokens, xiiUInt32& ref_uiCurToken, xiiStringView sToken, xiiUInt32* pAccepted = nullptr);
  ...
  XII_FOUNDATION_DLL bool Accept(const TokenStream& tokens, xiiUInt32& ref_uiCurToken, xiiStringView sToken1, xiiStringView sToken2, xiiUInt32* pAccepted = nullptr);
  XII_FOUNDATION_DLL bool AcceptUnless(const TokenStream& tokens, xiiUInt32& ref_uiCurToken, xiiStringView sToken1, xiiStringView sToken2, xiiUInt32* pAccepted = nullptr);
