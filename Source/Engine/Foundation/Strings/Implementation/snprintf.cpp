...
int xiiStringUtils::vsnprintf(char* szOutputBuffer, unsigned int uiBufferSize, const char* szFormat, va_list args0)
{
  va_list args;
  va_copy(args, args0);
...
void xiiStringUtils::OutputFormattedFloat(char* szOutputBuffer, xiiUInt32 uiBufferSize, xiiUInt32& uiWritePos, double value, xiiUInt8 uiWidth, bool bPadZeros, xiiInt8 iPrecision, bool bScientific, bool bRemoveTrailingZeroes)
{
  OutputFloat(szOutputBuffer, uiBufferSize, uiWritePos, value, uiWidth, xiiMath::Max<int>(-1, iPrecision), bPadZeros ? sprintfFlags::PadZeros : 0,
