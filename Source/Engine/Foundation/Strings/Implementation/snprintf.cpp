...
struct sprintfFlags
{
  ...
  {
    None,
    LeftJustify   = XII_BIT(0), // -
    ForceSign     = XII_BIT(1), // +
    BlankSign     = XII_BIT(2), // (space)
    Hash          = XII_BIT(3), // #
    PadZeros      = XII_BIT(4), // 0
    ForceZeroSign = XII_BIT(5), // [internal] Prints a '+' even for zero
  };
};
...
static void OutputIntSign(char* szOutputBuffer, unsigned int uiBufferSize, unsigned int& ref_uiWritePos, long long int value, unsigned int uiFlags, int iBase, bool bUpperCase, int iPrecision)
{
  if (value < 0)
    OutputChar(szOutputBuffer, uiBufferSize, ref_uiWritePos, '-');
...
static void OutputIntSignAndPadding(char* szOutputBuffer, unsigned int uiBufferSize, unsigned int& ref_uiWritePos, long long int value, unsigned int uiFlags, int iPadding, int iBase, bool bUpperCase, int iPrecision)
{
  if (uiFlags & sprintfFlags::PadZeros)
  {
...
static void OutputInt(char* szOutputBuffer, unsigned int uiBufferSize, unsigned int& ref_uiWritePos, long long int value, int iWidth, int iPrecision, unsigned int uiFlags, int iBase)
{
...
static void OutputUInt(char* szOutputBuffer, unsigned int uiBufferSize, unsigned int& ref_uiWritePos, unsigned long long int value, int iWidth, int iPrecision, unsigned int uiFlags, int iBase, bool bUpperCase)
{
...
static void FormatUFloatScientific(char* szOutputBuffer, unsigned int uiBufferSize, unsigned int& ref_uiWritePos, double& ref_fValue0, int iPrecision, unsigned int uiFlags, bool bUpperCase, bool bRemoveZeroes)
{
  if (IsNaN(ref_fValue0))
  {
    ref_fValue0 = 0;
...
static void OutputFloat(char* szOutputBuffer, unsigned int uiBufferSize, unsigned int& ref_uiWritePos, double value, int iWidth, int iPrecision, unsigned int uiFlags, bool bUpperCase, bool bScientific, bool bRemoveZeroes)
{
  char         szBuffer[128];
...
static void OutputFloat_Short(char* szOutputBuffer, unsigned int uiBufferSize, unsigned int& ref_uiWritePos, double value, int iWidth, int iPrecision, unsigned int uiFlags, bool bUpperCase)
{
...
int xiiStringUtils::vsnprintf(char* szOutputBuffer, unsigned int uiBufferSize, const char* szFormat, va_list szArgs0)
{
  va_list args;
...
int xiiStringUtils::snprintf(char* szOutputBuffer, unsigned int uiBufferSize, const char* szFormat, ...)
{
  va_list args;
