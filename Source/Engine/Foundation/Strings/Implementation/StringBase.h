...
struct xiiStringBase : public xiiThisIsAString
{
public:
  ...
  bool IsEqual(xiiStringView sOther) const; // [tested]
  ...
  /// Compares this string with the other string for equality.
  bool IsEqual_NoCase(xiiStringView sOther) const; // [tested]
  ...
  operator xiiStringView() const; // [tested]

  /// \brief Returns a string view to this string's data.
  xiiStringView GetView() const; // [tested]

  /// \brief Returns a pointer to the internal Utf8 string.
  XII_ALWAYS_INLINE operator const char*() const { return InternalGetData(); }

  /// \brief Fills the given container with xiiStringView's which represent each found substring.
  ...
  /// \brief Returns true, if the given path represents a 'rooted' path. See xiiFileSystem for details.
...
private:
  ...
  xiiUInt32   InternalGetElementCount() const;

  template <typename Derived2>
  friend typename xiiStringBase<Derived2>::iterator begin(const xiiStringBase<Derived2>& container);

  template <typename Derived2>
  friend typename xiiStringBase<Derived2>::const_iterator cbegin(const xiiStringBase<Derived2>& container);

  template <typename Derived2>
  friend typename xiiStringBase<Derived2>::iterator end(const xiiStringBase<Derived2>& container);

  template <typename Derived2>
  friend typename xiiStringBase<Derived2>::const_iterator cend(const xiiStringBase<Derived2>& container);

  template <typename Derived2>
  friend typename xiiStringBase<Derived2>::reverse_iterator rbegin(const xiiStringBase<Derived2>& container);

  template <typename Derived2>
  friend typename xiiStringBase<Derived2>::const_reverse_iterator crbegin(const xiiStringBase<Derived2>& container);

  template <typename Derived2>
  friend typename xiiStringBase<Derived2>::reverse_iterator rend(const xiiStringBase<Derived2>& container);

  template <typename Derived2>
  friend typename xiiStringBase<Derived2>::const_reverse_iterator crend(const xiiStringBase<Derived2>& container);
};


template <typename Derived>
typename xiiStringBase<Derived>::iterator begin(const xiiStringBase<Derived>& container)
{
  return typename xiiStringBase<Derived>::iterator(container.InternalGetData(), container.InternalGetDataEnd(), container.InternalGetData());
}

template <typename Derived>
typename xiiStringBase<Derived>::const_iterator cbegin(const xiiStringBase<Derived>& container)
{
  return typename xiiStringBase<Derived>::const_iterator(container.InternalGetData(), container.InternalGetDataEnd(), container.InternalGetData());
}

template <typename Derived>
typename xiiStringBase<Derived>::iterator end(const xiiStringBase<Derived>& container)
{
  return typename xiiStringBase<Derived>::iterator(container.InternalGetData(), container.InternalGetDataEnd(), container.InternalGetDataEnd());
}

template <typename Derived>
typename xiiStringBase<Derived>::const_iterator cend(const xiiStringBase<Derived>& container)
{
  return typename xiiStringBase<Derived>::const_iterator(container.InternalGetData(), container.InternalGetDataEnd(), container.InternalGetDataEnd());
}


template <typename Derived>
typename xiiStringBase<Derived>::reverse_iterator rbegin(const xiiStringBase<Derived>& container)
{
  return typename xiiStringBase<Derived>::reverse_iterator(container.InternalGetData(), container.InternalGetDataEnd(), container.InternalGetDataEnd());
}

template <typename Derived>
typename xiiStringBase<Derived>::const_reverse_iterator crbegin(const xiiStringBase<Derived>& container)
{
  return typename xiiStringBase<Derived>::const_reverse_iterator(container.InternalGetData(), container.InternalGetDataEnd(), container.InternalGetDataEnd());
}

template <typename Derived>
typename xiiStringBase<Derived>::reverse_iterator rend(const xiiStringBase<Derived>& container)
{
  return typename xiiStringBase<Derived>::reverse_iterator(container.InternalGetData(), container.InternalGetDataEnd(), nullptr);
}

template <typename Derived>
typename xiiStringBase<Derived>::const_reverse_iterator crend(const xiiStringBase<Derived>& container)
{
  return typename xiiStringBase<Derived>::const_reverse_iterator(container.InternalGetData(), container.InternalGetDataEnd(), nullptr);
}
