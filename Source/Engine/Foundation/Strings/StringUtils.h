...
public:
  ...
  /// \brief Recomputes the end pointer of a string (\a szStringEnd), if that is currently set to xiiMaxStringEnd. Otherwise does nothing.
  template <typename T>
  ...
  template <typename T>
  static constexpr xiiUInt32 GetStringElementCount(const T* pString); // [tested]
  ...
  /// Equal to the number of characters in a string, if used with UTF-32 strings.
  template <typename T>
  static xiiUInt32 GetStringElementCount(const T* pString, const T* pStringEnd); // [tested]
  ...
  /// pointer.
  static xiiUInt32 GetCharacterCount(const char* szUtf8, const char* pStringEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  static void GetCharacterAndElementCount(const char* szUtf8, xiiUInt32& ref_uiCharacterCount, xiiUInt32& ref_uiElementCount, const char* pStringEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  static xiiUInt32 Copy(char* szDest, xiiUInt32 uiDstSize, const char* szSource, const char* pSourceEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  ///  I.e. they will be truncated at a character boundary.
  /// Returns the number of bytes that were copied into szDest, excluding the terminating \0
  static xiiUInt32 CopyN(char* szDest, xiiUInt32 uiDstSize, const char* szSource, xiiUInt32 uiCharsToCopy, const char* pSourceEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Returns the upper case code point for uiChar.
  static xiiUInt32 ToUpperChar(xiiUInt32 uiChar); // [tested]

  /// \brief Returns the lower case code point for uiChar.
  static xiiUInt32 ToLowerChar(xiiUInt32 uiChar); // [tested]
  ...
  static xiiUInt32 ToUpperString(char* szString, const char* pStringEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Converts a (UTF-8) string in-place to lower case.
  ///
  /// Returns the new string length in bytes (it might shrink, but never grow), excluding the \0 terminator.
  static xiiUInt32 ToLowerString(char* szString, const char* pStringEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  static xiiInt32 CompareChars(xiiUInt32 uiCharacter1, xiiUInt32 uiCharacter2); // [tested]
  ...
  /// Returns 0 if both are equal.
  static xiiInt32 CompareChars(const char* szUtf8Char1, const char* szUtf8Char2); // [tested]
  ...
  /// Returns a positive number, if uiCharacter1 is larger than uiCharacter2.
  /// Returns 0 if both are equal.
  static xiiInt32 CompareChars_NoCase(xiiUInt32 uiCharacter1, xiiUInt32 uiCharacter2); // [tested]
  ...
  /// Returns a positive number, if szUtf8Char1 is larger than szUtf8Char2.
  /// Returns 0 if both are equal.
  static xiiInt32 CompareChars_NoCase(const char* szUtf8Char1, const char* szUtf8Char2); // [tested]

  /// \brief Returns true, if the two given strings are identical (bitwise).
  static bool IsEqual(const char* pString1, const char* pString2, const char* pString1End = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* pString2End = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  static bool IsEqualN(const char* pString1, const char* pString2, xiiUInt32 uiCharsToCompare, const char* pString1End = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* pString2End = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Returns true, if the two given strings are identical (case-insensitive).
  static bool IsEqual_NoCase(const char* pString1, const char* pString2, const char* pString1End = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* pString2End = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Returns true, if the two given strings are identical (case-insensitive) up to the n-th character.
  ///
  /// This function will handle UTF-8 strings properly.
  static bool IsEqualN_NoCase(const char* pString1, const char* pString2, xiiUInt32 uiCharsToCompare, const char* pString1End = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* pString2End = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  static xiiInt32 Compare(const char* pString1, const char* pString2, const char* pString1End = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* pString2End = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  /// Returns 0 for equal strings.
  /// Works with UTF-8 strings as well.
  static xiiInt32 CompareN(const char* pString1, const char* pString2, xiiUInt32 uiCharsToCompare, const char* pString1End = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* pString2End = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  /// Returns 0 for equal strings.
  /// Works with UTF-8 strings as well.
  static xiiInt32 Compare_NoCase(const char* pString1, const char* pString2, const char* pString1End = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* pString2End = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  /// Returns 0 for equal strings.
  /// Works with UTF-8 strings as well.
  static xiiInt32 CompareN_NoCase(const char* pString1, const char* pString2, xiiUInt32 uiCharsToCompare, const char* pString1End = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* pString2End = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  static xiiInt32 snprintf(char* szDst, xiiUInt32 uiDstSize, const char* szFormat, ...); // [tested]
  ...
  /// Formatting works exactly like printf, except that it additionally supports outputting binary with the 'b' modifier and it will
  /// output float NaN and Infinity as proper text.
  static xiiInt32 vsnprintf(char* szDst, xiiUInt32 uiDstSize, const char* szFormat, va_list szAp); // [tested]

  /// \brief Returns true if szString starts with the string given in szStartsWith.
  static bool StartsWith(const char* szString, const char* szStartsWith, const char* pStringEnd = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* szStartsWithEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Returns true if szString starts with the string given in szStartsWith. Ignores case.
  static bool StartsWith_NoCase(const char* szString, const char* szStartsWith, const char* pStringEnd = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* szStartsWithEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Returns true if szString ends with the string given in szEndsWith.
  static bool EndsWith(const char* szString, const char* szEndsWith, const char* pStringEnd = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* szEndsWithEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Returns true if szString ends with the string given in szEndsWith. Ignores case.
  static bool EndsWith_NoCase(const char* szString, const char* szEndsWith, const char* pStringEnd = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* szEndsWithEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Searches for the first occurrence of szStringToFind in szSource.
  static const char* FindSubString(const char* szSource, const char* szStringToFind, const char* pSourceEnd = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* szStringToFindEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Searches for the first occurrence of szStringToFind in szSource. Ignores case.
  static const char* FindSubString_NoCase(const char* szSource, const char* szStringToFind, const char* pSourceEnd = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* szStringToFindEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Searches for the last occurrence of szStringToFind in szSource before szStartSearchAt.
  static const char* FindLastSubString(const char* szSource, const char* szStringToFind, const char* szStartSearchAt = nullptr, const char* pSourceEnd = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* szStringToFindEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Searches for the last occurrence of szStringToFind in szSource before szStartSearchAt. Ignores case.
  static const char* FindLastSubString_NoCase(const char* szSource, const char* szStringToFind, const char* szStartSearchAt = nullptr, const char* pSourceEnd = xiiUnicodeUtils::GetMaxStringEnd<char>(), const char* szStringToFindEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  using XII_CHARACTER_FILTER = bool (*)(xiiUInt32 uiChar);
  ...
  static const char* SkipCharacters(const char* szString, XII_CHARACTER_FILTER skipCharacterCB, bool bAlwaysSkipFirst = false); // [tested]
  ...
  static const char* FindWordEnd(const char* szString, XII_CHARACTER_FILTER isDelimiterCB, bool bAlwaysSkipFirst = true); // [tested]
  ...
  /// \param pStringEnd The end pointer into pString, either the end pointer for the not zero terminated string or xiiMaxStringEnd for zero
  ...
  static void Trim(const char*& ref_pString, const char*& ref_pStringEnd, const char* szTrimCharsStart, const char* szTrimCharsEnd); // [tested] via xiiStringView and xiiStringBuilder

  /// \brief A default word delimiter function that returns true for ' ' (space), '\r' (carriage return), '\n' (newline), '\t' (tab) and
  /// '\v' (vertical tab)
  static bool IsWhiteSpace(xiiUInt32 uiChar); // [tested]

  /// \brief A decimal digit from 0..9
  static bool IsDecimalDigit(xiiUInt32 uiChar); // [tested]

  /// \brief A hexadecimal digit from 0..F
  static bool IsHexDigit(xiiUInt32 uiChar); // [tested]

  /// \brief A default word delimiter function for English text.
  static bool IsWordDelimiter_English(xiiUInt32 uiChar); // [tested]

  /// \brief A default word delimiter function for identifiers in C code.
  static bool IsIdentifierDelimiter_C_Code(xiiUInt32 uiChar); // [tested]
  ...
  static bool IsValidIdentifierName(const char* pString, const char* pStringEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]
  ...
  static const char* FindWholeWord(const char* szString, const char* szSearchFor, XII_CHARACTER_FILTER isDelimiterCB, const char* pStringEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Searches szString for the word szSearchFor. If IsDelimiterCB returns true for both characters in front and back of the word,
  /// the position is returned. Otherwise nullptr. Ignores case.
  static const char* FindWholeWord_NoCase(const char* szString, const char* szSearchFor, XII_CHARACTER_FILTER isDelimiterCB, const char* pStringEnd = xiiUnicodeUtils::GetMaxStringEnd<char>()); // [tested]

  /// \brief Checks if the given szString ends with an unsigned integer (e.g. "MyString123").
  /// If pStringLengthBeforeUInt is non-null the string length up to the first digit is stored. Returns XII_SUCCESS if
  /// there is a value at the end of string, XII_FAILURE otherwise.
  static xiiResult FindUIntAtTheEnd(const char* szString, xiiUInt32& out_uiValue, xiiUInt32* pStringLengthBeforeUInt = nullptr); // [tested]

  /// \brief [internal] Prefer to use snprintf.
  static void OutputFormattedInt(char* szOutputBuffer, xiiUInt32 uiBufferSize, xiiUInt32& ref_uiWritePos, xiiInt64 value, xiiUInt8 uiWidth, bool bPadZeros, xiiUInt8 uiBase);
  /// \brief [internal] Prefer to use snprintf.
