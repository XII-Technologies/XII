...
/// \brief xiiStringView represent a read-only sub-string of a larger string, as it can store a dedicated string end position.
...
public:
  ...
  bool TrimWordStart(xiiStringView sWord1, xiiStringView sWord2 = {}, xiiStringView sWord3 = {}, xiiStringView sWord4 = {}, xiiStringView sWord5 = {}); // [tested]

  /// \brief If the string ends with one of the given words (case insensitive), it is removed and the function returns true.
  bool TrimWordEnd(xiiStringView sWord1, xiiStringView sWord2 = {}, xiiStringView sWord3 = {}, xiiStringView sWord4 = {}, xiiStringView sWord5 = {}); // [tested]
