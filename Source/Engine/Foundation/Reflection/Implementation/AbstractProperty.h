...
struct xiiFunctionParameterTypeResolver<I, R (*)(P...)>
{
  ...
  XII_CHECK_AT_COMPILETIME_MSG(I < Arguments, "I needs to be smaller than the number of function parameters.");
...
public:
  ...
  virtual void Execute(void* pInstance, xiiArrayPtr<xiiVariant> arguments, xiiVariant& returnValue) const = 0;
