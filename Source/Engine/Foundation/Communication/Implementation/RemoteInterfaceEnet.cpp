...
xiiInternal::NewInstance<xiiRemoteInterfaceEnet> xiiRemoteInterfaceEnet::Make(xiiAllocatorBase* allocator /*= xiiFoundation::GetDefaultAllocator()*/)
{
  return XII_NEW(allocator, xiiRemoteInterfaceEnetImpl);
}
