...
public:
  ...
  /// \brief Returns the first index at which an element with the given value could be found or xiiInvalidIndex if nothing was found.
  xiiUInt32 IndexOf(const T& value, xiiUInt32 uiStartIndex = 0) const; // [tested]

  /// \brief Returns the last index at which an element with the given value could be found or xiiInvalidIndex if nothing was found.
...
template <typename T, bool Construct>
typename xiiDequeBase<T, Construct>::iterator begin(xiiDequeBase<T, Construct>& container)
{
  return typename xiiDequeBase<T, Construct>::iterator(container, (size_t)0);
}
...
template <typename T, bool Construct>
typename xiiDequeBase<T, Construct>::reverse_iterator rbegin(xiiDequeBase<T, Construct>& container)
{
  return typename xiiDequeBase<T, Construct>::reverse_iterator(container, (size_t)0);
}
...
template <typename T, bool Construct>
typename xiiDequeBase<T, Construct>::iterator end(xiiDequeBase<T, Construct>& container)
{
  return typename xiiDequeBase<T, Construct>::iterator(container, (size_t)container.GetCount());
}
...
template <typename T, bool Construct>
typename xiiDequeBase<T, Construct>::reverse_iterator rend(xiiDequeBase<T, Construct>& container)
{
  return typename xiiDequeBase<T, Construct>::reverse_iterator(container, (size_t)container.GetCount());
}
