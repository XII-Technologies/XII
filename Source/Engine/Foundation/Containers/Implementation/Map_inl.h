...
template <typename KeyType, typename ValueType, typename Comparer>
void xiiMapBase<KeyType, ValueType, Comparer>::Constructor()
{
  m_uiCount = 0;
...
template <typename KeyType, typename ValueType, typename Comparer>
xiiMapBase<KeyType, ValueType, Comparer>::~xiiMapBase()
{
  Clear();
}

template <typename KeyType, typename ValueType, typename Comparer>
void xiiMapBase<KeyType, ValueType, Comparer>::operator=(const xiiMapBase<KeyType, ValueType, Comparer>& rhs)
{
  Clear();
...
template <typename KeyType, typename ValueType, typename Comparer>
XII_ALWAYS_INLINE bool xiiMapBase<KeyType, ValueType, Comparer>::IsEmpty() const
{
  return (m_uiCount == 0);
}

template <typename KeyType, typename ValueType, typename Comparer>
XII_ALWAYS_INLINE xiiUInt32 xiiMapBase<KeyType, ValueType, Comparer>::GetCount() const
{
  return m_uiCount;
}
...
template <typename KeyType, typename ValueType, typename Comparer>
XII_ALWAYS_INLINE typename xiiMapBase<KeyType, ValueType, Comparer>::ConstIterator xiiMapBase<KeyType, ValueType, Comparer>::GetIterator() const
{
...
template <typename KeyType, typename ValueType, typename Comparer>
typename xiiMapBase<KeyType, ValueType, Comparer>::Node* xiiMapBase<KeyType, ValueType, Comparer>::GetLeftMost() const
{
  if (IsEmpty())
    return nullptr;
...
template <typename KeyType, typename ValueType, typename Comparer>
typename xiiMapBase<KeyType, ValueType, Comparer>::Node* xiiMapBase<KeyType, ValueType, Comparer>::GetRightMost() const
{
  if (IsEmpty())
    return nullptr;
...
typename xiiMapBase<KeyType, ValueType, Comparer>::Node* xiiMapBase<KeyType, ValueType, Comparer>::Internal_Find(const CompatibleKeyType& key) const
{
  Node* pNode = m_pRoot;
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
XII_ALWAYS_INLINE bool xiiMapBase<KeyType, ValueType, Comparer>::TryGetValue(const CompatibleKeyType& key, ValueType& out_value) const
{
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
XII_ALWAYS_INLINE bool xiiMapBase<KeyType, ValueType, Comparer>::TryGetValue(const CompatibleKeyType& key, const ValueType*& out_pValue) const
{
  Node* pNode = Internal_Find<CompatibleKeyType>(key);
  if (pNode != nullptr)
  {
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
XII_ALWAYS_INLINE bool xiiMapBase<KeyType, ValueType, Comparer>::TryGetValue(const CompatibleKeyType& key, ValueType*& out_pValue) const
{
  Node* pNode = Internal_Find<CompatibleKeyType>(key);
  if (pNode != nullptr)
  {
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
XII_ALWAYS_INLINE const ValueType* xiiMapBase<KeyType, ValueType, Comparer>::GetValue(const CompatibleKeyType& key) const
{
  Node* pNode = Internal_Find<CompatibleKeyType>(key);
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
XII_ALWAYS_INLINE ValueType* xiiMapBase<KeyType, ValueType, Comparer>::GetValue(const CompatibleKeyType& key)
{
  Node* pNode = Internal_Find<CompatibleKeyType>(key);
  return pNode ? &pNode->m_Value : nullptr;
}
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
XII_ALWAYS_INLINE const ValueType& xiiMapBase<KeyType, ValueType, Comparer>::GetValueOrDefault(const CompatibleKeyType& key, const ValueType& defaultValue) const
{
  Node* pNode = Internal_Find<CompatibleKeyType>(key);
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
XII_ALWAYS_INLINE typename xiiMapBase<KeyType, ValueType, Comparer>::Iterator xiiMapBase<KeyType, ValueType, Comparer>::Find(const CompatibleKeyType& key)
{
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
XII_ALWAYS_INLINE typename xiiMapBase<KeyType, ValueType, Comparer>::ConstIterator xiiMapBase<KeyType, ValueType, Comparer>::Find(const CompatibleKeyType& key) const
{
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
XII_ALWAYS_INLINE bool xiiMapBase<KeyType, ValueType, Comparer>::Contains(const CompatibleKeyType& key) const
{
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
typename xiiMapBase<KeyType, ValueType, Comparer>::Node* xiiMapBase<KeyType, ValueType, Comparer>::Internal_LowerBound(const CompatibleKeyType& key) const
{
  Node* pNode        = m_pRoot;
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
XII_ALWAYS_INLINE typename xiiMapBase<KeyType, ValueType, Comparer>::Iterator xiiMapBase<KeyType, ValueType, Comparer>::LowerBound(const CompatibleKeyType& key)
{
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
XII_ALWAYS_INLINE typename xiiMapBase<KeyType, ValueType, Comparer>::ConstIterator xiiMapBase<KeyType, ValueType, Comparer>::LowerBound(const CompatibleKeyType& key) const
{
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
typename xiiMapBase<KeyType, ValueType, Comparer>::Node* xiiMapBase<KeyType, ValueType, Comparer>::Internal_UpperBound(const CompatibleKeyType& key) const
{
  Node* pNode        = m_pRoot;
  Node* pNodeSmaller = nullptr;
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
XII_ALWAYS_INLINE typename xiiMapBase<KeyType, ValueType, Comparer>::Iterator xiiMapBase<KeyType, ValueType, Comparer>::UpperBound(const CompatibleKeyType& key)
{
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
XII_ALWAYS_INLINE typename xiiMapBase<KeyType, ValueType, Comparer>::ConstIterator xiiMapBase<KeyType, ValueType, Comparer>::UpperBound(const CompatibleKeyType& key) const
{
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
ValueType& xiiMapBase<KeyType, ValueType, Comparer>::operator[](const CompatibleKeyType& key)
{
...

  {
    ...
    if (m_pRoot != pNilNode)
    {
      ...
      while (true)
      {
        ...
        XII_ASSERT_DEBUG(top < STACK_SIZE, "xiiMapBase's internal stack is not large enough to be able to sort {0} elements.", GetCount());
        up[top++] = it;
...
typename xiiMapBase<KeyType, ValueType, Comparer>::Iterator xiiMapBase<KeyType, ValueType, Comparer>::Insert(CompatibleKeyType&& key, CompatibleValueType&& value)
{
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
bool xiiMapBase<KeyType, ValueType, Comparer>::Remove(const CompatibleKeyType& key)
{
  bool bRemoved       = true;
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
typename xiiMapBase<KeyType, ValueType, Comparer>::Node* xiiMapBase<KeyType, ValueType, Comparer>::AcquireNode(CompatibleKeyType&& key, ValueType&& value, xiiUInt8 uiLevel, Node* pParent)
{
  Node* pNode;
...
template <typename KeyType, typename ValueType, typename Comparer>
XII_ALWAYS_INLINE typename xiiMapBase<KeyType, ValueType, Comparer>::Node* xiiMapBase<KeyType, ValueType, Comparer>::SkewNode(Node* root)
{
...
template <typename KeyType, typename ValueType, typename Comparer>
XII_ALWAYS_INLINE typename xiiMapBase<KeyType, ValueType, Comparer>::Node* xiiMapBase<KeyType, ValueType, Comparer>::SplitNode(Node* root)
{
...
template <typename KeyType, typename ValueType, typename Comparer>
template <typename CompatibleKeyType>
typename xiiMapBase<KeyType, ValueType, Comparer>::Node* xiiMapBase<KeyType, ValueType, Comparer>::Remove(Node* root, const CompatibleKeyType& key, bool& bRemoved)
{
  bRemoved = false;
...
xiiMap<KeyType, ValueType, Comparer, AllocatorWrapper>::xiiMap() :
  xiiMapBase<KeyType, ValueType, Comparer>(Comparer(), AllocatorWrapper::GetAllocator())
{
}
...
template <typename KeyType, typename ValueType, typename Comparer, typename AllocatorWrapper>
xiiMap<KeyType, ValueType, Comparer, AllocatorWrapper>::xiiMap(const xiiMap<KeyType, ValueType, Comparer, AllocatorWrapper>& other) :
  xiiMapBase<KeyType, ValueType, Comparer>(other, AllocatorWrapper::GetAllocator())
{
}

template <typename KeyType, typename ValueType, typename Comparer, typename AllocatorWrapper>
xiiMap<KeyType, ValueType, Comparer, AllocatorWrapper>::xiiMap(const xiiMapBase<KeyType, ValueType, Comparer>& other) :
  xiiMapBase<KeyType, ValueType, Comparer>(other, AllocatorWrapper::GetAllocator())
{
}

template <typename KeyType, typename ValueType, typename Comparer, typename AllocatorWrapper>
void xiiMap<KeyType, ValueType, Comparer, AllocatorWrapper>::operator=(const xiiMap<KeyType, ValueType, Comparer, AllocatorWrapper>& rhs)
{
  xiiMapBase<KeyType, ValueType, Comparer>::operator=(rhs);
}

template <typename KeyType, typename ValueType, typename Comparer, typename AllocatorWrapper>
void xiiMap<KeyType, ValueType, Comparer, AllocatorWrapper>::operator=(const xiiMapBase<KeyType, ValueType, Comparer>& rhs)
{
  xiiMapBase<KeyType, ValueType, Comparer>::operator=(rhs);
}

template <typename KeyType, typename ValueType, typename Comparer>
void xiiMapBase<KeyType, ValueType, Comparer>::Swap(xiiMapBase<KeyType, ValueType, Comparer>& other)
{
...
template <typename KeyType, typename ValueType, typename Comparer>
void xiiMapBase<KeyType, ValueType, Comparer>::SwapNilNode(Node*& pCurNode, NilNode* pOld, NilNode* pNew)
{
  if (pCurNode == pOld)
  {
