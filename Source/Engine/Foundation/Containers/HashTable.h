...
template <typename KeyType, typename ValueType, typename Hasher>
typename xiiHashTableBase<KeyType, ValueType, Hasher>::Iterator begin(xiiHashTableBase<KeyType, ValueType, Hasher>& container)
{
...
template <typename KeyType, typename ValueType, typename Hasher>
typename xiiHashTableBase<KeyType, ValueType, Hasher>::Iterator end(xiiHashTableBase<KeyType, ValueType, Hasher>& container)
{
