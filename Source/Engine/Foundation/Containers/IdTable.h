...
public:
  ...
  protected:
    friend class xiiIdTableBase<IdType, ValueType>;

    explicit ConstIterator(const xiiIdTableBase<IdType, ValueType>& idTable);
  ...
  private:
    ...
    explicit Iterator(const xiiIdTableBase<IdType, ValueType>& idTable);
  };
...
protected:
  ...
  void operator=(const xiiIdTableBase<IdType, ValueType>& rhs); // [tested]
...
/// \brief \see xiiIdTableBase
template <typename IdType, typename ValueType, typename AllocatorWrapper = xiiDefaultAllocatorWrapper>
class xiiIdTable : public xiiIdTableBase<IdType, ValueType>
{
public:
  xiiIdTable();
  ...
  void operator=(const xiiIdTable<IdType, ValueType, AllocatorWrapper>& rhs);
  void operator=(const xiiIdTableBase<IdType, ValueType>& rhs);
};
