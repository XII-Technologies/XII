...
public:
  ...
  const ControlPoint& GetControlPoint(xiiUInt32 idx) const { return m_ControlPoints[idx]; }
  ...
  /// curve.
  ControlPoint& ModifyControlPoint(xiiUInt32 idx) { return m_ControlPoints[idx]; }
