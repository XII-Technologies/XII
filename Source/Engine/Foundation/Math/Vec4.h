...
template <typename Type>
const xiiVec4Template<Type> operator+(const xiiVec4Template<Type>& v1, const xiiVec4Template<Type>& v2); // [tested]
...
template <typename Type>
const xiiVec4Template<Type> operator*(Type f, const xiiVec4Template<Type>& v); // [tested]

template <typename Type>
const xiiVec4Template<Type> operator*(const xiiVec4Template<Type>& v, Type f); // [tested]
