...
public:
  ...
  xiiBoundingSphereTemplate(const xiiVec3Template<Type>& vCenter, Type fRadius); // [tested]
  ...
  void SetElements(const xiiVec3Template<Type>& vCenter, Type fRadius); // [tested]
  ...
  const xiiVec3Template<Type> GetClampedPoint(const xiiVec3Template<Type>& vPoint); // [tested]
