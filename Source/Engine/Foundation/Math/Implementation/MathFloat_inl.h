...
namespace xiiMath
{
  ...
  template <>
  XII_ALWAYS_INLINE xiiAngleTemplate<float> ASin(float f) { return xiiAngleTemplate<float>::MakeFromRadian(asinf(f)); }

  template <>
  XII_ALWAYS_INLINE xiiAngleTemplate<float> ACos(float f) { return xiiAngleTemplate<float>::MakeFromRadian(acosf(f)); }

  template <>
  XII_ALWAYS_INLINE xiiAngleTemplate<float> ATan(float f) { return xiiAngleTemplate<float>::MakeFromRadian(atanf(f)); }

  template <>
  XII_ALWAYS_INLINE xiiAngleTemplate<float> ATan2(float y, float x) { return xiiAngleTemplate<float>::MakeFromRadian(atan2f(y, x)); }
  ...
  XII_ALWAYS_INLINE float Sin(xiiAngle a)
  {
    return sinf(a.GetRadian());
  }

  XII_ALWAYS_INLINE float Cos(xiiAngle a)
  {
    return cosf(a.GetRadian());
  }

  XII_ALWAYS_INLINE float Tan(xiiAngle a)
  {
    return tanf(a.GetRadian());
  }

  XII_ALWAYS_INLINE xiiAngle ASin(float f)
  {
    return xiiAngle::MakeFromRadian(asinf(f));
  }

  XII_ALWAYS_INLINE xiiAngle ACos(float f)
  {
    return xiiAngle::MakeFromRadian(acosf(f));
  }

  XII_ALWAYS_INLINE xiiAngle ATan(float f)
  {
    return xiiAngle::MakeFromRadian(atanf(f));
  }

  XII_ALWAYS_INLINE xiiAngle ATan2(float y, float x)
  {
    return xiiAngle::MakeFromRadian(atan2f(y, x));
  }
  ...
  XII_ALWAYS_INLINE float Mod(float f, float fDiv)
  {
    return fmodf(f, fDiv);
  }
