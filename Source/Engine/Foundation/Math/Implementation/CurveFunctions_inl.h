...
namespace xiiMath
{
  XII_ALWAYS_INLINE double GetCurveValue_Linear(double t)
  {
    return t;
  }

  XII_ALWAYS_INLINE double GetCurveValue_ConstantZero(double t)
  {
    return 0.0;
  }

  XII_ALWAYS_INLINE double GetCurveValue_ConstantOne(double t)
  {
    return 1.0;
  }

  XII_ALWAYS_INLINE double GetCurveValue_EaseInSine(double t)
  {
    return 1.0 - cos((t * xiiMath::Pi<double>()) / 2.0);
  }

  XII_ALWAYS_INLINE double GetCurveValue_EaseOutSine(double t)
  {
    return sin((t * xiiMath::Pi<double>()) / 2.0);
  }

  XII_ALWAYS_INLINE double GetCurveValue_EaseInOutSine(double t)
  {
    return -(cos(xiiMath::Pi<double>() * t) - 1.0) / 2.0;
  }

  XII_ALWAYS_INLINE double GetCurveValue_EaseInQuad(double t)
  {
    return t * t;
  }

  XII_ALWAYS_INLINE double GetCurveValue_EaseOutQuad(double t)
  {
    return 1.0 - (1.0 - t) * (1.0 - t);
  }

  XII_ALWAYS_INLINE double GetCurveValue_EaseInOutQuad(double t)
  {
    return t < 0.5 ? 2.0 * t * t : 1.0 - xiiMath::Pow(-2.0 * t + 2, 2.0) / 2;
  }

  XII_ALWAYS_INLINE double GetCurveValue_EaseInCubic(double t)
  {
    return t * t * t;
  }

  XII_ALWAYS_INLINE double GetCurveValue_EaseOutCubic(double t)
  {
    return 1.0 - pow(1 - t, 3.0);
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseInOutCubic(double t)
  {
    return t < 0.5 ? 4.0 * t * t * t : 1.0 - xiiMath::Pow(-2.0 * t + 2.0, 3.0) / 2.0;
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseInQuartic(double t)
  {
    return t * t * t * t;
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseOutQuartic(double t)
  {
    return 1.0 - xiiMath::Pow(1.0 - t, 4.0);
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseInOutQuartic(double t)
  {
    return t < 0.5 ? 8.0 * t * t * t * t : 1.0 - xiiMath::Pow(-2.0 * t + 2.0, 4.0) / 2.0;
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseInQuintic(double t)
  {
    return t * t * t * t * t;
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseOutQuintic(double t)
  {
    return 1.0 - xiiMath::Pow(1.0 - t, 5.0);
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseInOutQuintic(double t)
  {
    return t < 0.5 ? 16.0 * t * t * t * t * t : 1.0 - xiiMath::Pow(-2.0 * t + 2.0, 5.0) / 2.0;
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseInExpo(double t)
  {
    return t == 0 ? 0 : xiiMath::Pow(2.0, 10.0 * t - 10.0);
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseOutExpo(double t)
  {
    return t == 1.0 ? 1.0 : 1.0 - xiiMath::Pow(2.0, -10.0 * t);
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseInOutExpo(double t)
  {
    if (t == 0.0)
    {
      return 0.0;
  ...
  XII_ALWAYS_INLINE double GetCurveValue_EaseInCirc(double t)
  {
    return 1.0 - xiiMath::Sqrt(1.0 - xiiMath::Pow(t, 2.0));
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseOutCirc(double t)
  {
    return xiiMath::Sqrt(1.0 - xiiMath::Pow(t - 1.0, 2.0));
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseInOutCirc(double t)
  {
    return t < 0.5 ? (1.0 - xiiMath::Sqrt(1.0 - xiiMath::Pow(2.0 * t, 2.0))) / 2.0 : (xiiMath::Sqrt(1.0 - xiiMath::Pow(-2.0 * t + 2.0, 2.0)) + 1.0) / 2.0;
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseInBack(double t)
  {
    return 2.70158 * t * t * t - 1.70158 * t * t;
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseOutBack(double t)
  {
    return 1 + 2.70158 * xiiMath::Pow(t - 1.0, 3.0) + 1.70158 * xiiMath::Pow(t - 1.0, 2.0);
  }


  XII_ALWAYS_INLINE double GetCurveValue_EaseInOutBack(double t)
  {
  ...
  XII_ALWAYS_INLINE double GetCurveValue_EaseInElastic(double t)
  {
    if (t == 0.0)
    {
      return 0.0;
  ...
  XII_ALWAYS_INLINE double GetCurveValue_EaseOutElastic(double t)
  {
    if (t == 0.0)
    {
      return 0.0;
  ...
  XII_ALWAYS_INLINE double GetCurveValue_EaseInOutElastic(double t)
  {
    if (t == 0.0)
    {
      return 0.0;
  ...
  XII_ALWAYS_INLINE double GetCurveValue_EaseInBounce(double t)
  {
    return 1.0 - GetCurveValue_EaseOutBounce(1.0 - t);
  }

  XII_ALWAYS_INLINE double GetCurveValue_EaseOutBounce(double t)
  {
    if (t < 1.0 / 2.75)
    {
      return 7.5625 * t * t;
  ...
  XII_ALWAYS_INLINE double GetCurveValue_EaseInOutBounce(double t)
  {
    return t < 0.5 ? (1.0 - GetCurveValue_EaseOutBounce(1.0 - 2.0 * t)) / 2.0 : (1.0 + GetCurveValue_EaseOutBounce(2.0 * t - 1.0)) / 2.0;
  }

  XII_ALWAYS_INLINE double GetCurveValue_Conical(double t)
  {
    if (t < 0.2)
    {
  ...
  XII_ALWAYS_INLINE double GetCurveValue_FadeInHoldFadeOut(double t)
  {
    if (t < 0.2)
    {
  ...
  XII_ALWAYS_INLINE double GetCurveValue_FadeInFadeOut(double t)
  {
    if (t < 0.5)
    {
  ...
  XII_ALWAYS_INLINE double GetCurveValue_Bell(double t)
  {
    if (t < 0.25)
    {
  ...
  inline double GetCurveValue(xiiCurveFunction function, double x)
  {
    switch (function)
    {
      case Linear:
  ...
  inline double GetCurveValue(xiiCurveFunction function, double x, bool inverse)
  {
