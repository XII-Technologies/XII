...
{
  xiiSimdVec4f center2 = object.m_Min + object.m_Max;
  xiiSimdVec4f extents = object.GetExtents();
...
XII_FORCE_INLINE bool xiiFrustum::Overlaps(const xiiSimdBSphere& object) const
{
  ...
  xiiSimdFloat xSphere = object.m_CenterAndRadius.x();
  xiiSimdFloat ySphere = object.m_CenterAndRadius.y();
  xiiSimdFloat zSphere = object.m_CenterAndRadius.z();
  xiiSimdVec4f radius;
  radius.Set(object.m_CenterAndRadius.w());

  xiiSimdVec4f xPlanes0;
  xiiSimdVec4f yPlanes0;
  xiiSimdVec4f zPlanes0;
  xiiSimdVec4f dPlanes0;
  ...
  xiiSimdVec4f minDist0;
  minDist0 = dPlanes0 + xPlanes0 * xSphere;
  minDist0 += yPlanes0 * ySphere;
  minDist0 += zPlanes0 * zSphere;

  xiiSimdVec4f xPlanes1;
  xiiSimdVec4f yPlanes1;
  xiiSimdVec4f zPlanes1;
  xiiSimdVec4f dPlanes1;
  ...
  xiiSimdVec4f minDist = minDist0.CompMin(minDist1);
