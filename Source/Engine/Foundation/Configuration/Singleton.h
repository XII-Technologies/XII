...
/// \brief xiiSingletonRegistry knows about all singleton instances of classes that use XII_DECLARE_SINGLETON.
///
...
public:
  ...
  /// \brief Registers a singleton instance under a given type name. This is automatically called by xiiSingletonRegistrar.
  template <typename Interface>
  ...
  /// \brief Unregisters a singleton instance. This is automatically called by xiiSingletonRegistrar.
  template <typename Interface>
...
/// \brief [internal] Helper class to implement xiiSingletonRegistry and XII_DECLARE_SINGLETON
///
