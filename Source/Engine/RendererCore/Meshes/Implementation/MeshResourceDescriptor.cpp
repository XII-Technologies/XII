  ...
  while (chunk.GetCurrentChunk().m_bValid)
  {
    ...
    if (ci.m_sChunkName == "MeshInfo")
    {
      ...
      for (xiiUInt32 i = 0; i < uiStreamCount; ++i)
      {
        ...
        m_MeshBufferDescriptor.AddStream((xiiGALVertexAttributeSemantic::Enum)iSemantic, (xiiGALResourceFormat::Enum)iFormat);
      }
...
XII_STATICLINK_FILE(RendererCore, RendererCore_Meshes_Implementation_MeshResourceDescriptor);
