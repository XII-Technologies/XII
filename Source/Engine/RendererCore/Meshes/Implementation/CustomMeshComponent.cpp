...
// clang-format off
XII_BEGIN_COMPONENT_TYPE(xiiCustomMeshComponent, 1, xiiComponentMode::Static)
{
...
XII_STATICLINK_FILE(RendererCore, RendererCore_Meshes_Implementation_CustomMeshComponent);
