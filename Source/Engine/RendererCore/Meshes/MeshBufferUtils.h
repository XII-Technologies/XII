...
struct XII_RENDERERCORE_DLL xiiMeshBufferUtils
{
  ...
  static xiiResult EncodeTangent(const xiiVec3& vTangent, float fBiTangentSign, xiiArrayPtr<xiiUInt8> dest, xiiMeshNormalPrecision::Enum tangentPrecision);
  ...
  static xiiResult EncodeTangent(const xiiVec3& vTangent, float fBiTangentSign, xiiArrayPtr<xiiUInt8> dest, xiiGALResourceFormat::Enum destFormat);
