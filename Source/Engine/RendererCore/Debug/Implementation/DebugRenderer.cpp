...
namespace
{
  ...
  struct PerContextData
  {
    ...
    xiiDynamicArray<InfoTextData>                          m_infoTextData[(int)xiiDebugRenderer::ScreenPlacement::ENUM_COUNT];
  ...
  static void ClearRenderData()
  {
    ...
    for (auto it = s_PerContextData.GetIterator(); it.IsValid(); ++it)
    {
      ...
      if (pData)
      {
        ...
        for (xiiUInt32 i = 0; i < (xiiUInt32)xiiDebugRenderer::ScreenPlacement::ENUM_COUNT; ++i)
        {
  ...
  static xiiUInt32 AddTextLines(const xiiDebugRendererContext& context, const xiiFormatString& text0, const xiiVec2I32& vPositionInPixel, float fSizeInPixel, xiiDebugRenderer::HorizontalAlignment horizontalAlignment, xiiDebugRenderer::VerticalAlignment verticalAlignment, AddFunc func)
  {
...

    {
      ...
      for (xiiStringView line : lines)
      {
        ...
        if (horizontalAlignment == xiiDebugRenderer::HorizontalAlignment::Center)
...
// clang-format off
XII_BEGIN_SUBSYSTEM_DECLARATION(RendererCore, DebugRenderer)
...
void xiiDebugRenderer::RenderInternal(const xiiDebugRendererContext& context, const xiiRenderViewContext& renderViewContext)
{
  ...
  // draw info text
  {
    static_assert((int)xiiDebugRenderer::ScreenPlacement::ENUM_COUNT == 6);

    HorizontalAlignment ha[(int)xiiDebugRenderer::ScreenPlacement::ENUM_COUNT] = {
    ...
    VerticalAlignment va[(int)xiiDebugRenderer::ScreenPlacement::ENUM_COUNT] = {
    ...
    int offs[(int)xiiDebugRenderer::ScreenPlacement::ENUM_COUNT] = {20, 20, 20, -20, -20, -20};
    ...
    xiiVec2I32 anchor[(int)xiiDebugRenderer::ScreenPlacement::ENUM_COUNT] = {
      xiiVec2I32(10, 10),
    ...
    for (xiiUInt32 corner = 0; corner < (xiiUInt32)xiiDebugRenderer::ScreenPlacement::ENUM_COUNT; ++corner)
    {
  ...
  xiiGALDevice*         pDevice            = xiiGALDevice::GetDefaultDevice();
  xiiGALCommandEncoder* pGALCommandEncoder = renderViewContext.m_pRenderContext->GetCommandEncoder();
  ...
  // SolidBoxes
  {
    ...
    if (uiNumSolidBoxes != 0)
    {
      ...
      while (uiNumSolidBoxes > 0)
      {
        ...
        pGALCommandEncoder->UpdateBuffer(s_hDataBuffer[BufferType::SolidBoxes], 0, xiiMakeArrayPtr(pSolidBoxData, uiNumSolidBoxesInBatch).ToByteArray());
  ...
  // LineBoxes
  {
    ...
    if (uiNumLineBoxes != 0)
    {
      ...
      while (uiNumLineBoxes > 0)
      {
        ...
        pGALCommandEncoder->UpdateBuffer(s_hDataBuffer[BufferType::LineBoxes], 0, xiiMakeArrayPtr(pLineBoxData, uiNumLineBoxesInBatch).ToByteArray());
  ...
  // Text
  {
    ...
    if (uiNumGlyphs != 0)
    {
      ...
      while (uiNumGlyphs > 0)
      {
        ...
        pGALCommandEncoder->UpdateBuffer(s_hDataBuffer[BufferType::Glyphs], 0, xiiMakeArrayPtr(pGlyphData, uiNumGlyphsInBatch).ToByteArray());

        renderViewContext.m_pRenderContext->BindMeshBuffer(xiiGALBufferHandle(), xiiGALBufferHandle(), nullptr, xiiGALPrimitiveTopology::Triangles, uiNumGlyphsInBatch * 2);
...
XII_STATICLINK_FILE(RendererCore, RendererCore_Debug_Implementation_DebugRenderer);
