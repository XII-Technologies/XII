...
public:
  ...
  xiiGALTextureHandle GetRenderTarget(xiiUInt32 uiWidth, xiiUInt32 uiHeight, xiiGALResourceFormat::Enum format, xiiGALMSAASampleCount::Enum sampleCount = xiiGALMSAASampleCount::None, xiiUInt32 uiSliceColunt = 1, bool bIsArrayTarget = false);
