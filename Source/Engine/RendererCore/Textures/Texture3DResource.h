...
struct XII_RENDERERCORE_DLL xiiTexture3DResourceDescriptor
{
...
class XII_RENDERERCORE_DLL xiiTexture3DResource : public xiiResource
{
...
public:
  ...
  static void FillOutDescriptor(xiiTexture3DResourceDescriptor& td, const xiiImage* pImage, bool bSRGB, xiiUInt32 uiNumMipLevels, xiiUInt32& out_MemoryUsed, xiiHybridArray<xiiGALSystemMemoryDescription, 32>& initData);
