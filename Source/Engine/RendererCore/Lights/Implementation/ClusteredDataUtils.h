...
namespace
{
  ...
  XII_ALWAYS_INLINE xiiUInt32 GetClusterIndexFromCoord(xiiUInt32 x, xiiUInt32 y, xiiUInt32 z) { return z * NUM_CLUSTERS_XY + y * NUM_CLUSTERS_X + x; }

  // in order: tlf, trf, blf, brf, tln, trn, bln, brn
  XII_FORCE_INLINE void GetClusterCornerPoints(
  ...
  XII_FORCE_INLINE void FillCluster(
