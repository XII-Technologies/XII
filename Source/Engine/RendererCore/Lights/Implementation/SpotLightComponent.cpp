...
class xiiSpotLightComponentPatch_1_2 : public xiiGraphPatch
{
public:
  xiiSpotLightComponentPatch_1_2() :
    xiiGraphPatch("xiiSpotLightComponent", 2)
  {
  }
...
xiiSpotLightComponentPatch_1_2 g_xiiSpotLightComponentPatch_1_2;


XII_STATICLINK_FILE(RendererCore, RendererCore_Lights_Implementation_SpotLightComponent);
