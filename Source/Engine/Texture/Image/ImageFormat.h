...
struct XII_TEXTURE_DLL xiiImageFormatType
{
  /// \brief Enum describing the type of an image format.
  enum Enum
  {
...
struct XII_TEXTURE_DLL xiiImageFormatDataType
{
  /// \brief Enum describing the channel type of an image format.
  enum Enum
  {
...
struct XII_TEXTURE_DLL xiiImageFormatChannel
{
  /// \brief Enum describing the channel of an image format.
  enum Enum
  {
...
struct XII_TEXTURE_DLL xiiImageFormat
{
  /// \brief Enum describing the encoding format of the pixels of an image.
  ///
  ...
  static xiiUInt32 GetPlaneCount(Enum format);
...
XII_DEFINE_AS_POD_TYPE(xiiImageFormat::Enum);
