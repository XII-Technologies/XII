...
public:
  ...
  virtual void SetupRenderTarget(xiiSharedPtr<xiiGALSwapChain> pSwapChain, const xiiView::RenderTargets* pRenderTargets, xiiUInt16 uiWidth, xiiUInt16 uiHeight);
