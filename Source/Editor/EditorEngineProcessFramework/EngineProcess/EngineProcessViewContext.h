...
public:
  ...
  xiiResult UpdateWindow(xiiWindowHandle parentWindow, xiiUInt16 uiWidth, xiiUInt16 uiHeight);
...
public:
  ...
  virtual void SetupRenderTarget(xiiGALSwapChainHandle hSwapChain, const xiiGALRenderTargets* renderTargets, xiiUInt16 uiWidth, xiiUInt16 uiHeight);
  virtual void Redraw(bool bRenderEditorGizmos);

  /// \brief Focuses camera on the given object
  static bool FocusCameraOnObject(xiiCamera& camera, const xiiBoundingBoxSphere& objectBounds, float fFov, const xiiVec3& vViewDir);
