...
XII_BEGIN_DYNAMIC_REFLECTED_TYPE(xiiVisualScriptActivityMsgToEditor, 1, xiiRTTIDefaultAllocator<xiiVisualScriptActivityMsgToEditor>)
{
  XII_BEGIN_PROPERTIES
  {
    XII_MEMBER_PROPERTY("ComponentGuid", m_ComponentGuid),
    XII_MEMBER_PROPERTY("Activity", m_Activity),
  }
  XII_END_PROPERTIES;
}
XII_END_DYNAMIC_REFLECTED_TYPE;
