...
public:
  xiiDocumentOpenResponseMsgToEditor() {}
};
...
public:
  xiiExportDocumentMsgToEngine() :
    m_uiAssetHash(0), m_uiVersion(0)
  {
  }

  xiiString m_sOutputFile;
  xiiUInt64 m_uiAssetHash;
...
class XII_EDITORENGINEPROCESSFRAMEWORK_DLL xiiVisualScriptActivityMsgToEditor : public xiiEditorEngineDocumentMsg
{
  XII_ADD_DYNAMIC_REFLECTION(xiiVisualScriptActivityMsgToEditor, xiiEditorEngineDocumentMsg);

public:
  xiiUuid       m_ComponentGuid;
  xiiDataBuffer m_Activity;
};
