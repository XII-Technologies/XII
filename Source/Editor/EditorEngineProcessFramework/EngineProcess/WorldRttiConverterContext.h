...
///  components / game objects. Used by the xiiIPCObjectMirror to create / destroy objects.
///
...
{
public:
  xiiWorldRttiConverterContext() :
    m_pWorld(nullptr), m_uiNextComponentPickingID(1), m_uiHighlightID(1)
  {
  }
