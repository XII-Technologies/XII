...
public:
  ...
  xiiVec2   m_PickingPosition;
  xiiUInt32 m_PickingIdOut;
  float     m_PickingDepthOut;
  xiiVec2   m_MarqueePickPosition0;
  xiiVec2   m_MarqueePickPosition1;
  xiiUInt32 m_uiMarqueeActionID = 0xFFFFFFFF; // used to prevent reusing an old result for a new marquee action
  xiiUInt32 m_uiWindowWidth;
  xiiUInt32 m_uiWindowHeight;
...
private:
  ...
  xiiMat4 m_mPickingInverseViewProjectionMatrix;
