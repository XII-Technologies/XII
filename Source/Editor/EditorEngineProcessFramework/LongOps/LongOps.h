...
public:
  ...
  virtual void GetReplicationInfo(xiiStringBuilder& out_sReplicationOpType, xiiStreamWriter& config) = 0;
...
public:
  ...
  virtual xiiResult InitializeExecution(xiiStreamReader& config, const xiiUuid& DocumentGuid) { return XII_SUCCESS; }
  ...
  virtual xiiResult Execute(xiiProgress& progress, xiiStreamWriter& proxydata) = 0;
};
