...
static xiiMeshBufferResourceHandle CreateMeshBufferResource(xiiGeometry& geom, const char* szResourceName, const char* szDescription, xiiGALPrimitiveTopology::Enum topology)
{
...
static xiiMeshBufferResourceHandle CreateMeshBufferBoxFaces()
{
  ...
  opt.m_Transform.SetRotationMatrixY(xiiAngle::Degree(180.0));
...
bool xiiEngineGizmoHandle::SetupForEngine(xiiWorld* pWorld, xiiUInt32 uiNextComponentPickingID)
{
  ...
  m_pGizmoComponent->SetRenderDataCategory(
    m_bVisualizer ? xiiDefaultRenderDataCategories::SimpleOpaque : xiiDefaultRenderDataCategories::SimpleForeground);
