...
xiiEditorInput xiiNonUniformBoxGizmo::DoMouseMoveEvent(QMouseEvent* e)
{
...

  {
    ...
    xiiVec3 vTranslate = -GetTransformation().m_qRotation * (vNewPos - m_vStartPosition);
...
void xiiNonUniformBoxGizmo::SetSize(const xiiVec3& negSize, const xiiVec3& posSize, bool bLinkAxis)
{
  m_vNegSize  = negSize;
  m_vPosSize  = posSize;
