...
xiiEditorInput xiiDrawBoxGizmo::DoMouseMoveEvent(QMouseEvent* e)
{
  ...
  {
    const xiiVec2I32 vMouseMove = xiiVec2I32(e->globalPos().x(), e->globalPos().y()) - m_vLastMousePos;
...
void xiiDrawBoxGizmo::GetResult(xiiVec3& out_Origin, float& out_fSizeNegX, float& out_fSizePosX, float& out_fSizeNegY, float& out_fSizePosY, float& out_fSizeNegZ, float& out_fSizePosZ) const
{
