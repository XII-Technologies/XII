...
void xiiGameObjectDocumentActions::MapMenuActions(const char* szMapping, const char* szPath)
{
...

  {
    ...
    xiiStringBuilder sSubPath(szPath, "/GameObjectCategory");
...
void xiiGameObjectDocumentActions::MapMenuSimulationSpeed(const char* szMapping, const char* szPath)
{
  xiiActionMap* pMap = xiiActionMapManager::GetActionMap(szMapping);
  XII_ASSERT_DEV(pMap != nullptr, "Mapping the actions failed!");
...
void xiiGameObjectDocumentActions::MapToolbarActions(const char* szMapping, const char* szPath)
{
  xiiActionMap* pMap = xiiActionMapManager::GetActionMap(szMapping);
  XII_ASSERT_DEV(pMap != nullptr, "Mapping the actions failed!");
