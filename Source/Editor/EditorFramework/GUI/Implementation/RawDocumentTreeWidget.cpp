...
xiiQtDocumentTreeView::xiiQtDocumentTreeView(QWidget* parent) :
  xiiQtItemView<QTreeView>(parent)
{
}
...
void xiiQtDocumentTreeView::keyPressEvent(QKeyEvent* e)
{
  if (xiiQtProxy::TriggerDocumentAction(m_pDocument, e))
    return;
