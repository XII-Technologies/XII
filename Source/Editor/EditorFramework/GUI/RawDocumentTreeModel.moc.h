...
public:
  ...
  xiiQtDocumentTreeModelAdapter(const xiiDocumentObjectManager* pTree, const xiiRTTI* pType, const char* m_sChildProperty);
  virtual const xiiRTTI*   GetType() const;
  virtual const xiiString& GetChildProperty() const;

  virtual QVariant      data(const xiiDocumentObject* pObject, int row, int column, int role = Qt::DisplayRole) const = 0;
  virtual bool          setData(const xiiDocumentObject* pObject, int row, int column, const QVariant& value, int role) const;
  virtual Qt::ItemFlags flags(const xiiDocumentObject* pObject, int row, int column) const;
...
public:
  xiiQtDummyAdapter(const xiiDocumentObjectManager* pTree, const xiiRTTI* pType, const char* m_sChildProperty);
...
public:
  xiiQtNamedAdapter(const xiiDocumentObjectManager* pTree, const xiiRTTI* pType, const char* m_sChildProperty, const char* szNameProperty);
  ~xiiQtNamedAdapter();
  virtual QVariant data(const xiiDocumentObject* pObject, int row, int column, int role) const override;
...
public:
  xiiQtNameableAdapter(const xiiDocumentObjectManager* pTree, const xiiRTTI* pType, const char* m_sChildProperty, const char* szNameProperty);
  ~xiiQtNameableAdapter();
  virtual bool          setData(const xiiDocumentObject* pObject, int row, int column, const QVariant& value, int role) const override;
  virtual Qt::ItemFlags flags(const xiiDocumentObject* pObject, int row, int column) const override;
};
...
public:
  ...
  void AddAdapter(xiiQtDocumentTreeModelAdapter* adapter);
