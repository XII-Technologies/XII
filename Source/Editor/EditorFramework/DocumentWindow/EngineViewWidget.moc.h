...
public:
  ...
  void GetCameraMatrices(xiiMat4& out_ViewMatrix, xiiMat4& out_ProjectionMatrix) const;
  ...
  xiiResult PickPlane(xiiUInt16 uiScreenPosX, xiiUInt16 uiScreenPosY, const xiiPlane& plane, xiiVec3& out_Position) const;
