...
void xiiQtEngineViewWidget::GetCameraMatrices(xiiMat4& out_ViewMatrix, xiiMat4& out_ProjectionMatrix) const
{
...
xiiResult xiiQtEngineViewWidget::PickPlane(xiiUInt16 uiScreenPosX, xiiUInt16 uiScreenPosY, const xiiPlane& plane, xiiVec3& out_Position) const
{
...
void xiiQtEngineViewWidget::HandleViewMessage(const xiiEditorEngineViewMsg* pMsg)
{
  ...
  if (const xiiViewMarqueePickingResultMsgToEditor* pFullMsg = xiiDynamicCast<const xiiViewMarqueePickingResultMsgToEditor*>(pMsg))
  {
...
xiiQtViewWidgetContainer::~xiiQtViewWidgetContainer() {}
