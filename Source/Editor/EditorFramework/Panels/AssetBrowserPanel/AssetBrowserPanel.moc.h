...
private Q_SLOTS:
  void SlotAssetChosen(xiiUuid guid, QString sAssetPathRelative, QString sAssetPathAbsolute);
  void SlotAssetSelected(xiiUuid guid, QString sAssetPathRelative, QString sAssetPathAbsolute);
