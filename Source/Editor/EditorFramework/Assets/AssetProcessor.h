...
private:
  ...
  bool GetNextAssetToProcess(xiiAssetInfo* pInfo, xiiUuid& out_guid, xiiStringBuilder& out_sAbsPath, xiiStringBuilder& out_sRelPath);
  bool GetNextAssetToProcess(xiiUuid& out_guid, xiiStringBuilder& out_sAbsPath, xiiStringBuilder& out_sRelPath);
