...
public:
  ...
  xiiResult WaitForMessage(const xiiRTTI* pMessageType, xiiTime tTimeout, xiiProcessCommunicationChannel ::WaitForMessageCallback* pCallback = nullptr);
...
{
public:
  void SendMessage(xiiEditorEngineDocumentMsg* pMessage);
