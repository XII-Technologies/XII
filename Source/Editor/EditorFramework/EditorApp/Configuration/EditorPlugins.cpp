...
void xiiPluginBundle::WriteStateToDDL(xiiOpenDdlWriter& ddl, const char* szOwnName) const
{
  ddl.BeginObject("PluginState");
  xiiOpenDdlUtils::StoreString(ddl, szOwnName, "ID");
  xiiOpenDdlUtils::StoreBool(ddl, m_bSelected, "Selected");
  xiiOpenDdlUtils::StoreBool(ddl, m_bLoadCopy, "LoadCopy");
  ddl.EndObject();
}

void xiiPluginBundle::ReadStateFromDDL(xiiOpenDdlReader& ddl, const char* szOwnName)
{
  m_bSelected = false;
...
void xiiPluginBundleSet::WriteStateToDDL(xiiOpenDdlWriter& ddl) const
{
...
void xiiPluginBundleSet::ReadStateFromDDL(xiiOpenDdlReader& ddl)
{
...
xiiResult xiiPluginBundle::ReadBundleFromDDL(xiiOpenDdlReader& ddl)
{
