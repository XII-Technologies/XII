...
public:
  ...
  xiiString GetExternalToolsFolder(bool bForceUseCustomTools = false);
  ...
  void         OpenDocumentQueued(const char* szDocument, const xiiDocumentObject* pOpenContext = nullptr);
  xiiDocument* OpenDocument(const char* szDocument, xiiBitflags<xiiDocumentFlags> flags, const xiiDocumentObject* pOpenContext = nullptr);
  xiiDocument* CreateDocument(const char* szDocument, xiiBitflags<xiiDocumentFlags> flags, const xiiDocumentObject* pOpenContext = nullptr);

  xiiResult CreateOrOpenProject(bool bCreate, const char* szFile);
