...
xiiQtDashboardDlg::xiiQtDashboardDlg(QWidget* parent, DashboardTab activeTab) :
  QDialog(parent)
{
  setupUi(this);
...
{
  QDesktopServices::openUrl(QUrl("https://docs.xiitechnologies.com/"));
}

void xiiQtDashboardDlg::on_GitHubDiscussions_clicked()
{
  QDesktopServices::openUrl(QUrl("https://github.com/XII-Technologies/XII/discussions/29"));
}
