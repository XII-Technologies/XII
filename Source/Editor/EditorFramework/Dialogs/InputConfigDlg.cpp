...
xiiQtInputConfigDlg::xiiQtInputConfigDlg(QWidget* pParent) :
  QDialog(pParent)
{
  setupUi(this);
...
void xiiQtInputConfigDlg::on_ButtonNewInputSet_clicked()
{
  ...
  else
  {
    ...
    pItem->setIcon(0, xiiQtUiServices::GetSingleton()->GetCachedIconResource(":/EditorFramework/Icons/Input.svg"));
