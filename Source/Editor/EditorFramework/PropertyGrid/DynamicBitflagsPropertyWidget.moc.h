...
class XII_EDITORFRAMEWORK_DLL xiiQtDynamicBitflagsPropertyWidget : public xiiQtStandardPropertyWidget
{
  Q_OBJECT

public:
  xiiQtDynamicBitflagsPropertyWidget();
  virtual ~xiiQtDynamicBitflagsPropertyWidget();
