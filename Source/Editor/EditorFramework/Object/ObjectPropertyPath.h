...
public:
  ...
  static xiiStatus ResolvePath(const xiiObjectPropertyPathContext& context, xiiHybridArray<xiiPropertyReference, 1>& out_keys, const char* szObjectSearchSequence, const char* szComponentType, const char* szPropertyPath);
