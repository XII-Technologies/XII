...
xiiCameraVisualizerAdapter::xiiCameraVisualizerAdapter() = default;
...
void xiiCameraVisualizerAdapter::Update()
{
  ...
  else
  {
...

    {
      ...
      m_LocalTransformNearPlane.m_qRotation.SetFromAxisAndAngle(xiiVec3(0, 1, 0), xiiAngle::MakeFromDegree(90));
      ...
      m_LocalTransformFarPlane.m_qRotation.SetFromAxisAndAngle(xiiVec3(0, 1, 0), xiiAngle::MakeFromDegree(90));
