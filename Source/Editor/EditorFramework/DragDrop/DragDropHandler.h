...
public:
  ...
  /// \brief Call this when a drag enter event occurs. Return value indicates whether a xiiDragDropHandler was found to handle the operation. If not,
...
protected:
  ...
  /// \brief Potentially called by the drag drop target to request information about how to determine the xiiDragDropInfo data.
