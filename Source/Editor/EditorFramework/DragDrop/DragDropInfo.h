...
/// \brief Helper operator to retrieve the "application/xiiEditor.ObjectSelection" mime data from a xiiDragDropInfo::m_pMimeData.
/// \code{.cpp}
///   xiiHybridArray<const xiiDocumentObject*, 32> Dragged;
///   QByteArray encodedData = m_pMimeData->data("application/xiiEditor.ObjectSelection");
///   QDataStream stream(&encodedData, QIODevice::ReadOnly);
///   stream >> Dragged;
/// \endcode
XII_EDITORFRAMEWORK_DLL void operator>>(QDataStream& stream, xiiDynamicArray<xiiDocumentObject*>& rhs);
