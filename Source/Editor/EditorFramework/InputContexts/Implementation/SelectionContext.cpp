...
static const bool IsInSelection(const xiiDeque<const xiiDocumentObject*>& selection, const xiiDocumentObject* pObject, const xiiDocumentObject*& out_ParentInSelection, const xiiDocumentObject*& out_ParentChild, const xiiDocumentObject* pRootObject)
{
