...
public:
  xiiGameObjectDocument(const char* szDocumentPath, xiiDocumentObjectManager* pObjectManager, xiiAssetDocEngineConnection engineConnectionType = xiiAssetDocEngineConnection::FullObjectMirroring);
...
public:
  ...
  void SetGlobalTransform(const xiiDocumentObject* pObject, const xiiTransform& t, xiiUInt8 transformationChanges) const;
  ...
  void SetGlobalTransformParentOnly(const xiiDocumentObject* pObject, const xiiTransform& t, xiiUInt8 transformationChanges) const;
  ...
  void DetermineNodeName(const xiiDocumentObject* pObject, const xiiUuid& prefabGuid, xiiStringBuilder& out_Result, QIcon* out_pIcon = nullptr) const;
...
private:
  ...
  typedef xiiHashTable<const xiiDocumentObject*, xiiSimdTransform, xiiHashHelper<const xiiDocumentObject*>, xiiAlignedAllocatorWrapper> TransformTable;
