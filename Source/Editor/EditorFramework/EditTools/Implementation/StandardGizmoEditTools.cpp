...
void xiiTranslateGizmoEditTool::GetGridSettings(xiiGridSettingsMsgToEngine& msg)
{
  ...
  msg.m_fGridDensity = xiiSnapProvider::GetTranslationSnapValue() * (pSceneDoc->GetGizmoWorldSpace() ? 1.0f : -1.0f); // negative density = local space
  ...
  if (pPreferences->GetShowGrid() && translateGizmo.IsVisible())
  {
    ...
    {
      xiiSnapProvider::SnapTranslation(msg.m_vGridCenter);

      switch (translateGizmo.GetLastPlaneInteraction())
      {
        case xiiTranslateGizmo::PlaneInteraction::PlaneX:
          msg.m_vGridCenter.y = xiiMath::RoundToMultiple(msg.m_vGridCenter.y, xiiSnapProvider::GetTranslationSnapValue() * 10);
          msg.m_vGridCenter.z = xiiMath::RoundToMultiple(msg.m_vGridCenter.z, xiiSnapProvider::GetTranslationSnapValue() * 10);
          break;
        case xiiTranslateGizmo::PlaneInteraction::PlaneY:
          msg.m_vGridCenter.x = xiiMath::RoundToMultiple(msg.m_vGridCenter.x, xiiSnapProvider::GetTranslationSnapValue() * 10);
          msg.m_vGridCenter.z = xiiMath::RoundToMultiple(msg.m_vGridCenter.z, xiiSnapProvider::GetTranslationSnapValue() * 10);
          break;
    ...
    {
      case xiiTranslateGizmo::PlaneInteraction::PlaneX:
        msg.m_vGridTangent1 = translateGizmo.GetTransformation().m_qRotation * xiiVec3(0, 1, 0);
        msg.m_vGridTangent2 = translateGizmo.GetTransformation().m_qRotation * xiiVec3(0, 0, 1);
        break;
      case xiiTranslateGizmo::PlaneInteraction::PlaneY:
        msg.m_vGridTangent1 = translateGizmo.GetTransformation().m_qRotation * xiiVec3(1, 0, 0);
        msg.m_vGridTangent2 = translateGizmo.GetTransformation().m_qRotation * xiiVec3(0, 0, 1);
        break;
      case xiiTranslateGizmo::PlaneInteraction::PlaneZ:
        msg.m_vGridTangent1 = translateGizmo.GetTransformation().m_qRotation * xiiVec3(1, 0, 0);
        msg.m_vGridTangent2 = translateGizmo.GetTransformation().m_qRotation * xiiVec3(0, 1, 0);
        break;
    }
  }
}
