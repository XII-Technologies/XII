...
class xiiKrautTreeAssetDocumentManager : public xiiAssetDocumentManager
{
  XII_ADD_DYNAMIC_REFLECTION(xiiKrautTreeAssetDocumentManager, xiiAssetDocumentManager);

public:
  xiiKrautTreeAssetDocumentManager();
  ~xiiKrautTreeAssetDocumentManager();
