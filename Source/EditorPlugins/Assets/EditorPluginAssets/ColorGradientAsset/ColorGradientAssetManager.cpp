...
void xiiColorGradientAssetDocumentManager::OnDocumentManagerEvent(const xiiDocumentManager::Event& e)
{
  switch (e.m_Type)
  {
    case xiiDocumentManager::Event::Type::DocumentWindowRequested:
    {
      ...
      {
        xiiQtColorGradientAssetDocumentWindow* pDocWnd = new xiiQtColorGradientAssetDocumentWindow(e.m_pDocument);
      }
    }
    break;
...
{
  out_pDocument = new xiiColorGradientAssetDocument(szPath);
}
