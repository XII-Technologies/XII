...
class xiiSkeletonAssetDocumentManager : public xiiAssetDocumentManager
{
  XII_ADD_DYNAMIC_REFLECTION(xiiSkeletonAssetDocumentManager, xiiAssetDocumentManager);

public:
  xiiSkeletonAssetDocumentManager();
  ~xiiSkeletonAssetDocumentManager();
