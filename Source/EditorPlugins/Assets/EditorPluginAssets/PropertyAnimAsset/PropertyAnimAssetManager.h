...
class xiiPropertyAnimAssetDocumentManager : public xiiAssetDocumentManager
{
  XII_ADD_DYNAMIC_REFLECTION(xiiPropertyAnimAssetDocumentManager, xiiAssetDocumentManager);

public:
  xiiPropertyAnimAssetDocumentManager();
  ~xiiPropertyAnimAssetDocumentManager();
