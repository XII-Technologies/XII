...
void xiiQtPropertyAnimAssetDocumentWindow::UpdateSelectionData()
{
  ...
  for (const QModelIndex& selIdx : m_pSelectionModel->selection().indexes())
  {
    ...
    auto addRecursive = [&tracks, pModel](auto& self, const xiiQtPropertyAnimModelTreeEntry* pTreeItem) -> void {
...
xiiQtPropertyAnimAssetTreeView::xiiQtPropertyAnimAssetTreeView(QWidget* parent) :
  QTreeView(parent)
{
