...
xiiQtAnimationControllerAssetDocumentWindow::xiiQtAnimationControllerAssetDocumentWindow(xiiDocument* pDocument) :
  xiiQtDocumentWindow(pDocument)
{
  ...
  m_pScene = new xiiQtAnimationControllerAssetScene(this);
...
xiiQtAnimationControllerAssetDocumentWindow::~xiiQtAnimationControllerAssetDocumentWindow() {}
