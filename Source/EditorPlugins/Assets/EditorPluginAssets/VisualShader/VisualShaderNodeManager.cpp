...
void xiiVisualShaderNodeManager::InternalCreatePins(const xiiDocumentObject* pObject, NodeInternal& node)
{
...
void xiiVisualShaderNodeManager::GetCreateableTypes(xiiHybridArray<const xiiRTTI*, 32>& Types) const
{
...
const char* xiiVisualShaderNodeManager::GetTypeCategory(const xiiRTTI* pRtti) const
{
...
xiiStatus xiiVisualShaderNodeManager::InternalCanAdd(const xiiRTTI* pRtti, const xiiDocumentObject* pParent, const char* szParentProperty, const xiiVariant& index) const
{
  ...
  if (pDesc)
  {
    ...
    static const xiiUInt32 uiMaxTextures = 16;
