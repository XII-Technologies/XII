...
void xiiVisualShaderTypeRegistry::UpdateNodeData(const char* szCfgFileRelative)
{
  xiiStringBuilder sPath(":app/VisualShader/", szCfgFileRelative);
...
void xiiVisualShaderTypeRegistry::LoadConfigFile(const char* szFile)
{
  ...
  if (xiiPathUtils::HasExtension(szFile, "ddl"))
  {
    ...
    while (pNode != nullptr)
    {
      if (!pNode->IsCustomType() || !xiiStringUtils::IsEqual(pNode->GetCustomType(), "Node"))
      {
...
void xiiVisualShaderTypeRegistry::ExtractNodePins(const xiiOpenDdlReaderElement* pNode, const char* szPinType, xiiHybridArray<xiiVisualShaderPinDescriptor, 4>& pinArray, bool bOutput)
{
  ...
  {
    if (xiiStringUtils::IsEqual(pElement->GetCustomType(), szPinType))
    {
...
void xiiVisualShaderTypeRegistry::ExtractNodeProperties(const xiiOpenDdlReaderElement* pNode, xiiVisualShaderNodeDescriptor& nd)
{
  for (const xiiOpenDdlReaderElement* pElement = pNode->GetFirstChild(); pElement != nullptr; pElement = pElement->GetSibling())
  {
    if (xiiStringUtils::IsEqual(pElement->GetCustomType(), "Property"))
    {
...
void xiiVisualShaderTypeRegistry::ExtractNodeConfig(const xiiOpenDdlReaderElement* pNode, xiiVisualShaderNodeDescriptor& nd)
{
  ...
  while (pElement)
  {
    if (xiiStringUtils::IsEqual(pElement->GetName(), "Color"))
    {
      GetColorFromDdl(pElement, nd.m_Color);
    }
    else if (pElement->HasPrimitives(xiiOpenDdlPrimitiveType::String))
    {
      if (xiiStringUtils::IsEqual(pElement->GetName(), "NodeType"))
      {
      ...
      else if (xiiStringUtils::IsEqual(pElement->GetName(), "Category"))
      {
        nd.m_sCategory = pElement->GetPrimitivesString()[0];
      }
      else if (xiiStringUtils::IsEqual(pElement->GetName(), "CheckPermutations"))
      {
      ...
      else if (xiiStringUtils::IsEqual(pElement->GetName(), "CodePermutations"))
      {
        temp = pElement->GetPrimitivesString()[0];
      ...
      else if (xiiStringUtils::IsEqual(pElement->GetName(), "CodeRenderStates"))
      {
        temp = pElement->GetPrimitivesString()[0];
        if (!temp.IsEmpty() && !temp.EndsWith("\n"))
          temp.Append("\n");
      ...
      else if (xiiStringUtils::IsEqual(pElement->GetName(), "CodeVertexShader"))
      {
        temp = pElement->GetPrimitivesString()[0];
        if (!temp.IsEmpty() && !temp.EndsWith("\n"))
          temp.Append("\n");
      ...
      else if (xiiStringUtils::IsEqual(pElement->GetName(), "CodeGeometryShader"))
      {
        temp = pElement->GetPrimitivesString()[0];
        if (!temp.IsEmpty() && !temp.EndsWith("\n"))
          temp.Append("\n");
      ...
      else if (xiiStringUtils::IsEqual(pElement->GetName(), "CodeMaterialParams"))
      {
        temp = pElement->GetPrimitivesString()[0];
        if (!temp.IsEmpty() && !temp.EndsWith("\n"))
          temp.Append("\n");
      ...
      else if (xiiStringUtils::IsEqual(pElement->GetName(), "CodeMaterialCB"))
      {
        temp                       = pElement->GetPrimitivesString()[0];
        nd.m_sShaderCodeMaterialCB = temp;
      }
      else if (xiiStringUtils::IsEqual(pElement->GetName(), "CodePixelDefines"))
      {
        temp = pElement->GetPrimitivesString()[0];
        if (!temp.IsEmpty() && !temp.EndsWith("\n"))
          temp.Append("\n");
      ...
      else if (xiiStringUtils::IsEqual(pElement->GetName(), "CodePixelIncludes"))
      {
        temp = pElement->GetPrimitivesString()[0];
        if (!temp.IsEmpty() && !temp.EndsWith("\n"))
          temp.Append("\n");
      ...
      else if (xiiStringUtils::IsEqual(pElement->GetName(), "CodePixelSamplers"))
      {
        temp = pElement->GetPrimitivesString()[0];
        if (!temp.IsEmpty() && !temp.EndsWith("\n"))
          temp.Append("\n");
      ...
      else if (xiiStringUtils::IsEqual(pElement->GetName(), "CodePixelConstants"))
      {
        temp = pElement->GetPrimitivesString()[0];
        if (!temp.IsEmpty() && !temp.EndsWith("\n"))
          temp.Append("\n");
      ...
      else if (xiiStringUtils::IsEqual(pElement->GetName(), "CodePixelBody"))
      {
        temp = pElement->GetPrimitivesString()[0];
        if (!temp.IsEmpty() && !temp.EndsWith("\n"))
          temp.Append("\n");
