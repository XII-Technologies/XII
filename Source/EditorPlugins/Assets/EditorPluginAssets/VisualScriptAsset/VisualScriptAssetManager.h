...
class xiiVisualScriptAssetManager : public xiiAssetDocumentManager
{
  XII_ADD_DYNAMIC_REFLECTION(xiiVisualScriptAssetManager, xiiAssetDocumentManager);

public:
  xiiVisualScriptAssetManager();
  ~xiiVisualScriptAssetManager();
