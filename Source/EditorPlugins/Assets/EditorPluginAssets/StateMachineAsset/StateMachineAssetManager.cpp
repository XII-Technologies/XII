...
void xiiStateMachineAssetManager::OnDocumentManagerEvent(const xiiDocumentManager::Event& e)
{
  switch (e.m_Type)
  {
    case xiiDocumentManager::Event::Type::DocumentWindowRequested:
    {
      ...
      {
        xiiQtStateMachineAssetDocumentWindow* pDocWnd = new xiiQtStateMachineAssetDocumentWindow(e.m_pDocument);
      }
    }
    break;
...
{
  out_pDocument = new xiiStateMachineAssetDocument(szPath);
}
