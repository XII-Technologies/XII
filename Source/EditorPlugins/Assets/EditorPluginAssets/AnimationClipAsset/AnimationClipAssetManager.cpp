...
xiiAnimationClipAssetDocumentManager::xiiAnimationClipAssetDocumentManager()
{
  ...
  //xiiQtImageCache::GetSingleton()->RegisterTypeImage("Animation Clip", QPixmap(":/AssetIcons/Animation_Clip.png"));
}
...
void xiiAnimationClipAssetDocumentManager::OnDocumentManagerEvent(const xiiDocumentManager::Event& e)
{
  switch (e.m_Type)
  {
    case xiiDocumentManager::Event::Type::DocumentWindowRequested:
    {
      ...
      {
        xiiQtAnimationClipAssetDocumentWindow* pDocWnd =
          new xiiQtAnimationClipAssetDocumentWindow(static_cast<xiiAnimationClipAssetDocument*>(e.m_pDocument));
      }
    }
    break;
...
void xiiAnimationClipAssetDocumentManager::InternalCreateDocument(
...
{
  out_pDocument = new xiiAnimationClipAssetDocument(szPath);
}
