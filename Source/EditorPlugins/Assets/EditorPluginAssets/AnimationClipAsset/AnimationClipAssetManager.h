...
class xiiAnimationClipAssetDocumentManager : public xiiAssetDocumentManager
{
  XII_ADD_DYNAMIC_REFLECTION(xiiAnimationClipAssetDocumentManager, xiiAssetDocumentManager);

public:
  xiiAnimationClipAssetDocumentManager();
  ~xiiAnimationClipAssetDocumentManager();
