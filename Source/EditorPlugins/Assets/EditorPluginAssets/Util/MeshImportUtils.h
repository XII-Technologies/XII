...
namespace xiiMeshImportUtils
{
  ...
  // XII_EDITORPLUGINASSETS_DLL void UpdateMaterialSlots(const char* szDocumentPath, const xiiModelImporter::Scene& scene, const xiiModelImporter::Mesh& mesh, bool bImportMaterials, bool bUseSubFolderForImportedMaterials, const char* szMeshFile, xiiHybridArray<xiiMaterialResourceSlot, 8>& inout_MaterialSlots);
  ...
  XII_EDITORPLUGINASSETS_DLL void CopyMeshAssetMaterialSlotToResource(xiiMeshResourceDescriptor& desc, const xiiHybridArray<xiiMaterialResourceSlot, 8>& materialSlots);
  XII_EDITORPLUGINASSETS_DLL void ImportMeshAssetMaterials(xiiHybridArray<xiiMaterialResourceSlot, 8>& inout_MaterialSlots, const char* szDocumentDirectory, const xiiModelImporter2::Importer* pImporter);
} // namespace xiiMeshImportUtils
