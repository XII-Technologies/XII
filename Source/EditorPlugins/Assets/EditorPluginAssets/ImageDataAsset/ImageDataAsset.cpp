...
xiiImageDataAssetDocument::xiiImageDataAssetDocument(const char* szDocumentPath) :
  xiiSimpleAssetDocument<xiiImageDataAssetProperties>(szDocumentPath, xiiAssetDocEngineConnection::None)
{
}

xiiTransformStatus xiiImageDataAssetDocument::InternalTransformAsset(const char* szTargetFile, const char* szOutputTag, const xiiPlatformProfile* pAssetProfile, const xiiAssetFileHeader& AssetHeader, xiiBitflags<xiiTransformFlags> transformFlags)
{
