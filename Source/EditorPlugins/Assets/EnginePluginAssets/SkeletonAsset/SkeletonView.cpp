...
xiiSkeletonViewContext::~xiiSkeletonViewContext() {}
...
void xiiSkeletonViewContext::SetCamera(const xiiViewRedrawMsgToEngine* pMsg)
{
  ...
  if (hSkeleton.IsValid())
  {
    ...
    xiiDebugRenderer::Draw2DText(m_hView, sText, xiiVec2I32(10, viewHeight - 10), xiiColor::White, 16, xiiDebugRenderer::HorizontalAlignment::Left,
                                 xiiDebugRenderer::VerticalAlignment::Bottom);
  }
}
