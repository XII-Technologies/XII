...
static void CreatePreviewRect(xiiGeometry& geom)
{
  ...
  idx[0] = geom.AddVertex(xiiVec3(-halfSize.x, 0, -halfSize.y), xiiVec3(-1, 0, 0), xiiVec2(-1, 2), color, 0, mTransform);
  idx[1] = geom.AddVertex(xiiVec3(halfSize.x, 0, -halfSize.y), xiiVec3(-1, 0, 0), xiiVec2(2, 2), color, 0, mTransform);
  idx[2] = geom.AddVertex(xiiVec3(halfSize.x, 0, halfSize.y), xiiVec3(-1, 0, 0), xiiVec2(2, -1), color, 0, mTransform);
  idx[3] = geom.AddVertex(xiiVec3(-halfSize.x, 0, halfSize.y), xiiVec3(-1, 0, 0), xiiVec2(-1, -1), color, 0, mTransform);
