...
xiiQtFileserveWidget::xiiQtFileserveWidget(QWidget* parent /*= nullptr*/)
{
  setupUi(this);
  Progress->reset();
...
void xiiQtFileserveWidget::FindOwnIP(xiiStringBuilder& out_Display, xiiHybridArray<xiiStringBuilder, 4>* out_AllIPs)
{
