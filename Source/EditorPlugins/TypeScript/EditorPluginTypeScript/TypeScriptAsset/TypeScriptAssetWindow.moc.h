...
class xiiQtTypeScriptAssetDocumentWindow : public xiiQtDocumentWindow
{
  Q_OBJECT

public:
  xiiQtTypeScriptAssetDocumentWindow(xiiAssetDocument* pDocument);
  ~xiiQtTypeScriptAssetDocumentWindow();
...
private:
  void TsDocumentEventHandler(const xiiTypeScriptAssetDocumentEvent& e);

  xiiTypeScriptAssetDocument* m_pAssetDoc    = nullptr;
