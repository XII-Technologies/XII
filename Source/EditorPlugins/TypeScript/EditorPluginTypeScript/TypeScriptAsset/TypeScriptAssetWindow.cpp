...
xiiQtTypeScriptAssetDocumentWindow::xiiQtTypeScriptAssetDocumentWindow(xiiAssetDocument* pDocument) :
  xiiQtDocumentWindow(pDocument)
{
  ...
  m_pAssetDoc = static_cast<xiiTypeScriptAssetDocument*>(pDocument);
  ...
  m_pAssetDoc->GetEvent().AddEventHandler(xiiMakeDelegate(&xiiQtTypeScriptAssetDocumentWindow::TsDocumentEventHandler, this));
}

xiiQtTypeScriptAssetDocumentWindow::~xiiQtTypeScriptAssetDocumentWindow()
{
  m_pAssetDoc->GetEvent().RemoveEventHandler(xiiMakeDelegate(&xiiQtTypeScriptAssetDocumentWindow::TsDocumentEventHandler, this));

  delete m_pHighlighter;
}

void xiiQtTypeScriptAssetDocumentWindow::UpdateFileContentDisplay()
{
...
void xiiQtTypeScriptAssetDocumentWindow::TsDocumentEventHandler(const xiiTypeScriptAssetDocumentEvent& e)
{
  switch (e.m_Type)
  {
    case xiiTypeScriptAssetDocumentEvent::Type::ScriptCreated:
    case xiiTypeScriptAssetDocumentEvent::Type::ScriptOpened:
    case xiiTypeScriptAssetDocumentEvent::Type::ScriptTransformed:
      UpdateFileContentDisplay();
      break;
