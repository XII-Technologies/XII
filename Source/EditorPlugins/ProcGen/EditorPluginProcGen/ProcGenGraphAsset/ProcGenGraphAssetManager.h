...
class xiiProcGenGraphAssetDocumentManager : public xiiAssetDocumentManager
{
  XII_ADD_DYNAMIC_REFLECTION(xiiProcGenGraphAssetDocumentManager, xiiAssetDocumentManager);

public:
  xiiProcGenGraphAssetDocumentManager();
  ~xiiProcGenGraphAssetDocumentManager();
