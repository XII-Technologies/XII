...
class xiiRmlUiAssetDocumentManager : public xiiAssetDocumentManager
{
  XII_ADD_DYNAMIC_REFLECTION(xiiRmlUiAssetDocumentManager, xiiAssetDocumentManager);

public:
  xiiRmlUiAssetDocumentManager();
  ~xiiRmlUiAssetDocumentManager();
