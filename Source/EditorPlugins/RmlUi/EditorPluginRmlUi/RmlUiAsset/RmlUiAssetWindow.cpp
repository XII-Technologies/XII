...
xiiQtRmlUiAssetDocumentWindow::xiiQtRmlUiAssetDocumentWindow(xiiAssetDocument* pDocument) :
  xiiQtEngineDocumentWindow(pDocument)
{
  ...
  xiiQtViewWidgetContainer* pContainer = nullptr;
  {
    ...
    m_pViewWidget = new xiiQtEngineViewWidget(nullptr, this, &m_ViewConfig);
  ...
  m_pAssetDoc = static_cast<xiiRmlUiAssetDocument*>(pDocument);

  FinishWindowCreation();
}

void xiiQtRmlUiAssetDocumentWindow::InternalRedraw()
{
...
void xiiQtRmlUiAssetDocumentWindow::SendRedrawMsg()
{
