...
xiiSceneLayerBase::xiiSceneLayerBase() = default;

xiiSceneLayerBase::~xiiSceneLayerBase() = default;

//////////////////////////////////////////////////////////////////////////

xiiSceneLayer::xiiSceneLayer() = default;

xiiSceneLayer::~xiiSceneLayer() = default;

//////////////////////////////////////////////////////////////////////////

xiiSceneDocumentSettings::xiiSceneDocumentSettings() = default;
...
xiiScene2Document::xiiScene2Document(xiiStringView sDocumentPath) :
  xiiSceneDocument(sDocumentPath, xiiSceneDocument::DocumentType::Scene)
{
...
xiiStatus xiiScene2Document::DeleteLayer(const xiiUuid& layerGuid)
{
  ...
  xiiStringBuilder sName("<Unknown>");
  {
    ...
    {
      sName = xiiPathUtils::GetFileName(assetInfo->m_pAssetInfo->m_Path.GetDataDirParentRelativePath());
    }
    else
    {
