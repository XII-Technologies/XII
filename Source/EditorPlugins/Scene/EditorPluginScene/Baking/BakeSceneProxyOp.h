...
class xiiLongOpProxy_BakeScene : public xiiLongOpProxy
{
  XII_ADD_DYNAMIC_REFLECTION(xiiLongOpProxy_BakeScene, xiiLongOpProxy);

public:
  virtual void          InitializeRegistered(const xiiUuid& documentGuid, const xiiUuid& componentGuid) override;
  virtual xiiStringView GetDisplayName() const override { return "Bake Scene"; }
