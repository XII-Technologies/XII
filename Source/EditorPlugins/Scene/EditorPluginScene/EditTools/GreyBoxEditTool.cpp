...
void xiiGreyBoxEditTool::GetGridSettings(xiiGridSettingsMsgToEngine& msg)
{
  ...
  msg.m_fGridDensity = xiiSnapProvider::GetTranslationSnapValue(); // negative density = local space
  ...
  if (pPreferences->GetShowGrid())
  {
    if (m_DrawBoxGizmo.GetCurrentMode() == xiiDrawBoxGizmo::ManipulateMode::DrawBase)
    {
      ...
      msg.m_vGridTangent1 = xiiVec3(1, 0, 0);
      msg.m_vGridTangent2 = xiiVec3(0, 1, 0);
    }
    else if (m_DrawBoxGizmo.GetCurrentMode() == xiiDrawBoxGizmo::ManipulateMode::DrawHeight)
    {
      ...
      {
        msg.m_vGridTangent1 = xiiVec3(1, 0, 0);
        msg.m_vGridTangent2 = xiiVec3(0, 0, 1);
      }
      else
      {
        msg.m_vGridTangent1 = xiiVec3(0, 1, 0);
        msg.m_vGridTangent2 = xiiVec3(0, 0, 1);
      }
    }
