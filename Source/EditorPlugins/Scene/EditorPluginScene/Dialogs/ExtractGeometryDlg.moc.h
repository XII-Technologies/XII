...
class xiiQtExtractGeometryDlg : public QDialog, public Ui_ExtractGeometryDlg
{
  Q_OBJECT

public:
  xiiQtExtractGeometryDlg(QWidget* pParent);

  static QString s_sDestinationFile;
  static bool    s_bOnlySelection;
  static int     s_iExtractionMode;
  static xiiMat3 GetCoordinateSystemTransform();
