...
xiiQtDeltaTransformDlg::Mode  xiiQtDeltaTransformDlg::s_Mode  = xiiQtDeltaTransformDlg::Mode::Translate;
xiiQtDeltaTransformDlg::Space xiiQtDeltaTransformDlg::s_Space = xiiQtDeltaTransformDlg::Space::World;
xiiVec3                       xiiQtDeltaTransformDlg::s_vTranslate(0.0f);
xiiVec3                       xiiQtDeltaTransformDlg::s_vTranslateDeviation(0.0f);

xiiVec3 xiiQtDeltaTransformDlg::s_vScale(1.0f);
xiiVec3 xiiQtDeltaTransformDlg::s_vScaleDeviation(1.0f);

float xiiQtDeltaTransformDlg::s_fUniformScale          = 1.0f;
float xiiQtDeltaTransformDlg::s_fUniformScaleDeviation = 1.0f;

xiiVec3 xiiQtDeltaTransformDlg::s_vRotate(0.0f);
xiiVec3 xiiQtDeltaTransformDlg::s_vRotateRandom(180.0f);
  ...
  QDialog(pParent)
{
  ...
  {
    xiiQtScopedBlockSignals _1(ComboMode);
...
void xiiQtDeltaTransformDlg::on_ComboMode_currentIndexChanged(int index)
{
  QueryUI();
...
void xiiQtDeltaTransformDlg::on_ComboSpace_currentIndexChanged(int index)
{
  s_Space = (Space)index;
}

void xiiQtDeltaTransformDlg::on_ButtonApply_clicked()
{
  xiiStringBuilder sAction;

  // early out when nothing is to do
  switch (s_Mode)
  {
    case Mode::Translate:
      if (s_vTranslate == xiiVec3(0.0f))
        return;

      sAction.Format("Translate: {0} | {1} | {2}", xiiArgF(s_vTranslate.x, 2), xiiArgF(s_vTranslate.y, 2), xiiArgF(s_vTranslate.z, 2));
      break;
    ...
    case Mode::TranslateDeviation:
      ...
      sAction.Format("Translate (deviation): {0} | {1} | {2}", xiiArgF(s_vTranslateDeviation.x, 2), xiiArgF(s_vTranslateDeviation.y, 2),
    ...
    case Mode::RotateX:
      ...
      sAction.Format("Rotate X: {0}", xiiArgF(s_vRotate.x, 1));
      break;
    ...
    case Mode::RotateXRandom:
      ...
      sAction.Format("Rotate X (random): {0}", xiiArgF(s_vRotateRandom.x, 1));
      break;
    ...
    case Mode::RotateXDeviation:
      ...
      sAction.Format("Rotate X (deviation): {0}", xiiArgF(s_vRotateDeviation.x, 1));
      break;
    ...
    case Mode::RotateY:
      ...
      sAction.Format("Rotate Y: {0}", xiiArgF(s_vRotate.y, 1));
      break;
    ...
    case Mode::RotateYRandom:
      ...
      sAction.Format("Rotate Y (random): {0}", xiiArgF(s_vRotateRandom.y, 1));
      break;
    ...
    case Mode::RotateYDeviation:
      ...
      sAction.Format("Rotate Y (deviation): {0}", xiiArgF(s_vRotateDeviation.y, 1));
      break;
    ...
    case Mode::RotateZ:
      ...
      sAction.Format("Rotate Z: {0}", xiiArgF(s_vRotate.z, 1));
      break;
    ...
    case Mode::RotateZRandom:
      ...
      sAction.Format("Rotate Z (random): {0}", xiiArgF(s_vRotateRandom.z, 1));
      break;
    ...
    case Mode::RotateZDeviation:
      ...
      sAction.Format("Rotate Z (deviation): {0}", xiiArgF(s_vRotateDeviation.z, 1));
      break;

    case Mode::Scale:
      if (s_vScale == xiiVec3(1.0f))
        return;

      sAction.Format("Scale: {0} | {1} | {2}", xiiArgF(s_vScale.x, 2), xiiArgF(s_vScale.y, 2), xiiArgF(s_vScale.z, 2));
      break;
    ...
    case Mode::UniformScale:
      ...
      sAction.Format("Scale: {0}", xiiArgF(s_fUniformScale, 2));
      break;
    ...
    case Mode::UniformScaleDeviation:
      ...
      sAction.Format("Scale (deviation): {0}", xiiArgF(s_fUniformScaleDeviation, 2));
      break;

    case Mode::NaturalDeviationZ:
      sAction.Format("Natural Deviation Z: {0}", xiiArgF(s_fNaturalDeviationZ, 1));
      break;
  }
  ...
  for (const xiiDocumentObject* pObject : selection)
  {
    ...
    xiiVec3 vRotate       = s_vRotate;
    xiiVec3 vScale        = s_vScale;
    float   fUniformScale = s_fUniformScale;


    switch (s_Mode)
    {
      case xiiQtDeltaTransformDlg::TranslateDeviation:
      {
        xiiVec3 vAbsTranslate = s_vTranslateDeviation.Abs();
      ...
      case xiiQtDeltaTransformDlg::RotateXRandom:
        vRotate.x = rng.DoubleMinMax(-s_vRotateRandom.Abs().x, +s_vRotateRandom.Abs().x);
        break;

      case xiiQtDeltaTransformDlg::RotateXDeviation:
        vRotate.x = rng.DoubleVarianceAroundZero(s_vRotateDeviation.Abs().x);
        break;

      case xiiQtDeltaTransformDlg::RotateYRandom:
        vRotate.y = rng.DoubleMinMax(-s_vRotateRandom.Abs().y, +s_vRotateRandom.Abs().y);
        break;

      case xiiQtDeltaTransformDlg::RotateYDeviation:
        vRotate.y = rng.DoubleVarianceAroundZero(s_vRotateDeviation.Abs().y);
        break;

      case xiiQtDeltaTransformDlg::RotateZRandom:
        vRotate.z = rng.DoubleMinMax(-s_vRotateRandom.Abs().z, +s_vRotateRandom.Abs().z);
        break;

      case xiiQtDeltaTransformDlg::RotateZDeviation:
        vRotate.z = rng.DoubleVarianceAroundZero(s_vRotateDeviation.Abs().z);
        break;

      case xiiQtDeltaTransformDlg::ScaleDeviation:
      {
        const xiiVec3 vScaleMin = s_vScaleDeviation.CompMin(xiiVec3(1.0f).CompDiv(s_vScaleDeviation));
        const xiiVec3 vScaleMax = s_vScaleDeviation.CompMax(xiiVec3(1.0f).CompDiv(s_vScaleDeviation));
      ...
      case xiiQtDeltaTransformDlg::UniformScaleDeviation:
      {
        const float fUniScaleMin = xiiMath::Min(1.0f / s_fUniformScaleDeviation, s_fUniformScaleDeviation);
        const float fUniScaleMax = xiiMath::Max(1.0f / s_fUniformScaleDeviation, s_fUniformScaleDeviation);
    ...
    switch (s_Mode)
    {
      ...
      case Mode::RotateXRandom:
      case Mode::RotateXDeviation:
        qRot                   = xiiQuat::MakeFromAxisAndAngle(xiiVec3(1, 0, 0), xiiAngle::Degree(vRotate.x));
      ...
      case Mode::RotateYRandom:
      case Mode::RotateYDeviation:
        qRot                   = xiiQuat::MakeFromAxisAndAngle(xiiVec3(0, 1, 0), xiiAngle::Degree(vRotate.y));
        localTrans.m_qRotation = qRot * localTrans.m_qRotation;
        localTrans.m_vPosition = qRot * localTrans.m_vPosition;
        trans                  = tReference * localTrans;
        trans.m_qRotation.Normalize();
      ...
      case Mode::RotateZRandom:
      case Mode::RotateZDeviation:
        qRot                   = xiiQuat::MakeFromAxisAndAngle(xiiVec3(0, 0, 1), xiiAngle::Degree(vRotate.z));
        localTrans.m_qRotation = qRot * localTrans.m_qRotation;
        localTrans.m_vPosition = qRot * localTrans.m_vPosition;
        trans                  = tReference * localTrans;
        trans.m_qRotation.Normalize();
      ...
      case Mode::NaturalDeviationZ:
      {
        ...
        {
          const xiiVec3 vDeviationAxis = xiiVec3::MakeRandomDeviationZ(rng, xiiAngle::Degree(s_fNaturalDeviationZ));
...
void xiiQtDeltaTransformDlg::on_ButtonUndo_clicked()
{
  auto history = m_pSceneDocument->GetCommandHistory();
...
void xiiQtDeltaTransformDlg::QueryUI()
{
  switch (s_Mode)
  {
    case Mode::Translate:
    ...
    case xiiQtDeltaTransformDlg::NaturalDeviationZ:
      s_fNaturalDeviationZ = (float)Value1->value();
      break;
  }
}

void xiiQtDeltaTransformDlg::UpdateUI()
{
...
void xiiQtDeltaTransformDlg::on_Value1_valueChanged(double value)
{
  switch (s_Mode)
  {
    case Mode::Translate:
...
void xiiQtDeltaTransformDlg::on_Value2_valueChanged(double value)
{
  switch (s_Mode)
  {
    case Mode::Translate:
...
void xiiQtDeltaTransformDlg::on_Value3_valueChanged(double value)
{
  switch (s_Mode)
  {
    case Mode::Translate:
