...
xiiUInt32 xiiQtDuplicateDlg::s_uiNumberOfCopies = 1;
bool      xiiQtDuplicateDlg::s_bGroupCopies     = false;
xiiVec3   xiiQtDuplicateDlg::s_vTranslationStep(0, 0, 0);
xiiVec3   xiiQtDuplicateDlg::s_vRotationStep(0, 0, 0);
xiiVec3   xiiQtDuplicateDlg::s_vRandomTranslation(0, 0, 0);
xiiVec3   xiiQtDuplicateDlg::s_vRandomRotation(0, 0, 0);
int       xiiQtDuplicateDlg::s_iRevolveAxis       = 0;
int       xiiQtDuplicateDlg::s_iRevolveStartAngle = 0;
int       xiiQtDuplicateDlg::s_iRevolveAngleStep  = 0;
float     xiiQtDuplicateDlg::s_fRevolveRadius     = 1.0f;


xiiQtDuplicateDlg::xiiQtDuplicateDlg(QWidget* pParent) :
  QDialog(pParent)
{
  setupUi(this);
  ...
  m_vBoundingBoxSize.x = xiiMath::RoundToMultiple(m_vBoundingBoxSize.x, 0.01f);
  m_vBoundingBoxSize.y = xiiMath::RoundToMultiple(m_vBoundingBoxSize.y, 0.01f);
  m_vBoundingBoxSize.z = xiiMath::RoundToMultiple(m_vBoundingBoxSize.z, 0.01f);
...
void xiiQtDuplicateDlg::on_DefaultButtons_clicked(QAbstractButton* pButton)
{
  ...
  if (pButton == DefaultButtons->button(QDialogButtonBox::Ok))
  {
    ...
    s_fRevolveRadius     = xiiMath::Clamp((float)SpinBoxRadius->value(), 0.0f, 1000.0f);

    accept();
  }
}

void xiiQtDuplicateDlg::on_toolButtonTransX_clicked()
{
  const float f = xiiMath::RoundToMultiple((float)SpinBoxTransX->value(), 0.01f);
...
void xiiQtDuplicateDlg::on_toolButtonTransY_clicked()
{
  const float f = xiiMath::RoundToMultiple((float)SpinBoxTransY->value(), 0.01f);
...
void xiiQtDuplicateDlg::on_toolButtonTransZ_clicked()
{
  const float f = xiiMath::RoundToMultiple((float)SpinBoxTransZ->value(), 0.01f);
...
void xiiQtDuplicateDlg::on_RevolveNone_clicked()
{
...
void xiiQtDuplicateDlg::on_RevolveX_clicked()
{
...
void xiiQtDuplicateDlg::on_RevolveY_clicked()
{
...
void xiiQtDuplicateDlg::on_RevolveZ_clicked()
{
