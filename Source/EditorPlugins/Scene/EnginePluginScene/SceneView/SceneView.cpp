...
void xiiSceneViewContext::SetupRenderTarget(xiiGALSwapChainHandle hSwapChain, const xiiRenderTargets* pRenderTargets, xiiUInt16 uiWidth, xiiUInt16 uiHeight)
{
