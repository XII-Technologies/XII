...
xiiQtNodeScene* xiiQtNodeView::GetScene()
{
  return m_pScene;
}

void xiiQtNodeView::mousePressEvent(QMouseEvent* event)
{
...
void xiiQtNodeView::mouseMoveEvent(QMouseEvent* event)
{
...
void xiiQtNodeView::mouseReleaseEvent(QMouseEvent* event)
{
...
void xiiQtNodeView::wheelEvent(QWheelEvent* event)
{
#if QT_VERSION >= QT_VERSION_CHECK(5, 15, 0)
  ...
  m_ViewScale *= fScale;
  m_ViewScale.setX(xiiMath::Clamp(m_ViewScale.x(), 0.01, 2.0));
  m_ViewScale.setY(xiiMath::Clamp(m_ViewScale.y(), 0.01, 2.0));
...
void xiiQtNodeView::contextMenuEvent(QContextMenuEvent* event)
{
  if (m_iPanCounter > 2)
  {
    m_iPanCounter = 0;
...
void xiiQtNodeView::resizeEvent(QResizeEvent* event)
{
