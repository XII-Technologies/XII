...
public:
  ...
  static xiiDynamicStringEnum& GetDynamicEnum(const char* szEnumName);

  static xiiDynamicStringEnum& CreateDynamicEnum(const char* szEnumName);
  ...
  static xiiDelegate<void(const char* szEnumName, xiiDynamicStringEnum& e)> s_RequestUnknownCallback;
