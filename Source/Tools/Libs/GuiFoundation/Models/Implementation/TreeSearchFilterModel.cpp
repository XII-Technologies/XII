...
bool xiiQtTreeSearchFilterModel::UpdateVisibility(const QModelIndex& idx, bool bParentIsVisible)
{
  bool bExisted = false;
...
bool xiiQtTreeSearchFilterModel::filterAcceptsRow(int source_row, const QModelIndex& source_parent) const
{
