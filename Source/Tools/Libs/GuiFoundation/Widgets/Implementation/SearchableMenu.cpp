  ...
  QWidgetAction(pParent)
{
  ...
  m_pSearch = new xiiQtSearchWidget(m_pGroup);
  connect(m_pSearch, &xiiQtSearchWidget::enterPressed, this, &xiiQtSearchableMenu::OnEnterPressed);
  connect(m_pSearch, &xiiQtSearchWidget::specialKeyPressed, this, &xiiQtSearchableMenu::OnSpecialKeyPressed);
  connect(m_pSearch, &xiiQtSearchWidget::textChanged, this, &xiiQtSearchableMenu::OnSearchChanged);
  connect(m_pSearch, &xiiQtSearchWidget::visibleEvent, this, &xiiQtSearchableMenu::OnShow);
  ...
  m_pFilterModel = new xiiQtTreeSearchFilterModel(m_pGroup);
  ...
  connect(m_pTreeView, &QTreeView::activated, this, &xiiQtSearchableMenu::OnItemActivated);
...
bool xiiQtSearchableMenu::SelectFirstLeaf(QModelIndex parent)
{
...
bool xiiQtSearchableMenu::eventFilter(QObject* pObject, QEvent* event)
{
...
void xiiQtSearchableMenu::AddItem(xiiStringView sDisplayName, xiiStringView sInternalPath, const QVariant& variant, QIcon icon)
{
  ...
  pThisItem->setData(xiiMakeQString(sDisplayName).toLower(), SortRole);

  pParent->appendRow(pThisItem);
}

QString xiiQtSearchableMenu::GetSearchText() const
{
  return m_pSearch->text();
}

void xiiQtSearchableMenu::Finalize(const QString& sSearchText)
{
...
void xiiQtSearchableMenu::OnEnterPressed()
{
...
void xiiQtSearchableMenu::OnSpecialKeyPressed(Qt::Key key)
{
...
void xiiQtSearchableMenu::OnSearchChanged(const QString& text)
{
