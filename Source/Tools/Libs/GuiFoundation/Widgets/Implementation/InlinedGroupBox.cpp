...
xiiQtInlinedGroupBox::xiiQtInlinedGroupBox(QWidget* pParent) :
  xiiQtGroupBoxBase(pParent, false)
{
...
void xiiQtInlinedGroupBox::paintEvent(QPaintEvent* event)
{
...
bool xiiQtInlinedGroupBox::eventFilter(QObject* object, QEvent* event)
{
  switch (event->type())
  {
