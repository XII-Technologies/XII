...
void xiiQtGroupBoxBase::SetTitle(const char* szTitle)
{
  m_sTitle = szTitle;
}
...
void xiiQtGroupBoxBase::DrawHeader(QPainter& p, const QRect& rect)
{
  ...
  if (m_bCollapsible)
  {
    ...
    QIcon collapseIcon = bCollapsed ? xiiQtUiServices::GetCachedIconResource(":/GuiFoundation/Icons/groupClosed.png") : xiiQtUiServices::GetCachedIconResource(":/GuiFoundation/Icons/groupOpen.png");
