...
void xiiQtGraphicsView::wheelEvent(QWheelEvent* e)
{
  if (e->angleDelta().y() > 0)
  {
    m_fZoom *= 1.2f;
...
void xiiQtGraphicsView::mousePressEvent(QMouseEvent* e)
{
...
void xiiQtGraphicsView::mouseReleaseEvent(QMouseEvent* e)
{
...
void xiiQtGraphicsView::mouseMoveEvent(QMouseEvent* e)
{
  if (m_bPanning)
  {
...
void xiiQtGraphicsView::keyPressEvent(QKeyEvent* e)
{
...
void xiiQtGraphicsView::UpdateTransform()
{
  m_fZoom = xiiMath::Clamp(m_fZoom, m_fMinZoom, m_fMaxZoom);
