...
xiiQtTimeScrubberWidget::~xiiQtTimeScrubberWidget() {}
...
xiiQtTimeScrubberToolbar::xiiQtTimeScrubberToolbar(QWidget* parent) :
...
void xiiQtTimeScrubberToolbar::SetButtonState(bool playing, bool repeatEnabled)
{
  if (playing)
