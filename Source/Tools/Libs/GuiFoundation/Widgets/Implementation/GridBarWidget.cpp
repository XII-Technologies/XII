...
xiiQGridBarWidget::xiiQGridBarWidget(QWidget* pParent) :
  QWidget(pParent)
{
...
void xiiQGridBarWidget::paintEvent(QPaintEvent* e)
{
  ...
  // render fine grid stop lines
  {
    ...
    xiiWidgetUtils::ComputeGridExtentsX(m_ViewportSceneRect, m_fFineGridStops, fSceneMinX, fSceneMaxX);
    fSceneMinX = xiiMath::Max(fSceneMinX, 0.0);
  ...
  {
    double fSceneMinX, fSceneMaxX;
    xiiWidgetUtils::ComputeGridExtentsX(m_ViewportSceneRect, m_fTextGridStops, fSceneMinX, fSceneMaxX);
    fSceneMinX = xiiMath::Max(fSceneMinX, 0.0);
