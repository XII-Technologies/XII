...
bool xiiActionManager::UnregisterAction(xiiActionDescriptorHandle& hAction)
{
  ...
  XII_VERIFY(it.Value().m_Actions.Remove(hAction), "Action is present but not in its category data!");
