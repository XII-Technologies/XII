...
namespace xiiModelImporter2
{
  ...
  xiiResult ImporterMagicaVoxel::DoImport()
  {
    ...
    const xiiUInt32 uiNrmStream = mb.AddStream(xiiGALVertexAttributeSemantic::Normal, xiiMeshNormalPrecision::ToResourceFormatNormal(xiiMeshNormalPrecision::_16Bit));
    ...
    for (xiiUInt32 i = 0; i < positions.GetCount(); ++i)
    {
      ...
      xiiMeshBufferUtils::EncodeNormal(normals[i], mb.GetVertexData(uiNrmStream, i), xiiMeshNormalPrecision::_16Bit).IgnoreResult();
