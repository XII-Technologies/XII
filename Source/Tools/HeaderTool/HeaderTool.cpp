...
xiiHeaderTool::xiiHeaderTool() :
  xiiApplication("XIIBuildTool")
{
  m_sSourceDirectory = "";
  m_sExportDirectory = "";
...
void xiiHeaderTool::AfterCoreSystemsStartup()
{
...
void xiiHeaderTool::BeforeCoreSystemsShutdown()
{
}

xiiApplication::Execution xiiHeaderTool::Run()
{
