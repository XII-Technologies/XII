...
static xiiUniquePtr<PrintImplementation> s_PrintInterface;

// BEGIN-DOCS-CODE-SNIPPET: startup-block
// clang-format off
XII_BEGIN_SUBSYSTEM_DECLARATION(SampleGamePluginStartupGroup, SampleGamePluginMainStartup)
  ...
  ON_CORESYSTEMS_STARTUP
  {
    ...
    s_PrintInterface = XII_DEFAULT_NEW(PrintImplementation);
  ...
  {
    // we can query 'an implementation of PrintInterface' through the xiiSingletonRegistry
    // BEGIN-DOCS-CODE-SNIPPET: singleton-query-interface
    xiiSingletonRegistry::GetSingletonInstance<PrintInterface>()->Print("Called ON_HIGHLEVELSYSTEMS_STARTUP");
    // END-DOCS-CODE-SNIPPET
  }
