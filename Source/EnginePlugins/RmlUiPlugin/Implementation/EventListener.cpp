...
namespace xiiRmlUiInternal
{
  ...
  {
    static_cast<xiiRmlUiContext*>(ref_event.GetTargetElement()->GetContext())->ProcessEvent(m_sIdentifier, ref_event);
  }
  ...
  Rml::EventListener* EventListenerInstancer::InstanceEventListener(const Rml::String& value, Rml::Element* pElement)
  {
    ...
    {
      xiiUInt32 uiIndex = m_EventListenerFreelist.PeekBack();
