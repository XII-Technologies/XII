...
class XII_GAMEPLAYPLUGIN_DLL xiiHeightfieldComponentManager : public xiiComponentManager<xiiHeightfieldComponent, xiiBlockStorageType::Compact>
{
public:
...
class XII_GAMEPLAYPLUGIN_DLL xiiHeightfieldComponent : public xiiRenderComponent
{
