...
class XII_GAMEPLAYPLUGIN_DLL xiiClothSheetComponentManager : public xiiComponentManager<class xiiClothSheetComponent, xiiBlockStorageType::FreeList>
{
public:
...
class XII_GAMEPLAYPLUGIN_DLL xiiClothSheetRenderData final : public xiiRenderData
{
...
class XII_GAMEPLAYPLUGIN_DLL xiiClothSheetRenderer : public xiiRenderer
{
...
struct XII_GAMEPLAYPLUGIN_DLL xiiClothSheetFlags
{
...
XII_DECLARE_REFLECTABLE_TYPE(XII_GAMEPLAYPLUGIN_DLL, xiiClothSheetFlags);

class XII_GAMEPLAYPLUGIN_DLL xiiClothSheetComponent : public xiiRenderComponent
{
