...
void xiiJoltCharacterControllerComponent::SerializeComponent(xiiWorldWriter& inout_stream) const
{
...
void xiiJoltCharacterControllerComponent::SetMass(float fMass)
{
  m_fMass = fMass;
...
void xiiJoltCharacterControllerComponent::SetStrength(float fStrength)
{
...
void xiiJoltCharacterControllerComponent::CollectCastContacts(xiiDynamicArray<ContactPoint>& out_Contacts, const JPH::Shape* pShape, const xiiVec3& vQueryPosition, const xiiQuat& qQueryRotation, const xiiVec3& vSweepDir) const
{
  ...
  public:
    ...
    virtual void AddHit(const JPH::ShapeCastResult& result) override
    {
      ...
      contact.m_vPosition      = xiiJoltConversionUtils::ToVec3(result.mContactPointOn2);
      contact.m_vContactNormal = xiiJoltConversionUtils::ToVec3(-result.mPenetrationAxis.Normalized());
      ...
      contact.m_vSurfaceNormal = xiiJoltConversionUtils::ToVec3(lock.GetBody().GetWorldSpaceSurfaceNormal(result.mSubShapeID2, result.mContactPointOn2));
    }
  };
