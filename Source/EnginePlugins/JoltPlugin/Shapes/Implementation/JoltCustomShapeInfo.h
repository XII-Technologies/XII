...
class xiiJoltCustomShapeInfo : public JPH::DecoratedShape
{
public:
  xiiJoltCustomShapeInfo() :
    DecoratedShape(JPH::EShapeSubType::User1)
  {
  }

  xiiJoltCustomShapeInfo(const Shape* pInInnerShape) :
    DecoratedShape(JPH::EShapeSubType::User1, pInInnerShape)
  {
  }

  float                                                  m_fDensity = 1.0f;
  xiiHybridArray<JPH::RefConst<JPH::PhysicsMaterial>, 1> m_CustomMaterials;
