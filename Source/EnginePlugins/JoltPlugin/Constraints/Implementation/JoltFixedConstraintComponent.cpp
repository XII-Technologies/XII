...
// clang-format off
XII_BEGIN_COMPONENT_TYPE(xiiJoltFixedConstraintComponent, 1, xiiComponentMode::Static);
XII_END_DYNAMIC_REFLECTED_TYPE;
// clang-format on

xiiJoltFixedConstraintComponent::xiiJoltFixedConstraintComponent()  = default;
xiiJoltFixedConstraintComponent::~xiiJoltFixedConstraintComponent() = default;

void xiiJoltFixedConstraintComponent::ApplySettings()
{
  xiiJoltConstraintComponent::ApplySettings();
}

bool xiiJoltFixedConstraintComponent::ExceededBreakingPoint()
{
...
void xiiJoltFixedConstraintComponent::CreateContstraintType(JPH::Body* pBody0, JPH::Body* pBody1)
{
  ...
  opt.mAxisX1 = inv1.Multiply3x3(xiiJoltConversionUtils::ToVec3(m_LocalFrameA.m_qRotation * xiiVec3(1, 0, 0)));
  opt.mAxisX2 = inv2.Multiply3x3(xiiJoltConversionUtils::ToVec3(m_LocalFrameB.m_qRotation * xiiVec3(1, 0, 0)));
  opt.mAxisY1 = inv1.Multiply3x3(xiiJoltConversionUtils::ToVec3(m_LocalFrameA.m_qRotation * xiiVec3(0, 1, 0)));
  opt.mAxisY2 = inv2.Multiply3x3(xiiJoltConversionUtils::ToVec3(m_LocalFrameB.m_qRotation * xiiVec3(0, 1, 0)));
