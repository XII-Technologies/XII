...
class xiiJoltDebugRenderer : public JPH::DebugRenderer
{
public:
  xiiDynamicArray<xiiDebugRenderer::Line>     m_Lines;
  xiiDynamicArray<xiiDebugRenderer::Triangle> m_Triangles;
