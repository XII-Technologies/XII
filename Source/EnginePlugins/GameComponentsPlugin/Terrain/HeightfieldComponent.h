...
class XII_GAMECOMPONENTS_DLL xiiHeightfieldComponentManager : public xiiComponentManager<xiiHeightfieldComponent, xiiBlockStorageType::Compact>
{
public:
...
class XII_GAMECOMPONENTS_DLL xiiHeightfieldComponent : public xiiRenderComponent
{
...
protected:
  ...
  xiiVec2 m_vTexCoordOffset = xiiVec2::MakeZero();
