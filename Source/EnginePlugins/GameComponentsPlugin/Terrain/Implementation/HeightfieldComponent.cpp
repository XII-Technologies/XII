...
xiiResult xiiHeightfieldComponent::BuildMeshDescriptor(xiiMeshResourceDescriptor& desc) const
{
...

  {
    ...
    mb.AllocateStreams(uiNumVerticesX * uiNumVerticesY, xiiGALPrimitiveTopology::TriangleList, uiNumTriangles);
    ...
    desc.SetBounds(xiiBoundingBoxSphere::MakeFromBox(xiiBoundingBox::MakeFromMinMax(vPosOffset, vPosOffset + vSize)));
