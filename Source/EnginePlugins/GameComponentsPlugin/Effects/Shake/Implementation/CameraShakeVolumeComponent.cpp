...
void xiiCameraShakeVolumeComponent::SerializeComponent(xiiWorldWriter& inout_stream) const
{
...
void xiiCameraShakeVolumeComponent::DeserializeComponent(xiiWorldReader& inout_stream)
{
...
void xiiCameraShakeVolumeSphereComponent::SerializeComponent(xiiWorldWriter& inout_stream) const
{
  SUPER::SerializeComponent(inout_stream);
  auto& s = inout_stream.GetStream();
...
void xiiCameraShakeVolumeSphereComponent::DeserializeComponent(xiiWorldReader& inout_stream)
{
  SUPER::DeserializeComponent(inout_stream);
  // const xiiUInt32 uiVersion = inout_stream.GetComponentTypeVersion(GetStaticRTTI());
  auto& s = inout_stream.GetStream();
...
{
  msg.AddBounds(xiiBoundingSphere::MakeFromCenterAndRadius(xiiVec3::MakeZero(), m_fRadius), xiiCameraShakeVolumeComponent::SpatialDataCategory);
}
