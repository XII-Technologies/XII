...
void xiiParticleInitializerFactory_CylinderPosition::Save(xiiStreamWriter& stream) const
{
...
void xiiParticleInitializerFactory_CylinderPosition::Load(xiiStreamReader& stream)
{
