...
macro(xii_create_target_cs TYPE TARGET_NAME)
	xii_apply_build_filter(${TARGET_NAME})

	set(ARG_OPTIONS NO_XII_PREFIX)
	...
	if(ARG_UNPARSED_ARGUMENTS)
		message(FATAL_ERROR "xii_create_target_cs: Invalid arguments '${ARG_UNPARSED_ARGUMENTS}'")
	endif()
	...
	elseif(${TYPE} STREQUAL "APPLICATION")
		...
		message(FATAL_ERROR "xii_create_target_cs: Missing argument to specify target type. Pass in 'APPLICATION' or 'SHARED_LIBRARY' or 'STATIC_LIBRARY'.")
	endif()
	...
	# use xii_make_winmain_executable if this is desired
