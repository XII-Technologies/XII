...
# #####################################
# ## xii_retrieve_target_pch(<target> <pch-name>)
# #####################################
function(xii_retrieve_target_pch TARGET_NAME PCH_NAME)
...
# #####################################
# ## xii_pch_use(<pch-header> <cpp-files>)
# #####################################
function(xii_pch_use PCH_H TARGET_CPPS)
  if(NOT XII_USE_PCH OR XII_CMAKE_GENERATOR_MSVC)
...
# #####################################
# ## xii_pch_create(<pch-header> <cpp-file>)
# #####################################
function(xii_pch_create PCH_H TARGET_CPP)
  if(NOT XII_CMAKE_GENERATOR_MSVC)
    return()
  endif()
...
# #####################################
# ## xii_find_pch_in_file_list(<files> <out-pch-name>)
# #####################################
function(xii_find_pch_in_file_list FILE_LIST PCH_PATH PCH_NAME)
...
# #####################################
# ## xii_auto_pch(<target> <files> [<file-exclude-regex> ... ])
# #####################################
function(xii_auto_pch TARGET_NAME FILES)
  ...
  xii_pch_create("${PCH_NAME}.h" ${PCH_PATH})

  xii_pch_use("${PCH_NAME}.h" "${FILES}")

  xii_set_target_pch(${TARGET_NAME} ${PCH_NAME})
endfunction()
