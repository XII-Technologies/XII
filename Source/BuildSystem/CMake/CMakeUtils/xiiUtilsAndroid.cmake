...
macro(xii_list_subdirs result curdir)
...
# #####################################
# ## xii_android_add_default_content(<target>)
# #####################################
function(xii_android_add_default_content TARGET_NAME)
	xii_pull_all_vars()

	if(NOT XII_CMAKE_PLATFORM_ANDROID)
		return()
	endif()
	...
	set(CONTENT_DIRECTORY_SRC "${CMAKE_SOURCE_DIR}/${XII_SUBMODULE_PREFIX_PATH}/Data/Platform/Android")
