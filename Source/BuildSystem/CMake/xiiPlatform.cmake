...
if (XII_CMAKE_PLATFORM_NAME STREQUAL "UNKNOWN")
  message(FATAL_ERROR "Failed to detect platform.")
else()
  message(STATUS "Detected Platform is '${XII_CMAKE_PLATFORM_NAME}'")
endif()

get_property(XII_CMAKE_RELPATH GLOBAL PROPERTY XII_CMAKE_RELPATH)
set(PLATFORM_CFG_FILE "${XII_ROOT}/${XII_CMAKE_RELPATH}/Platforms/Configure_${XII_CMAKE_PLATFORM_POSTFIX}.cmake")
