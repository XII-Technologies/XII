...
export namespace Utils {
     ...
     * say it is called 'prefab-proxy'. This node typically holds a single xiiPrefabReferenceComponent. After prefab instantiation is complete,
    ...
    /**
     * Similar to xii.Utils.FindPrefabRootNode() but additionally searches for a specific script component.
     * 
