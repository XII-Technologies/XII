...
export namespace Debug {
    ...
    export enum ArgType { // see xiiVariant::Type for values
        Boolean = 2,
        Number = 12,
        String = 27,
    }
     ...
     * @param argTypes Variadic list describing the type of each argument. E.g. "xii.Debug.ArgType.String, xii.Debug.ArgType.Number"
     */
