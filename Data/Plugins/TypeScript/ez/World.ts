...
export namespace World {
   ...
   * 
   * Example:
   *   let slider = xii.World.CreateComponent(someGameObject, xii.SliderComponent);
   * 
   ...
   * 
   * @param type The object type category to search for. See xiiMarkerComponent for a way to attach a type category to an object.
