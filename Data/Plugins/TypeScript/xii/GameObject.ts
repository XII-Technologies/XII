...
/**
 * Represents a C++ xiiGameObject on the TypeScript side.
 * 
 ...
 * the C++ side xiiGameObject has been deleted and the TypeScript instance cannot be used anymore either.
 * 
...
export class GameObject {
     ...
     * 
     * See also xii.Utils.FindPrefabRootScript() for the common use case to finding the script of a prefab instance.
     * 
