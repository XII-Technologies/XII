...
export abstract class Component {
    ...
    /**
     * Sends an xii.Message directly to this component.
     * 
    ...
    /**
     * Sends and xii.Message to this component.
...
export abstract class TypescriptComponent extends Component {
     ...
     * 
     * @param msgType The TS type of the message to handle. E.g. 'xii.MsgSetColor'
