...
xiiCVarBool cvar_DebugDisplay("CppProject.DebugDisplay", false, xiiCVarFlags::Default, "Whether the game should display debug geometry.");

XII_BEGIN_DYNAMIC_REFLECTED_TYPE(CppProjectGameState, 1, xiiRTTIDefaultAllocator<CppProjectGameState>)
XII_END_DYNAMIC_REFLECTED_TYPE;

CppProjectGameState::CppProjectGameState() = default;
CppProjectGameState::~CppProjectGameState() = default;

void CppProjectGameState::OnActivation(xiiWorld* pWorld, const xiiTransform* pStartPosition)
{
...
xiiGameStatePriority CppProjectGameState::DeterminePriority(xiiWorld* pWorld) const
{
  return xiiGameStatePriority::Default;
}

void CppProjectGameState::ConfigureMainWindowInputDevices(xiiWindow* pWindow)
{
...
void CppProjectGameState::ConfigureInputActions()
{
  ...
  RegisterInputAction("CppProjectPlugin", "SpawnObject", xiiInputSlot_KeyO, xiiInputSlot_Controller0_ButtonA, xiiInputSlot_MouseButton2);
  RegisterInputAction("CppProjectPlugin", "DeleteObject", xiiInputSlot_KeyP, xiiInputSlot_Controller0_ButtonB);
}
...
void CppProjectGameState::ProcessInput()
{
  ...
  if (xiiInputManager::GetInputActionState("CppProjectPlugin", "SpawnObject") == xiiKeyState::Pressed)
  {
  ...
  if (xiiInputManager::GetInputActionState("CppProjectPlugin", "DeleteObject") == xiiKeyState::Pressed)
  {
