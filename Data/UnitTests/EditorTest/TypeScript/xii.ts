import __Log = require("./xii/Log")
export import Log = __Log.Log;

import __Utils = require("./xii/Utils")
export import Utils = __Utils.Utils;

import __Vec2 = require("./xii/Vec2")
export import Vec2 = __Vec2.Vec2;

import __Vec3 = require("./xii/Vec3")
export import Vec3 = __Vec3.Vec3;

import __Mat3 = require("./xii/Mat3")
export import Mat3 = __Mat3.Mat3;

import __Mat4 = require("./xii/Mat4")
export import Mat4 = __Mat4.Mat4;

import __Quat = require("./xii/Quat")
export import Quat = __Quat.Quat;

import __Transform = require("./xii/Transform")
export import Transform = __Transform.Transform;

import __Color = require("./xii/Color")
export import Color = __Color.Color;

import __Time = require("./xii/Time")
export import Time = __Time.Time;

import __Angle = require("./xii/Angle")
export import Angle = __Angle.Angle;

import __GameObject = require("./xii/GameObject")
export import GameObject = __GameObject.GameObject;

import __Component = require("./xii/Component")
