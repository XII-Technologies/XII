#include <FeatureLabRuntime/FeatureLabApp.h>
...
XII_APPLICATION_ENTRY_POINT(FeatureLabApp);

FeatureLabApp::FeatureLabApp()
  : xiiGameApplication("FeatureLab", nullptr)
{
}

xiiResult FeatureLabApp::TryProjectFolder(xiiStringView sPath)
{
...
void FeatureLabApp::DetermineProjectPath()
{
  // IMPORTANT!
  //
  ...
  m_sAppProjectPath = "Data/Samples/FeatureLab";
}

xiiUniquePtr<xiiGameStateBase> FeatureLabApp::CreateGameState()
{
...
xiiResult FeatureLabApp::BeforeCoreSystemsStartup()
{
...
void FeatureLabApp::AfterCoreSystemsStartup()
{
...
void FeatureLabApp::Run_InputUpdate()
{
